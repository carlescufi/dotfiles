...
if version >= 700
  ...
  hi MatchParen guifg=#ffffff guibg=#439ea9 gui=NONE
...
hi Title		guifg=#dfeff6 guibg=NONE	gui=NONE
 " Selected text color
...
hi Todo 		guifg=#ADED80 guibg=#579929 gui=NONE
...
hi Keyword		guifg=#8ac6f2 gui=none
 "  specified preprocessed words (like NONE, italic etc. above)
