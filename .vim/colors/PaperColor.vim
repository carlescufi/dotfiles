...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  call s:HL("StatusLine", s:statusline_active_fg, s:statusline_active_bg, "NONE")
  ...
  call s:HL("WildMenu", s:wildmenu_fg, s:wildmenu_bg, "NONE")
  if version >= 700
  ...
  call s:HL("Boolean", s:green, "", "NONE")
  ...
  call s:HL("Conditional", s:purple, "", "NONE")
  call s:HL("Repeat", s:purple, "", "NONE")
  ...
  call s:HL("Type", s:pink, "", "NONE")
  call s:HL("StorageClass", s:navy, "", "NONE")
  call s:HL("Structure", s:blue, "", "NONE")
  call s:HL("Typedef", s:pink, "", "NONE")

  call s:HL("Special", s:foreground, "", "")
  call s:HL("SpecialChar", s:foreground, "", "")
  call s:HL("Tag", s:green, "", "")
  call s:HL("Delimiter",s:aqua, "", "")
  call s:HL("SpecialComment", s:comment, "", "NONE")
  call s:HL("Debug", s:orange, "", "")

  "call s:HL("Ignore", "666666", "", "")

  call s:HL("Error", s:foreground, s:error, "")
  call s:HL("Todo", s:todo, s:background, "NONE")
  ...
  call s:HL("vimFunction", s:blue, "", "NONE")
  call s:HL("vimNotFunc", s:pink, "", "")
  call s:HL("vimMap", s:red, "", "")
  call s:HL("vimAutoEvent", s:aqua, "", "NONE")
  ...
  call s:HL("vimCommentTitle", s:comment, "", "NONE")
  call s:HL("vimBracket", s:aqua, "", "")
  call s:HL("vimParenSep", s:aqua, "", "")
  call s:HL("vimSynType", s:olive, "", "NONE")
  ...
  " C Highlighting
  call s:HL("cType", s:pink, "", "NONE")
  call s:HL("cFormat", s:olive, "", "")
  call s:HL("cStorageClass", s:navy, "", "NONE")

  call s:HL("cBoolean", s:green, "", "")
  call s:HL("cCharacter", s:olive, "", "")
  call s:HL("cConstant", s:green, "", "NONE")
  call s:HL("cConditional", s:purple, "", "NONE")
  call s:HL("cSpecial", s:olive, "", "NONE")
  call s:HL("cDefine", s:blue, "", "")
  call s:HL("cNumber", s:orange, "", "")
  call s:HL("cPreCondit", s:aqua, "", "")
  call s:HL("cRepeat", s:purple, "", "NONE")
  call s:HL("cLabel",s:aqua, "", "")
  " call s:HL("cAnsiFunction",s:aqua, "", "NONE")
  ...
  " call s:HL("cTodo", s:comment, "", "NONE")
  " call s:HL("cStructure", s:blue, "", "NONE")
  call s:HL("cCustomParen", s:foreground, "", "")
  " call s:HL("cCustomFunc", s:foreground, "", "")
  " call s:HL("cUserFunction",s:blue, "", "NONE")
  call s:HL("cOctalZero", s:purple, "", "NONE")
  ...
  call s:HL("cppSTLfunctional", s:foreground, "", "NONE")
  call s:HL("cppSTLiterator", s:foreground, "", "NONE")
  " call s:HL("cppSTLfunction", s:aqua, "", "NONE")
  call s:HL("cppExceptions", s:red, "", "")
  call s:HL("cppStatement", s:blue, "", "")
  call s:HL("cppStorageClass", s:navy, "", "NONE")
  ...
  " call s:HL("lexPatBlock", s:foreground, "", "NONE")
  call s:HL("lexSlashQuote", s:foreground, "", "")
  call s:HL("lexSep", s:foreground, "", "")
  call s:HL("lexStartState", s:orange, "", "")
  call s:HL("lexPatTagZone", s:olive, "", "NONE")
  call s:HL("lexMorePat", s:olive, "", "NONE")
  call s:HL("lexOptions", s:olive, "", "NONE")
  ...
  call s:HL("nasmStorage", s:aqua, "", "NONE")
  call s:HL("nasmLabel", s:pink, "", "")
  call s:HL("nasmDirective", s:blue, "", "NONE")
  call s:HL("nasmLocalLabel", s:orange, "", "")

  " GAS highlighting
  call s:HL("gasSymbol", s:pink, "", "")
  call s:HL("gasDirective", s:blue, "", "NONE")
  ...
  call s:HL("gasDirectiveStore", s:foreground, "", "NONE")

  " MIPS highlighting
  call s:HL("mipsInstruction", s:pink, "", "")
  call s:HL("mipsRegister", s:navy, "", "")
  call s:HL("mipsLabel", s:aqua, "", "NONE")
  call s:HL("mipsDirective", s:purple, "", "NONE")

  " Shell/Bash highlighting
  call s:HL("bashStatement", s:foreground, "", "NONE")
  call s:HL("shDerefVar", s:aqua, "", "NONE")
  call s:HL("shDerefSimple", s:aqua, "", "")
  call s:HL("shFunction", s:orange, "", "NONE")
  call s:HL("shStatement", s:foreground, "", "")
  call s:HL("shLoop", s:purple, "", "NONE")
  call s:HL("shQuote", s:olive, "", "")
  call s:HL("shCaseEsac", s:aqua, "", "NONE")
  ...
  " HTML Highlighting
  call s:HL("htmlTitle", s:green, "", "NONE")
  call s:HL("htmlH1", s:green, "", "NONE")
  call s:HL("htmlH2", s:aqua, "", "NONE")
  call s:HL("htmlH3", s:purple, "", "NONE")
  call s:HL("htmlH4", s:orange, "", "NONE")
  ...
  call s:HL("htmlBold", s:foreground, "", "NONE")
  call s:HL("htmlItalic", s:comment, "", "NONE")
  call s:HL("htmlBoldItalic", s:navy, "", "NONE")
  " call s:HL("htmlLink", s:blue, "", "NONE")
  call s:HL("htmlTagN", s:wine, "", "NONE")
...
call s:HL("cssColor", s:blue, "", "NONE")
...
call s:HL("cssClassName", s:pink, "", "")
  ...
  call s:HL("markdownHeadingRule", s:pink, "", "NONE")
  call s:HL("markdownH1", s:pink, "", "NONE")
  call s:HL("markdownH2", s:orange, "", "NONE")
  call s:HL("markdownBlockquote", s:pink, "", "")
  call s:HL("markdownCodeBlock", s:olive, "", "")
  call s:HL("markdownCode", s:olive, "", "")
  call s:HL("markdownLink", s:blue, "", "NONE")
  ...
  call s:HL("rstSections", s:pink, "", "NONE")
  call s:HL("rstDelimiter", s:pink, "", "NONE")
  call s:HL("rstExplicitMarkup", s:pink, "", "NONE")
  ...
  " Python Highlighting
  call s:HL("pythonImport", s:pink, "", "NONE")
  call s:HL("pythonExceptions", s:red, "", "")
  call s:HL("pythonException", s:purple, "", "NONE")
  call s:HL("pythonInclude", s:red, "", "")
  call s:HL("pythonStatement", s:pink, "", "")
  call s:HL("pythonConditional", s:purple, "", "NONE")
  call s:HL("pythonRepeat", s:purple, "", "NONE")
  call s:HL("pythonFunction", s:aqua, "", "NONE")
  call s:HL("pythonPreCondit", s:purple, "", "")
  call s:HL("pythonExClass", s:orange, "", "")
  call s:HL("pythonOperator", s:purple, "", "NONE")
  call s:HL("pythonBuiltin", s:foreground, "", "")
  call s:HL("pythonDecorator", s:orange, "", "")

  call s:HL("pythonString", s:olive, "", "")
  call s:HL("pythonEscape", s:olive, "", "NONE")
  call s:HL("pythonStrFormatting", s:olive, "", "NONE")

  call s:HL("pythonBoolean", s:green, "", "NONE")
  call s:HL("pythonExClass", s:red, "", "")
  call s:HL("pythonBytesEscape", s:olive, "", "NONE")
  ...
  call s:HL("javaClassDecl", s:aqua, "", "NONE")
  call s:HL("javaScopeDecl", s:blue, "", "NONE")
  call s:HL("javaStorageClass", s:navy, "", "NONE")
  call s:HL("javaBoolean", s:green, "", "NONE")
  ...
  call s:HL("javaScriptFunction", s:blue, "", "NONE")
  call s:HL("javaScriptConditional", s:purple, "", "NONE")
  call s:HL("javaScriptRepeat", s:purple, "", "NONE")
  call s:HL("javaScriptBoolean", s:green, "", "NONE")
  call s:HL("javaScriptNumber", s:orange, "", "")
  call s:HL("javaScriptMember", s:navy, "", "")
  call s:HL("javaScriptReserved", s:navy, "", "")
  call s:HL("javascriptNull", s:comment, "", "NONE")
  ...
  call s:HL("jsonNull", s:purple, "", "NONE")
  call s:HL("jsonBoolean", s:green, "", "NONE")
  call s:HL("jsonCommentError", s:pink, s:background , "")

  " Go Highlighting
  call s:HL("goDirective", s:red, "", "")
  call s:HL("goDeclaration", s:blue, "", "NONE")
  call s:HL("goStatement", s:pink, "", "")
  call s:HL("goConditional", s:purple, "", "NONE")
  call s:HL("goConstants", s:orange, "", "")
  call s:HL("goFunction", s:orange, "", "")
  " call s:HL("goTodo", s:comment, "", "NONE")
  ...
  call s:HL("dtracePredicate", s:purple, "", "NONE")
  call s:HL("dtraceComment", s:comment, "", "")
  call s:HL("dtraceFunction", s:foreground, "", "")
  call s:HL("dtraceAggregatingFunction", s:blue, "", "NONE")
  call s:HL("dtraceStatement", s:navy, "", "NONE")
  call s:HL("dtraceIdentifier", s:pink, "", "")
  call s:HL("dtraceOption", s:pink, "", "")
  call s:HL("dtraceConstant", s:orange, "", "")
  call s:HL("dtraceType", s:pink, "", "NONE")

  " PlantUML Highlighting
  call s:HL("plantumlPreProc", s:orange, "", "NONE")
  ...
  call s:HL("plantumlClassPublic", s:olive, "", "NONE")
  ...
  call s:HL("plantumlTypeKeyword", s:blue, "", "NONE")
  call s:HL("plantumlKeyword", s:pink, "", "NONE")

  call s:HL("plantumlType", s:blue, "", "NONE")
  call s:HL("plantumlBlock", s:pink, "", "NONE")
  call s:HL("plantumlPreposition", s:orange, "", "")
  call s:HL("plantumlLayout", s:blue, "", "NONE")
  call s:HL("plantumlNote", s:orange, "", "")
  call s:HL("plantumlLifecycle", s:aqua, "", "")
  call s:HL("plantumlParticipant", s:foreground, "", "NONE")


  " Haskell Highlighting
  call s:HL("haskellType", s:aqua, "", "NONE")
  call s:HL("haskellIdentifier", s:orange, "", "NONE")
  call s:HL("haskellOperators", s:pink, "", "")
  call s:HL("haskellWhere", s:foreground, "", "NONE")
  call s:HL("haskellDelimiter", s:aqua, "", "")
  call s:HL("haskellImportKeywords", s:pink, "", "")
  call s:HL("haskellStatement", s:purple, "", "NONE")


  " SQL/MySQL Highlighting
  call s:HL("sqlStatement", s:pink, "", "NONE")
  call s:HL("sqlType", s:blue, "", "NONE")
  call s:HL("sqlKeyword", s:pink, "", "")
  call s:HL("sqlOperator", s:aqua, "", "")
  call s:HL("sqlSpecial", s:green, "", "NONE")

  call s:HL("mysqlVariable", s:olive, "", "NONE")
  call s:HL("mysqlType", s:blue, "", "NONE")
  call s:HL("mysqlKeyword", s:pink, "", "")
  call s:HL("mysqlOperator", s:aqua, "", "")
  call s:HL("mysqlSpecial", s:green, "", "NONE")
  ...
  call s:HL("octaveBeginKeyword", s:purple, "", "NONE")
  call s:HL("octaveElseKeyword", s:purple, "", "NONE")
  call s:HL("octaveEndKeyword", s:purple, "", "NONE")
  call s:HL("octaveStatement", s:pink, "", "")

  " Ruby Highlighting
  call s:HL("rubyModule", s:navy, "", "NONE")
  call s:HL("rubyClass", s:pink, "", "NONE")
  call s:HL("rubyPseudoVariable", s:comment, "", "NONE")
  call s:HL("rubyKeyword", s:pink, "", "")
  call s:HL("rubyInstanceVariable", s:purple, "", "")
  call s:HL("rubyFunction", s:foreground, "", "NONE")
  ...
  call s:HL("rubyConditional", s:purple, "", "NONE")
  call s:HL("rubyRepeat", s:purple, "", "NONE")
  call s:HL("rubyControl", s:purple, "", "NONE")
  call s:HL("rubyException", s:purple, "", "NONE")
  call s:HL("rubyExceptional", s:purple, "", "NONE")
  call s:HL("rubyBoolean", s:green, "", "NONE")

  " Fortran Highlighting
  call s:HL("fortranUnitHeader", s:foreground, "", "NONE")
  call s:HL("fortranType", s:pink, "", "NONE")
  call s:HL("fortranStructure", s:blue, "", "NONE")
  call s:HL("fortranStorageClass", s:navy, "", "NONE")
  call s:HL("fortranStorageClassR", s:navy, "", "NONE")
  ...
  call s:HL("phpRepeat", s:purple, "", "NONE")
  call s:HL("phpConditional", s:purple, "", "NONE")
  call s:HL("phpStatement", s:pink, "", "")
  call s:HL("phpAssignByRef", s:aqua, "", "NONE")
  call s:HL("phpSpecialFunction", s:blue, "", "")
  call s:HL("phpFunctions", s:blue, "", "")
  call s:HL("phpComparison", s:aqua, "", "")
  call s:HL("phpBackslashSequences", s:olive, "", "NONE")
  call s:HL("phpMemberSelector", s:blue, "", "")
  call s:HL("phpStorageClass", s:purple, "", "NONE")
  ...
  call s:HL("perlFunction", s:pink, "", "NONE")
  ...
  call s:HL("perlStatementInclude", s:aqua, "", "NONE")
  call s:HL("perlStatementScalar", s:purple, "", "")
  call s:HL("perlSubName", s:aqua, "", "NONE")
  call s:HL("perlSpecialString", s:olive, "", "NONE")

  " Pascal Highlighting
  call s:HL("pascalType", s:pink, "", "NONE")
  call s:HL("pascalStatement", s:blue, "", "NONE")
  call s:HL("pascalPredefined", s:pink, "", "")
  call s:HL("pascalFunction", s:foreground, "", "")
  call s:HL("pascalStruct", s:navy, "", "NONE")
  call s:HL("pascalOperator", s:aqua, "", "NONE")
  call s:HL("pascalPreProc", s:green, "", "")
  call s:HL("pascalAcces", s:navy, "", "NONE")

  " Lua Highlighting
  call s:HL("luaFunc", s:foreground, "", "")
  call s:HL("luaIn", s:blue, "", "NONE")
  call s:HL("luaFunction", s:pink, "", "")
  call s:HL("luaStatement", s:blue, "", "")
  call s:HL("luaRepeat", s:blue, "", "NONE")
  call s:HL("luaCondStart", s:purple, "", "NONE")
  call s:HL("luaTable", s:aqua, "", "NONE")
  call s:HL("luaConstant", s:green, "", "NONE")
  call s:HL("luaElse", s:purple, "", "NONE")
  call s:HL("luaCondElseif", s:purple, "", "NONE")
  call s:HL("luaCond", s:purple, "", "NONE")
  ...
  call s:HL("shDerefVar", s:purple, "", "NONE")
  ...
  call s:HL("ngxDirectiveBlock", s:pink, "", "NONE")
  call s:HL("ngxDirective", s:blue, "", "none")
  call s:HL("ngxDirectiveImportant", s:blue, "", "NONE")
  ...
  call s:HL("elixirAlias", s:blue, "", "NONE")
  ...
  call s:HL("elixirKeyword", s:purple, "", "NONE")
  call s:HL("elixirFunctionDeclaration", s:foreground, "", "NONE")
  ...
  " Erlang Highlighting
  call s:HL("erlangBIF", s:purple, "", "NONE,")
  ...
  call s:HL("erlangAttribute", s:blue, "", "NONE")
  call s:HL("erlangRecordDef", s:blue, "", "NONE")
  call s:HL("erlangRecord", s:blue, "", "")
  call s:HL("erlangRightArrow", s:blue, "", "NONE")
  call s:HL("erlangStringModifier", s:olive, "", "NONE")
  call s:HL("erlangInclude", s:blue, "", "NONE")
  call s:HL("erlangKeyword", s:pink, "", "")
  call s:HL("erlangGlobalFuncCall", s:foreground, "", "")

  " Cucumber Highlighting
  call s:HL("cucumberFeature", s:blue, "", "NONE")
  call s:HL("cucumberBackground", s:pink, "", "NONE")
  call s:HL("cucumberScenario", s:pink, "", "NONE")
  ...
  call s:HL("cucumberWhen", s:purple, "", "NONE")
  call s:HL("cucumberScenarioOutline", s:pink, "", "NONE")
  ...
  call s:HL("netrwDir", s:aqua, "", "NONE")
  ...
  call s:HL("NERDTreeHelpTitle", s:blue, "", "NONE")
  ...
  " Plugin: Startify
  call s:HL("StartifyFile", s:blue, "", "NONE")
  ...
  call s:HL("gitcommitSummary", "", "", "NONE")
