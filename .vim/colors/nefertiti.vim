...
if !exists("g:did_nefertiti_code_setup")
    ...
    let s:nefertiti_dynamic_colors["Todo"]              = [ [0x8f, 0x6f, 0x8f], [], "guibg=#202020   gui=italic,underline,NONE" ]
    ...
    function! s:_nefertiti_set_search_highlight() "{{{3
        ...
        execute "hi Search guibg=#" . s:_nefertiti_search_highlight_intensity_highlight_map[g:nefertiti_current_search_highlight_intensity] . " guifg=#000000 gui=NONE"
    endfunction "}}}3
    ...
    function! s:_nefertiti_set_stable_colors() "{{{3
        ...
        hi StatusLine       guifg=#000000   guibg=#9d9080   gui=NONE
        ...
        hi TabLineSel       guibg=#2c2824   guifg=#ddd6c0   gui=NONE
        """ }}}4
        """ Search {{{4
        ...
        hi MatchParen       guifg=#fff000   guibg=bg        gui=NONE
        hi SpecialKey       guifg=#cc6644   guibg=bg        gui=NONE
