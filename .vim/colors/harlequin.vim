...
call s:Highlight('Statement',   s:cerise, '', 'NONE', '')
call s:Highlight('Keyword',     s:cerise, '', 'NONE', '')
call s:Highlight('Conditional', s:cerise, '', 'NONE', '')
call s:Highlight('Operator',    s:cerise, '', '', '')
call s:Highlight('Label',       s:cerise, '', '', '')
call s:Highlight('Repeat',      s:cerise, '', 'NONE', '')

call s:Highlight('Type',            s:brick, '', '', '')
call s:Highlight('StorageClass',    s:cerise, '', '', '')
call s:Highlight('Structure',       s:cerise, '', '', '')
call s:Highlight('TypeDef',         s:cerise, '', 'NONE', '')

call s:Highlight('Exception',       s:lime, '', 'NONE', '')
call s:Highlight('Include',         s:lime, '', 'NONE', '')
...
call s:Highlight('PreCondit',       s:lime, '', 'NONE', '')
call s:Highlight('Debug',           s:lime, '', 'NONE', '')
...
call s:Highlight('SpecialComment',  s:frost, '', 'NONE', '')
call s:Highlight('Todo',            s:frost, '', 'NONE', '')

call s:Highlight('String',          s:sunny, '', '', '') 
call s:Highlight('SpecialKey',      s:lilac, '', 'NONE', '')
call s:Highlight('Special',         s:lilac, '', 'NONE', '')
call s:Highlight('SpecialChar',     s:lilac, '', 'NONE', '')

call s:Highlight('Boolean',         s:lilac, '', 'NONE', '')
call s:Highlight('Character',       s:lilac, '', 'NONE', '')
call s:Highlight('Number',          s:lilac, '', 'NONE', '')
call s:Highlight('Constant',        s:lilac, '', 'NONE', '')
call s:Highlight('Float',           s:lilac, '', 'NONE', '')

call s:Highlight('FoldColumn',      s:greys[1], s:black, '', '')
call s:Highlight('Folded',          s:greys[1], s:black, '', '')

call s:Highlight('MatchParen',      s:black, s:gold, 'NONE', '')
...
call s:Highlight('Error',           s:mordant, s:greys[5], 'NONE', '')
call s:Highlight('ErrorMsg',        s:mordant, '', 'NONE', '')
...
call s:Highlight('StatusLine',      s:white, s:black, 'NONE', '')
call s:Highlight('StatusLineNC',    s:greys[1], s:greys[5], 'NONE', '')
call s:Highlight('VertSplit',       s:greys[1], s:greys[5], 'NONE', '')

call s:Highlight('ModeMsg',         s:sunny, '', 'NONE', '')
...
call s:Highlight('PmenuSel',        s:gold, s:black, 'NONE', '')
...
call s:Highlight('WildMenu',        s:black, s:lilac, 'NONE', '')

call s:Highlight('Title',           '', '', 'underline', '')

call s:HighlightX('Tag',            '', '', 'NONE', '')

"*** PYTHON ***
call s:Highlight('pythonDecorator',     s:cerise, '', '', '')
call s:Highlight('pythonException',     s:lime, '', 'NONE', '')
...
"*** JAVASCRIPT ***
call s:Highlight('javaScriptNull',        s:lilac, '', 'NONE', '')
call s:Highlight('javaScriptNumber',      s:lilac, '', 'NONE', '')
call s:Highlight('javaScriptFunction',    s:cerise, '', '', '')
call s:Highlight('javaScriptOperator',    s:cerise, '', 'NONE', '')
...
call s:Highlight('clojureMacro',          s:lime, '', 'NONE', '')
call s:Highlight('clojureDispatch',       s:lilac, '', 'NONE', '')
call s:Highlight('clojureError',          s:black, s:mordant, 'NONE', '')
...
"*** VIMSCRIPT ***
call s:Highlight('vimCommentTitle',       s:frost, '', 'NONE', '')
...
call s:Highlight('xmlEntity',                s:lilac, '', 'NONE', '')
...
call s:Highlight('htmlH1',                   '', '', 'NONE', '')
call s:Highlight('htmlH2',                   '', '', 'NONE', '')
...
call s:Highlight('cssImportant',             s:lime, '', 'NONE', '')
call s:Highlight('cssCommonAttr',            s:lilac, '', 'NONE', '')
call s:Highlight('cssRenderAttr',            s:lilac, '', 'NONE', '')
call s:Highlight('cssBoxAttr',               s:lilac, '', 'NONE', '')
call s:Highlight('cssUIAttr',                s:lilac, '', 'NONE', '')
call s:Highlight('cssTextAttr',              s:lilac, '', 'NONE', '')
call s:Highlight('cssTableAttr',             s:lilac, '', 'NONE', '')
call s:Highlight('cssColorAttr',             s:lilac, '', 'NONE', '')

"*** minibufexpl ***
call s:Highlight('MBENormal',                 s:greys[1], '', '', '')
call s:Highlight('MBEVisibleNormal',          s:white, '', 'NONE', '')
call s:Highlight('MBEVisibleActive',          s:frost, '', 'NONE', '')
call s:Highlight('MBEChanged',                s:greys[1], '', 'italic', '')
call s:Highlight('MBEVisibleChanged',         s:white, '', 'NONE,italic', '')
call s:Highlight('MBEVisibleChangedActive',   s:frost, '', 'NONE,italic', '')

"*** vim-easymotion ***
call s:Highlight('EasyMotionTarget',          s:cerise, '', 'NONE', '')
call s:Highlight('EasyMotionShade',           s:greys[2], '', '', '')

"*** CtrlP ***
call s:Highlight('CtrlPNoEntries',            s:mordant, '', '', '')
call s:Highlight('CtrlPPrtBase',              '', '', 'NONE', '')

"*** taglist.vim ***
call s:Highlight('TagListTitle',              s:white, '', 'NONE', '')
