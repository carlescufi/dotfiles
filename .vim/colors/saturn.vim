...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>H("NormalBlueBold", s:blue, "", "NONE")
    call <SID>H("NormalBlueBoldReverse", s:blue, "", "reverse,NONE")
    call <SID>H("NormalBlueLight", s:blue_light, "", "none")
    call <SID>H("NormalBlueLightReverse", s:blue_light, "", "reverse")
    call <SID>H("NormalBlueLightBold", s:blue_light, "", "NONE")
    call <SID>H("NormalBlueLightBoldReverse", s:blue_light, "", "reverse,NONE")
    call <SID>H("NormalRed", s:red, "", "none")
    call <SID>H("NormalRedReverse", s:red, "", "reverse")
    call <SID>H("NormalRedBold", s:red, "", "NONE")
    call <SID>H("NormalRedBoldReverse", s:red, "", "reverse,NONE")
    call <SID>H("NormalOrange", s:orange, "", "none")
    call <SID>H("NormalOrangeReverse", s:orange, "", "reverse")
    call <SID>H("NormalOrangeBold", s:orange, "", "NONE")
    call <SID>H("NormalOrangeBoldReverse", s:orange, "", "reverse,NONE")
    call <SID>H("NormalAqua", s:aqua, "", "none")
    call <SID>H("NormalAquaReverse", s:aqua, "", "reverse")
    call <SID>H("NormalAquaBold", s:aqua, "", "NONE")
    call <SID>H("NormalAquaBoldReverse", s:aqua, "", "reverse,NONE")
    call <SID>H("NormalGreen", s:green, "", "none")
    call <SID>H("NormalGreenReverse", s:green, "", "reverse")
    call <SID>H("NormalGreenBold", s:green, "", "NONE")
    call <SID>H("NormalGreenBoldReverse", s:green, "", "reverse,NONE")
    call <SID>H("NormalPurple", s:purple, "", "none")
    call <SID>H("NormalPurpleReverse", s:purple, "", "reverse")
    call <SID>H("NormalPurpleBold", s:purple, "", "NONE")
    call <SID>H("NormalPurpleBoldReverse", s:purple, "", "reverse,NONE")
    call <SID>H("NormalGrey", s:grey, "", "none")
    call <SID>H("NormalGreyReverse", s:grey, "", "reverse")
    call <SID>H("NormalGreyBold", s:grey, "", "reverse")
    call <SID>H("NormalGreyBoldReverse", s:grey, "", "reverse,NONE")
    call <SID>H("NormalGreyDark", s:grey_dark, "", "none")
    call <SID>H("NormalGreyDarkReverse", s:grey_dark, "", "reverse")
    call <SID>H("NormalGreyDarkBold", s:grey_dark, "", "NONE")
    ...
    " custom highlighting
    call <SID>H("StatusLineBold", s:blue, s:grey_light, "NONE")
    call <SID>H("StatusLineBlueLight", s:blue_light, s:grey_light, "none")
    call <SID>H("StatusLineBlueLightBold", s:blue_light, s:grey_light, "NONE")
    call <SID>H("StatusLineRed", s:red, s:grey_light, "none")
    call <SID>H("StatusLineRedBold", s:red, s:grey_light, "NONE")
    call <SID>H("StatusLineOrange", s:orange, s:grey_light, "none")
    call <SID>H("StatusLineOrangeBold", s:orange, s:grey_light, "NONE")
    call <SID>H("StatusLineAqua", s:aqua, s:grey_light, "none")
    call <SID>H("StatusLineAquaBold", s:aqua, s:grey_light, "NONE")
    call <SID>H("StatusLineGreen", s:green, s:grey_light, "none")
    call <SID>H("StatusLineGreenBold", s:green, s:grey_light, "NONE")
    call <SID>H("StatusLinePurple", s:purple, s:grey_light, "none")
    call <SID>H("StatusLinePurpleBold", s:purple, s:grey_light, "NONE")
    call <SID>H("StatusLineGrey", s:grey, s:grey_light, "none")
    call <SID>H("StatusLineGreyBold", s:grey, s:grey_light, "NONE")
    call <SID>H("StatusLineGreyDark", s:grey_dark, s:grey_light, "none")
    call <SID>H("StatusLineGreyDarkBold", s:grey_dark, s:grey_light, "NONE")
   ...
   " a string constant: 'this is a string'
    ...
    call <SID>H("Todo", s:red, s:grey_very_light, "NONE")
    ...
    call <SID>H("markdownBold", "", "", "NONE")
    for header in range(1, 3)
        call <SID>H("htmlH" . header, s:purple, "", "NONE")
    endfor
    for header in range(4, 6)
        call <SID>H("htmlH" . header, s:pink, "", "NONE")
    endfor
