...
highlight	NonText		gui=NONE	guibg=grey90	guifg=Blue
...
highlight	StatusLine	gui=NONE	guibg=MediumOrchid guifg=White gui=NONE
...
highlight	Type		guifg=BlueViolet	gui=NONE
...
highlight	DiffText	gui=NONE	guibg=DarkOrange
highlight	DiffDelete	gui=NONE	guifg=Blue	guibg=IndianRed
highlight	DiffChange	guibg=Orchid
highlight	DiffAdd		guibg=HotPink
highlight	WarningMsg	guifg=Red	gui=NONE
highlight	MoreMsg		gui=NONE	guifg=DeepPink4
