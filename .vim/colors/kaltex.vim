...
" Description: A cold colorscheme for GVIM/VIM with NONE, italic and underline |
...
"       Changed 'PmenuSel' and 'Todo' gui option to NONE.                      |
"==============================================================================|
...
if v:version >= 700
  ...
  if has("windows")
    ...
    hi TabLineSel ctermbg=DarkBlue ctermfg=Gray guibg=DarkBlue guifg=Gray gui=NONE
  endif
...
if has("wildmenu")
  hi WildMenu ctermbg=bg ctermfg=Green cterm=NONE guibg=bg guifg=DarkRed gui=NONE
endif
...
hi PreCondit ctermbg=bg ctermfg=DarkYellow guibg=bg guifg=#bbaa00 gui=NONE
