...
if version >= 700
    ...
    call s:h("MatchParen",  { "fg": s:norm, "bg": s:lightAccent5, "gui": "NONE" })
...
" Highlights - UI ------------------------------------------{{{
  ...
  call s:h("StatusLine",   { "fg": s:bg, "bg": s:lightAccent1, "gui": "italic", "cterm": "NONE" })
  ...
  call s:h("Title",        { "fg": s:lightAccent6, "gui": "NONE", "cterm": "NONE" })
  call s:h("ErrorMsg",     { "fg": s:lightAccent7, "bg": s:darkAccent7, "gui": "NONE", "cterm": "NONE" })
  call s:h("WarningMsg",   { "fg": s:lightAccent6, "bg": s:darkAccent6, "gui": "NONE", "cterm": "NONE" })
  call s:h("DiffAdd",      { "bg": s:lightAccent2 })
  call s:h("DiffChange",   { "bg": s:lightAccent6 })
  call s:h("DiffDelete",   { "bg": s:lightAccent7 })
  call s:h("DiffText",     { "bg": s:lightAccent6, "gui": "NONE", "cterm": "NONE" })
...
" Highlights - Generic Syntax ------------------------------{{{
  ...
  call s:h("Constant",   { "fg": s:lightAccent3, "gui": "NONE", "cterm": "NONE" })
  call s:h("String",     { "fg": s:darkAccent3 })
  call s:h("Character",  { "fg": s:darkAccent3, "gui": "NONE", "cterm": "NONE" })

  call s:h("Identifier", { "fg": s:darkAccent2 })
  call s:h("Function",   { "fg": s:lightNorm, "gui": "NONE", "cterm": "NONE" })

  call s:h("Statement",  { "fg": s:darkAccent4 })
  call s:h("Operator",   { "fg": s:darkAccent1 })
  call s:h("Keyword",    { "fg": s:lightAccent1, "gui": "NONE", "cterm": "NONE" })
  call s:h("Exception",  { "fg": s:lightAccent7 })

  call s:h("PreProc",    { "fg": s:lightAccent2, "gui": "NONE", "cterm": "NONE" })
  ...
  call s:h("Todo",       { "fg": s:lightAccent5, "bg": s:darkAccent5, "gui": "NONE", "cterm": "NONE" })
