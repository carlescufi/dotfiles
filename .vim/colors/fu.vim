...
hi NonText        ctermfg=248   ctermbg=233   cterm=NONE     guifg=#a8a8a8  guibg=#121212
...
if version >= 700
  ...
  hi MatchParen   ctermfg=157   ctermbg=237   cterm=NONE     guifg=#afffaf  guibg=#3a3a3a
...
hi Constant       ctermfg=220                 cterm=NONE     guifg=#ffd700
...
hi diffText       ctermfg=bg    ctermbg=174   cterm=NONE     guifg=#000000  guibg=#949494
