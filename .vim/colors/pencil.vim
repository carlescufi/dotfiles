...
call s:h("Error",         {"fg": s:actual_white, "bg": s:red , "gui": "NONE"     , "cterm": "NONE"     })
call s:h("Todo",          {"fg": s:actual_white, "bg": s:pink, "gui": "NONE"     , "cterm": "NONE"     })
...
call s:h("TabLineSel",    {"fg": s:blue, "bg": s:bg_subtle, "gui": "NONE", "cterm": "NONE"})
...
"call s:h("txtBold",                {"fg": s:norm  , "gui": "NONE"       , "cterm": "NONE"  })
