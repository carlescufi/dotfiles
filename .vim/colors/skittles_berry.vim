...
hi Directory      ctermfg=149 gui=NONE guifg=#afd75f
hi ErrorMsg       term=standout ctermfg=117 gui=NONE guifg=#87d7ff
...
hi VertSplit      term=reverse ctermfg=8 ctermbg=232 gui=NONE guifg=#7f7f7f guibg=#080808
...
hi WarningMsg     term=standout ctermfg=15 ctermbg=236 gui=NONE guifg=#ffffff guibg=#303030
...
hi DiffChange     term=NONE ctermbg=238 guifg=#89807d guibg=#4c4745
hi DiffDelete     ctermfg=125 ctermbg=125 guifg=#960050 guibg=#1e0010
hi DiffText       term=reverse cterm=NONE ctermfg=0 ctermbg=202 gui=NONE guifg=#ad81ff guibg=#4a7800
...
hi MatchParen     term=reverse ctermfg=0 ctermbg=208 gui=NONE guifg=#000000 guibg=#ff8700
hi Comment        ctermfg=66 guifg=#5f8787
hi Constant       ctermfg=91 gui=NONE guifg=#8700af
...
hi Todo           term=standout ctermfg=0 ctermbg=11 gui=NONE guifg=#000000 guibg=#ffff00
...
hi Conditional    ctermfg=124 gui=NONE guifg=#af0000
hi Repeat         ctermfg=124 gui=NONE guifg=#af0000
hi Label          ctermfg=228 guifg=#ffff87
hi Operator       ctermfg=214 guifg=#ffaf00
hi Keyword        ctermfg=117 gui=NONE guifg=#87d700
hi Exception      ctermfg=106 gui=NONE guifg=#87af00
hi Include        ctermfg=255 guifg=#eeeeee
hi Define         ctermfg=124 gui=NONE guifg=#af0000
hi Macro          ctermfg=186 guifg=#d7d787
hi PreCondit      ctermfg=149 gui=NONE guifg=#afd75f
...
hi SpecialChar    ctermfg=208 gui=NONE guifg=#ff8700
hi Delimiter      ctermfg=245 guifg=#8a8a8a
hi SpecialComment ctermfg=66 gui=NONE guifg=#5f8787
hi Debug          ctermfg=138 gui=NONE guifg=#af8787
