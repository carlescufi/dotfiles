...
if has('gui_running')
    ...
    hi Title guifg=#ff9900 gui=NONE ctermfg=208 cterm=NONE
    ...
    hi Identifier guifg=#ff9900 gui=NONE ctermfg=208 cterm=NONE
    hi Include guifg=#ffde00 ctermfg=220
    hi PreProc guifg=grey ctermfg=grey
    hi Operator gui=NONE guifg=#ff9900 ctermfg=208 cterm=NONE
    hi Define guifg=#ffde00 gui=NONE ctermfg=220 cterm=NONE
    hi Type guifg=#61c3fe ctermfg=39
    hi Function guifg=#ffde00 gui=NONE ctermfg=220
    hi Structure gui=NONE guifg=#ff6600 ctermfg=202 cterm=NONE
