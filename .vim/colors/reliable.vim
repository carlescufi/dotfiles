...
"
"Version 1.0.2 - changed Type highlight group to display NONE
...
if v:version >= 700
	...
	highlight TabLine guifg=#002A5C guibg=#FFFFFF gui=NONE,underline
	highlight TabLineFill guifg=#A1BAD8 gui=underline
	highlight TabLineSel guifg=#002A5C guibg=#FCB52D gui=NONE,underline
endif
...
highlight DiffDelete guifg=#7493BE guibg=#FCB52D gui=NONE
highlight DiffText guifg=#002A5C guibg=#F3E8B3 gui=NONE
...
highlight Folded guifg=#606769 guibg=#C3C6CC gui=NONE
highlight IncSearch guifg=#FFFFFF guibg=#FCB52D gui=NONE
highlight LineNr guifg=#606769 gui=NONE
highlight MatchParen guibg=#A1BAD8 gui=NONE
highlight ModeMsg guifg=#002A5C gui=NONE
highlight MoreMsg guifg=#002A5C guibg=#A1BAD8 gui=NONE
highlight NonText guifg=#606769 gui=NONE
highlight Normal guibg=#FFFFFF gui=NONE
highlight Question guifg=#002A5C guibg=#FCB52D gui=NONE
...
highlight Title guifg=#7493BE gui=NONE
highlight VertSplit guifg=#002A5C guibg=#C3C6CC gui=NONE
...
highlight Comment guifg=#606769 gui=NONE
...
highlight PreProc guifg=#7493BE gui=NONE
...
highlight Todo guifg=#FCB52D guibg=Yellow gui=NONE,underline
