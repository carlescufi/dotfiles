...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    " Interface Elements
    call <SID>X("StatusLine", "ffffff", "43c464", "NONE")
    ...
    call <SID>X("LineNr", "eeeeee", "438ec3", "NONE")
    call <SID>X("MatchParen", "", "", "")

    " Specials
    call <SID>X("Todo", "e50808", "dbf3cd", "NONE")
    ...
    call <SID>X("Comment", "22a21f", "", "NONE")
    ...
    " Jinja Highlighting
    call <SID>X("jinjaTagBlock", "ff0007", "fbf4c7", "NONE")
    call <SID>X("jinjaVarBlock", "ff0007", "fbf4c7", "")
    call <SID>X("jinjaString", "0086d2", "fbf4c7", "")
    call <SID>X("jinjaNumber", "bf0945", "fbf4c7", "NONE")
    call <SID>X("jinjaStatement", "fb660a", "fbf4c7", "NONE")
