...
hi Type         guifg=#616161          guibg=NONE      gui=NONE,italic
hi Conditional  guifg=#4d4d4d          guibg=NONE      gui=NONE
hi Todo         guifg=fg               guibg=NONE      gui=NONE,underline
hi Comment      guifg=#797979          guibg=NONE      gui=italic
hi PmenuSel     guifg=fg               guibg=#a9a9aa   gui=NONE
...
hi DiffText     guifg=#000000          guibg=#bababa   gui=NONE
hi Directory    guifg=#525252          guibg=bg        gui=NONE
hi ErrorMsg     guifg=#6f6f6f          guibg=NONE      gui=NONE
hi FoldColumn   guifg=#555555          guibg=#cccbcb   gui=NONE
...
hi MatchParen   guifg=#000000          guibg=#a8a8a8   gui=NONE
hi ModeMsg      guifg=#ffffff          guibg=#767676   gui=NONE
hi MoreMsg      guifg=#7c7c7c          guibg=bg        gui=NONE
hi NonText      guifg=#7e7e7e          guibg=bg        gui=NONE
...
hi Question     guifg=#454545          guibg=bg        gui=NONE
...
hi StatusLine   guifg=#e8e8e8          guibg=#858585   gui=NONE
...
" -----------------------------------------------------------------------------
hi VimError         guifg=#b6b6b6      guibg=#313131   gui=NONE
hi VimCommentTitle  guifg=#5c5c5c      guibg=bg        gui=NONE,italic
...
" -----------------------------------------------------------------------------
hi pythonDecorator  guifg=#3b3b3b      guibg=NONE      gui=NONE
...
if exists('g:zenesque_colors') && g:zenesque_colors==1
    ...
    hi Function     guifg=#3b1c5b          guibg=NONE      gui=NONE
    ...
    hi PmenuSel     guifg=fg               guibg=#c37a23   gui=NONE
    hi ColorColumn  guifg=NONE             guibg=#e6e6e6
    hi Cursor       guifg=bg               guibg=fg        gui=NONE
    hi CursorIM     guifg=bg               guibg=fg        gui=NONE
    hi lCursor      guifg=bg               guibg=fg        gui=NONE
    ...
    hi SpellLocal   guisp=#434343                          gui=undercurl
    hi SpellRare    guisp=#7d7d7d                          gui=undercurl
    hi StatusLine   guifg=fg               guibg=#c0bebe   gui=NONE
...
elseif exists('g:zenesque_colors') && g:zenesque_colors==2
    ...
    hi Constant     guifg=#848484          guibg=NONE      gui=NONE
    hi Statement    guifg=#a6a6a6          guibg=NONE      gui=italic
    hi Function     guifg=#919191          guibg=NONE      gui=NONE
    hi String       guifg=#838383          guibg=NONE      gui=italic
    hi Type         guifg=#838383          guibg=NONE      gui=NONE,italic
    ...
    hi PmenuSel     guifg=#000000          guibg=#a9a9aa   gui=NONE
    hi Special      guifg=#868585          guibg=NONE      gui=NONE
    hi Identifier   guifg=#626262          guibg=NONE      gui=NONE
    ...
    hi SpellLocal   guisp=#434343                          gui=undercurl
    hi SpellRare    guisp=#7d7d7d                          gui=undercurl
    hi StatusLine   guifg=#000000          guibg=#727272   gui=NONE
...
elseif exists('g:zenesque_colors') && g:zenesque_colors==3
    ...
    hi PmenuSel     guifg=bg               guibg=#9b601a   gui=NONE
