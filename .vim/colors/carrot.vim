...
highlight Search    gui=NONE guifg=#804020 guibg=#fcc657 
...
highlight Title      gui=NONE guifg=#112662 guibg=bg
...
highlight Statement  gui=NONE guifg=IndianRed3 guibg=bg      
highlight Conditional gui=NONE guifg=#7f0055 guibg=bg      
highlight Todo       gui=none guifg=White   guibg=Grey20   term=standout       
highlight Type       gui=NONE guifg=Brown   guibg=bg      
