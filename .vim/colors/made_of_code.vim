...
hi StatusLine ctermfg=231 ctermbg=59 cterm=NONE guifg=#f8f8f8 guibg=#4e4f5b gui=NONE
...
hi Todo ctermfg=133 ctermbg=0 cterm=inverse,NONE guifg=#c050c2 guibg=#000000 gui=inverse,NONE,italic
