...
hi FoldColumn   guifg=#40587c           guibg=#dcdda8           gui=NONE
...
hi MatchParen   guifg=#000000           guibg=#949555           gui=NONE
hi ModeMsg      guifg=#ffffff           guibg=#a15c55           gui=NONE
hi MoreMsg      guifg=#3c613b           guibg=bg                gui=NONE
hi NonText      guifg=#93aaab           guibg=bg                gui=NONE

hi Pmenu        guifg=#866a45           guibg=#b7b7a7           gui=NONE
hi PmenuSel     guifg=#a5a5a5           guibg=#716d51           gui=NONE
hi PmenuSbar    guifg=#ffffff           guibg=#999666           gui=NONE
hi PmenuThumb   guifg=#ffffff           guibg=#7B7939           gui=NONE

hi Question     guifg=#496844           guibg=bg                gui=NONE
...
hi Todo         guifg=#675220           guibg=NONE              gui=NONE
" -----------------------------------------------------------------------------
hi VimError         guifg=#9e3224       guibg=#000000   gui=NONE
hi VimCommentTitle  guifg=#5a7471       guibg=bg        gui=NONE,italic
hi qfFileName       guifg=#5b7982       guibg=NONE      gui=italic
hi qfLineNr         guifg=#e87334       guibg=NONE      gui=NONE
hi qfError          guifg=#673420       guibg=NONE      gui=NONE

" -----------------------------------------------------------------------------
hi pythonDecorator  guifg=#6c1111 guibg=NONE gui=NONE
