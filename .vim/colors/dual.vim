...
"              dark colors. On GVIM, it uses bright colors without NONE,       |
...
if v:version >= 700
  ...
  hi PmenuSel ctermbg=DarkRed ctermfg=White cterm=NONE guibg=#336600 guifg=bg gui=NONE
  ...
  if has("windows")
    ...
    hi TabLineSel ctermbg=DarkBlue ctermfg=fg guibg=#003399 guifg=bg gui=NONE
  endif
...
hi Title ctermbg=bg ctermfg=Magenta cterm=NONE guibg=bg guifg=Blue gui=NONE
...
if has("vertsplit")
  hi VertSplit ctermbg=Gray ctermfg=DarkBlue cterm=NONE guibg=Gray75 guifg=#003399 gui=NONE
endif

if has("wildmenu")
  hi WildMenu ctermbg=bg ctermfg=Blue guibg=bg guifg=#003399 gui=NONE
endif
