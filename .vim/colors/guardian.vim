...
hi Question    guibg=bg	guifg=#ccffcc  gui=NONE ctermbg=bg ctermfg=10
...
hi Constant    guibg=bg	   guifg=white	  gui=NONE    ctermbg=8	  ctermfg=15
hi String      guibg=bg	   guifg=#ffffcc  gui=italic  ctermbg=bg  ctermfg=14
hi Character   guibg=bg	   guifg=#ffffcc  gui=NONE    ctermbg=bg  ctermfg=14
hi Number      guibg=bg	   guifg=#bbddff  gui=NONE    ctermbg=1   ctermfg=15
hi Boolean     guibg=bg	   guifg=#bbddff  gui=none    ctermbg=1   ctermfg=15
hi Float       guibg=bg	   guifg=#bbddff  gui=NONE    ctermbg=1   ctermfg=15

hi Identifier  guibg=bg    guifg=#ffddaa  gui=NONE    ctermbg=bg  ctermfg=12
hi Function    guibg=bg    guifg=#ffddaa  gui=NONE    ctermbg=bg  ctermfg=12
hi Statement   guibg=bg    guifg=#ffffcc  gui=NONE    ctermbg=bg  ctermfg=14

hi Conditional guibg=bg    guifg=#ff6666  gui=NONE    ctermbg=bg  ctermfg=12
hi Repeat      guibg=bg    guifg=#ff9900  gui=NONE    ctermbg=4   ctermfg=14
hi Label       guibg=bg    guifg=#ffccff  gui=NONE    ctermbg=bg   ctermfg=13
hi Operator    guibg=bg    guifg=#cc9966  gui=NONE    ctermbg=6   ctermfg=15
hi Keyword     guibg=bg	   guifg=#66ffcc  gui=NONE    ctermbg=bg  ctermfg=10
hi Exception   guibg=bg	   guifg=#66ffcc  gui=NONE    ctermbg=bg  ctermfg=10

hi PreProc	  guibg=bg	 guifg=#ffcc99	gui=NONE ctermbg=4  ctermfg=14
hi Include	  guibg=bg	 guifg=#99cc99	gui=NONE ctermbg=bg ctermfg=10
hi link Define	  Include
hi link Macro	  Include
hi link PreCondit Include

hi Type		  guibg=bg	 guifg=#ff7788  gui=NONE    ctermbg=bg	ctermfg=12
hi StorageClass	  guibg=bg	 guifg=#99cc99  gui=NONE    ctermbg=bg	ctermfg=10
hi Structure	  guibg=bg	 guifg=#99ff99  gui=NONE    ctermbg=bg	ctermfg=10
...
hi Title    guibg=#445566  guifg=white	  gui=NONE    ctermbg=1	  ctermfg=15
hi Ignore   guibg=bg	   guifg=#cccccc  gui=italic  ctermbg=bg  ctermfg=8
hi Error    guibg=#ff0000  guifg=white	  gui=NONE    ctermbg=12  ctermfg=15
hi Todo	    guibg=#556677  guifg=#ff0000  gui=NONE    ctermbg=1	  ctermfg=12

hi htmlH2 guibg=bg guifg=fg gui=NONE ctermbg=8 ctermfg=fg
