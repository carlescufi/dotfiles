...
call s:HL('colorsboxRedBold', s:red, s:none, s:NONE)
call s:HL('colorsboxGreen', s:green)
call s:HL('colorsboxGreenBold', s:green, s:none, s:NONE)
call s:HL('colorsboxYellow', s:yellow)
call s:HL('colorsboxYellowBold', s:yellow, s:none, s:NONE)
call s:HL('colorsboxBlue', s:blue)
call s:HL('colorsboxBlueBold', s:blue, s:none, s:NONE)
call s:HL('colorsboxPurple', s:purple)
call s:HL('colorsboxPurpleBold', s:purple, s:none, s:NONE)
call s:HL('colorsboxAqua', s:aqua)
call s:HL('colorsboxAquaBold', s:aqua, s:none, s:NONE)
call s:HL('colorsboxOrange', s:orange)
call s:HL('colorsboxOrangeBold', s:orange, s:none, s:NONE)
