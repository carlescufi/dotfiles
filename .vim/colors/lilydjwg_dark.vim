...
hi IncSearch gui=NONE,reverse guifg=#33ff1c guibg=#3454ff cterm=NONE,reverse ctermfg=40 ctermbg=69
hi LineNr guifg=#FF77DD ctermfg=212
hi MatchParen guifg=#99FF99 guibg=#444444 ctermfg=120 ctermbg=238
hi ModeMsg gui=NONE guifg=#AAAA3C guibg=#222211 cterm=NONE ctermfg=136
...
hi Question gui=NONE guifg=#009966 guibg=#113322 cterm=NONE ctermfg=42
...
hi Statement gui=NONE guifg=#d86868 guibg=#2d2222 cterm=NONE ctermfg=167
...
hi Todo gui=NONE,underline guifg=#FF4444 guibg=#333300 cterm=NONE,underline ctermfg=203 ctermbg=58
