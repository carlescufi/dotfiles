...
hi LineNr           guibg=#F1FFC1	guifg=DarkGray	gui=NONE,italic 
hi StatusLineNC     guibg=#bbbbbb	guifg=White		gui=NONE,italic
...
hi SignColumn       guibg=#F1FFC1	guifg=black		gui=NONE

hi Directory	    guibg=white		guifg=Black		gui=NONE,italic 
hi Tooltip   	    guibg=#F1FFC1	guifg=DarkGray	gui=NONE,italic 
hi FoldColumn       guibg=#F1FFC1	guifg=Black		gui=none 
hi VertSplit        guibg=#F1FFC1	guifg=#F1FFC1	gui=none 
hi Wildmenu         guibg=White		guifg=Black		gui=NONE 
...
hi Visual	        guibg=#4485FF	guifg=white		gui=NONE
hi VisualNos	    guibg=#4485FF	guifg=white		gui=NONE
...
"hi Number			guibg=white 	guifg=black		gui=NONE
...
hi Exception 	    guibg=white 	guifg=black		gui=NONE
" return ~olive   
...
hi Include			guibg=white 	guifg=#141312 	gui=NONE
