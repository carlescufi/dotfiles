...
highlight Search	guibg=#bbbbbb	gui=NONE
highlight Visual	guifg=#DADADA
highlight Folded	guifg=#ffffff	guibg=#666666
highlight Cursor	guifg=#666666	guibg=#000000	gui=NONE
highlight Special	guifg=#7F007F	guibg=#eeeeff	gui=NONE
...
highlight Statement	guifg=#007F7F			gui=NONE
highlight Type		guifg=#0000ff   gui=NONE
highlight Function	guifg=#007F7F	gui=NONE
highlight LineNr	guifg=#000000	guibg=#bbbbbb
highlight FoldColumn	guifg=#000000	guibg=#dddddd
highlight Define	guifg=#00007F	guibg=#ddddff gui=NONE
highlight Number	guifg=#000000	guibg=#eeffff gui=NONE
highlight Subtitle	guifg=#000000	guibg=#66bbbb gui=NONE,underline
highlight String	guifg=#7F007F	guibg=#ffdddd
highlight Delimiter	guifg=#000000	guibg=#dde0dd	gui=NONE
highlight PreProc	guifg=#0000ff	guibg=#ffffff	gui=NONE
highlight Constant	guifg=#000000	guibg=#aaaaaa gui=underline,NONE
