...
highlight Error		ctermfg=grey	ctermbg=black	cterm=NONE
highlight Identifier 	ctermfg=black			cterm=NONE
highlight Normal 	ctermfg=black
highlight PreProc 	ctermfg=black
highlight Special	ctermfg=black			cterm=NONE
highlight Statement 	ctermfg=black			cterm=NONE,underline
highlight Type 		ctermfg=black			cterm=NONE
highlight Visual	ctermfg=black	ctermbg=grey

" GUI Colors
highlight Comment	guifg=grey
highlight Constant 	guifg=grey			gui=NONE
highlight Cursor			guibg=black
highlight CursorLine 	guibg=grey
highlight Error		guifg=grey	guibg=black	gui=NONE
highlight Identifier 	guifg=black			gui=NONE
highlight Normal 	guifg=black
highlight PreProc 	guifg=black			gui=italic
highlight Special	guifg=black			gui=NONE
highlight Statement 	guifg=black			gui=NONE,underline
