...
hi Statement   guifg=#607080 gui=NONE
hi Operator  guifg=#747270 gui=NONE
" HTML: arguments
"hi Type       guifg=#202020 gui=none
hi Type        guifg=#606060 gui=NONE
" Python: Standard exceptions, True&False
hi Structure  guifg=#405060 gui=underline,NONE
hi Function   guifg=#203040 gui=NONE
...
hi PreProc    guifg=#705060 gui=NONE
" Cheetah: def, attr, for and so on, Python: Decorators
hi Define      guifg=#905080 gui=NONE

hi Error      guifg=#a02000 guibg=white gui=NONE,underline
hi Todo       guifg=#848280 guibg=NONE gui=NONE,underline
...
hi SpecialKey guifg=#c4c2c0 guibg=#e4e2e0 gui=italic,NONE  
...
hi DiffDelete guifg=NONE guibg=#f0a0a0 gui=italic,NONE
