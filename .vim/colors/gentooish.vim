...
if has('gui_running')
    ...
    hi SpecialKey     term=NONE ctermfg=58
    hi NonText        term=NONE ctermfg=240
    hi Directory      term=NONE ctermfg=120
    ...
    hi MoreMsg        term=NONE ctermfg=252
    hi ModeMsg        term=NONE ctermfg=252
    hi LineNr         term=underline ctermfg=250 ctermbg=235
    hi Question       term=standout ctermfg=252
    hi StatusLine     term=NONE,reverse cterm=NONE ctermfg=252 ctermbg=236
    hi StatusLineNC   term=reverse cterm=NONE ctermfg=240 ctermbg=236
    hi VertSplit      term=reverse ctermfg=252 ctermbg=236
    hi Title          term=NONE ctermfg=95
    hi Visual         term=reverse ctermfg=231 ctermbg=60
    hi VisualNOS      term=NONE,underline ctermfg=252 ctermbg=16
    hi WarningMsg     term=standout ctermfg=252 ctermbg=95
    hi WildMenu       term=standout cterm=NONE ctermfg=177 ctermbg=16
    hi Folded         term=standout ctermfg=142 ctermbg=16
    hi FoldColumn     term=standout ctermfg=252 ctermbg=16
    hi DiffAdd        term=NONE ctermfg=252 ctermbg=59
    hi DiffChange     term=NONE ctermbg=54
    hi DiffDelete     term=NONE ctermfg=252 ctermbg=95
    ...
    hi Comment        term=NONE ctermfg=241
    hi Constant       term=underline ctermfg=142
    hi Special        term=NONE ctermfg=222
    hi Identifier     term=underline ctermfg=74
    hi Statement      term=NONE ctermfg=77
    ...
    hi Number         ctermfg=179
    hi Boolean        ctermfg=46
    hi User1          cterm=NONE ctermfg=246 ctermbg=236
    hi User2          cterm=NONE ctermfg=120 ctermbg=236
    if v:version >= 700
        ...
        hi PmenuSel       cterm=NONE ctermfg=177 ctermbg=16
