...
hi StatusLine   guibg=#000000 guifg=#d8fa3c gui=NONE
...
hi Folded       guibg=#434e56 guifg=#adc6ee gui=NONE
...
" @ruby require, load
hi Include guifg=#f8f8f8 gui=NONE
...
hi Define guifg=#f8f8f8 gui=NONE

" case when end do..end attr_reader
hi Statement guifg=#f8f8f8 gui=NONE
...
" @diff method name?
" "^M"
hi PreProc guifg=#d8fa3c gui=NONE
