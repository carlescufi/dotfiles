...
hi IncSearch	guifg=bg guibg=cyan gui=NONE
...
hi Visual gui=NONE guifg=black guibg=#84AF84
hi WarningMsg	guifg=#F60000 gui=underline

" syntax highlighting groups
hi Comment guifg=DarkGray
hi Constant guifg=#72A5E4 gui=NONE
hi Number guifg=chartreuse2 gui=NONE
...
hi Todo guibg=#444444 guifg=#00FFFF gui=NONE
...
hi DiffText   gui=NONE guibg=firebrick3
