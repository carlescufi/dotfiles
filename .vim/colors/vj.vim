...
hi ModeMsg guifg=yellow3 gui=NONE
"hi MoreMsg		
"hi NonText		
"hi Question	
...
"hi Ignore		
"hi Error		
hi Todo guifg=yellow3 guibg=blue3 gui=NONE
...
hi Function     guifg=#bab588 guibg=bg gui=NONE 
...
highlight Keyword gui=NONE guifg=grey guibg=bg
highlight Exception gui=NONE guifg=#d0a8ad guibg=bg
"""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
hi Identifier   guifg=#856075  "gui=NONE
...
hi LineNr       guibg=#409ae0 guifg=darkblue gui=NONE
...
hi SpecialKey	ctermfg=darkgreen
hi NonText	cterm=NONE ctermfg=darkgrey ctermbg=grey
hi Directory	ctermfg=darkcyan
hi ErrorMsg	cterm=NONE ctermfg=7 ctermbg=1
hi IncSearch	ctermfg=yellow ctermbg=darkyellow cterm=NONE
