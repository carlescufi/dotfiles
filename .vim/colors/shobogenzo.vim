...
hi IncSearch      term=reverse cterm=NONE ctermfg=232 ctermbg=215 gui=reverse guifg=#ffaf5f guibg=#080808
...
hi WarningMsg     term=none cterm=NONE ctermfg=15 ctermbg=202 gui=none guifg=#ffffff guibg=#ff5f00
hi ModeMsg        term=NONE ctermfg=95 gui=NONE guifg=#875f5f
hi MoreMsg        term=reverse cterm=none ctermfg=229 ctermbg=95 gui=none guifg=#ffffaf guibg=#875f5f
hi Question       term=none cterm=NONE ctermfg=214 guifg=#ffaf00
hi StatusLine     term=NONE,reverse cterm=none ctermfg=229 ctermbg=95 gui=none guifg=#ffffaf guibg=#875f5f
...
hi DiffAdd        term=NONE ctermfg=229 ctermbg=34 guifg=#ffffaf guibg=#00af00
hi DiffChange     term=NONE ctermfg=229 ctermbg=32 guifg=#ffffaf guibg=#0087d7
hi DiffDelete     term=NONE ctermfg=229 ctermbg=124 guifg=#ffffaf guibg=#af0000
...
hi SpecialKey     term=NONE ctermfg=32 ctermbg=none guifg=#0087d7
hi Title          term=NONE cterm=NONE ctermfg=130 ctermbg=232 guifg=#af5f00 guibg=#080808
hi Visual         term=none cterm=reverse ctermfg=80 ctermbg=59 gui=reverse guifg=#5f5f5f guibg=#5fd7d7

hi Comment        term=NONE ctermfg=195 guifg=#d7ffff
...
hi Identifier     term=NONE cterm=none ctermfg=210 ctermbg=none guifg=#ff8787
...
hi Special        term=NONE ctermfg=224 guifg=#ffd7d7
hi Function       term=NONE cterm=NONE ctermfg=210 ctermbg=none guifg=#ff8787
...
hi TaglistTagName cterm=NONE ctermfg=26 ctermbg=none guifg=#005fd7
