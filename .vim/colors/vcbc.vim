...
hi Statement 	cterm=NONE		ctermfg=Blue		ctermbg=White		gui=NONE			guifg=Blue			guibg=NONE
...
hi DiffText		cterm=NONE		ctermfg=White		ctermbg=DarkRed		gui=NONE,italic		guifg=Red			guibg=#fff0f0
