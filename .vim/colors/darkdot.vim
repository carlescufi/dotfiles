...
hi Special	ctermfg=blue	cterm=NONE	guifg=#6666ff	gui=NONE
...
if v:version >= 700
	...
	hi TabLineSel	cterm=NONE	ctermbg=none	ctermfg=none	gui=none	guibg=#bbbbbb	guifg=#000000
	hi TabLineFill 	cterm=inverse	ctermbg=none	ctermfg=none	gui=none	guibg=#bbbbbb	guifg=#000000

	hi MatchParen	cterm=NONE	ctermbg=none	ctermfg=green	gui=NONE	guibg=bg	guifg=#44ff44
endif
