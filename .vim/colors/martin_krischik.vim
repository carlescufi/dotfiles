...
elseif (&term == "builtin_gui")
    ...
    highlight NonText		gui=NONE		guifg=Blue	    guibg=grey80
    ...
    highlight MoreMsg		gui=NONE		guifg=SeaGreen
    highlight Question		gui=NONE		guifg=SeaGreen
    "
    ...
    " Group: Status line {{{3
    "
    highlight StatusLine	gui=NONE,reverse	guifg=LightBlue2    guibg=black
    ...
    highlight TabLineSel	gui=NONE,reverse	guifg=LightBlue2    guibg=black
    "
    ...
    highlight DiffDelete	gui=NONE		guifg=Blue	    guibg=LightCyan
    highlight DiffText		gui=NONE				    guibg=Red
    "
    " Group: Fold colors {{{3
    "
    ...
    "
    highlight Conditional	gui=NONE		guifg=DodgerBlue4
    highlight Exception		gui=none		guifg=SlateBlue4
    highlight Keyword		gui=NONE		guifg=RoyalBlue4
    highlight Label		gui=none		guifg=SlateBlue3
    highlight Operator		gui=none		guifg=RoyalBlue3
    highlight Repeat		gui=NONE		guifg=DodgerBlue3
...
elseif	(&term == "xterm")  ||
    ...
    highlight SpecialKey	term=NONE				    ctermfg=DarkBlue	ctermbg=LightGray
    highlight Title		term=NONE				    ctermfg=DarkMagenta	ctermbg=LightGray
    highlight LineNr		term=underline				    ctermfg=DarkRed	ctermbg=DarkGray
    highlight NonText		term=NONE				    ctermfg=LightBlue	ctermbg=LightGray
    ...
    highlight ModeMsg		term=NONE	    cterm=NONE					ctermbg=LightGray
    highlight MoreMsg		term=NONE				    ctermfg=DarkGreen	ctermbg=LightGray
    ...
    " Group: Status line {{{3
    "
    highlight StatusLine	term=NONE,reverse   cterm=NONE,reverse
    ...
    highlight VisualNOS		term=NONE,underline cterm=NONE,underline
    "
    " Group: tab pages line {{{3
    "
    highlight TabLine		term=reverse	    cterm=reverse
    highlight TabLineFill	term=reverse	    cterm=reverse
    highlight TabLineSel	term=NONE,reverse   cterm=NONE,reverse
    "
    " Group: Menu colors {{{3
    "
    ...
    " Group: Diff colors {{{3
    "
    highlight DiffAdd		term=NONE							ctermbg=LightBlue
    highlight DiffChange	term=NONE							ctermbg=LightMagenta
    highlight DiffDelete	term=NONE				    ctermfg=LightBlue	ctermbg=LightCyan
    highlight DiffText		term=reverse	    cterm=NONE					ctermbg=LightRed
    "
    " Group: Fold colors {{{3
    "
    ...
    " Group: Other Syntax Highlight Colors {{{3
    "
    highlight Directory		term=NONE				    ctermfg=DarkBlue	ctermbg=LightGray
    ...
    "
    highlight Comment		term=NONE				    ctermfg=DarkGray	ctermbg=LightGray
    "
    " Group: Constant colors group {{{3
    "
    ...
    " Group: Statement colors group {{{3
    "
    highlight Conditional	term=NONE				    ctermfg=DarkBlue	ctermbg=LightGray
    highlight Exception		term=NONE				    ctermfg=DarkBlue	ctermbg=LightGray
    highlight Keyword		term=NONE				    ctermfg=DarkBlue	ctermbg=LightGray
    highlight Label		term=NONE				    ctermfg=DarkBlue	ctermbg=LightGray
    highlight Operator		term=NONE				    ctermfg=DarkBlue	ctermbg=LightGray
    highlight Repeat		term=NONE				    ctermfg=DarkBlue	ctermbg=LightGray
    highlight Statement		term=NONE				    ctermfg=DarkBlue	ctermbg=LightGray
    "
    " Group: Preprocessor colors group {{{3
    "
    ...
    " Group: special symbol group {{{3
    "
    highlight Special		term=NONE				    ctermfg=DarkMagenta	ctermbg=LightGray
    highlight SpecialChar	term=NONE				    ctermfg=DarkMagenta	ctermbg=LightGray
    highlight Tag		term=NONE				    ctermfg=DarkMagenta	ctermbg=LightGray
    highlight Delimiter		term=NONE				    ctermfg=DarkMagenta	ctermbg=LightGray
    highlight SpecialComment	term=NONE				    ctermfg=DarkMagenta	ctermbg=LightGray
    highlight Debug		term=NONE				    ctermfg=DarkMagenta	ctermbg=LightGray
    "
    " Group: text that stands out {{{3
    "
