...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("Typedef", s:lyme, "", "NONE")
	...
	call <SID>X("Number", s:orange, "", "")
	call <SID>X("Boolean", s:green, "", "NONE")
	...
	call <SID>X("StorageClass", s:peach, "", "NONE")
	call <SID>X("Structure", s:blue, "", "NONE")
	...
	call <SID>X("vimAutoEvent", s:aqua, "", "NONE")
	...
	call <SID>X("vimSynType", s:olive, "", "NONE")
	...
	call <SID>X("makeStatement", s:aqua, "", "NONE")
	call <SID>X("makeCommands", s:foreground, "", "")
	call <SID>X("makeSpecial", s:orange, "", "NONE")
	...
	call <SID>X("cppSTLfunctional", s:foreground, "", "NONE")
	call <SID>X("cppSTLiterator", s:foreground, "", "NONE")
	call <SID>X("cppExceptions", s:red, "", "")
	call <SID>X("cppStatement", s:blue, "", "")
	call <SID>X("cppStorageClass", s:peach, "", "NONE")
	...
	call <SID>X("lexPatTagZone", s:olive, "", "NONE")
	call <SID>X("lexMorePat", s:olive, "", "NONE")
	call <SID>X("lexOptions", s:olive, "", "NONE")
	...
	call <SID>X("nasmStorage", s:aqua, "", "NONE")
	call <SID>X("nasmLabel", s:lyme, "", "")
	call <SID>X("nasmDirective", s:blue, "", "NONE")
	call <SID>X("nasmLocalLabel", s:orange, "", "")

	" GAS highlighting
	call <SID>X("gasSymbol", s:lyme, "", "")
	call <SID>X("gasDirective", s:blue, "", "NONE")
	...
	call <SID>X("gasDirectiveStore", s:foreground, "", "NONE")

	" MIPS highlighting
	call <SID>X("mipsInstruction", s:lyme, "", "")
	call <SID>X("mipsRegister", s:peach, "", "")
	call <SID>X("mipsLabel", s:aqua, "", "NONE")
	call <SID>X("mipsDirective", s:purple, "", "NONE")

	" Shell/Bash highlighting
	call <SID>X("bashStatement", s:foreground, "", "NONE")
	call <SID>X("shDerefVar", s:aqua, "", "NONE")
	...
	call <SID>X("shCaseEsac", s:aqua, "", "NONE")
	...
	" Python Highlighting
	call <SID>X("pythonImport", s:lyme, "", "NONE")
	...
	call <SID>X("pythonEscape", s:olive, "", "NONE")
	call <SID>X("pythonStrFormatting", s:olive, "", "NONE")
	call <SID>X("pythonBoolean", s:green, "", "NONE")
	call <SID>X("pythonExClass", s:red, "", "")
	call <SID>X("pythonBytesEscape", s:olive, "", "NONE")
	...
	call <SID>X("javaScopeDecl", s:blue, "", "NONE")
	call <SID>X("javaStorageClass", s:peach, "", "NONE")
	call <SID>X("javaBoolean", s:peach, "", "")

	" JavaScript Highlighting
	call <SID>X("javaScriptBraces", s:foreground, "", "")
	call <SID>X("javaScriptParens", s:blue, "", "")
	call <SID>X("javaScriptIdentifier", s:peach, "", "NONE")
	call <SID>X("javaScriptFunction", s:lyme, "", "NONE")
	...
	" HTML Highlighting
	call <SID>X("htmlTitle", s:green, "", "NONE")
	call <SID>X("htmlH1", s:green, "", "NONE")
	call <SID>X("htmlH2", s:aqua, "", "NONE")
	call <SID>X("htmlH3", s:purple, "", "NONE")
	call <SID>X("htmlH4", s:orange, "", "NONE")
	...
	call <SID>X("htmlBoldItalic", s:peach, "", "NONE")
	call <SID>X("htmlTagN", s:lyme, "", "NONE")
	call <SID>X("htmlSpecialTagName", s:orange, "", "NONE")
	call <SID>X("htmlComment", s:comment, "", "NONE")
	call <SID>X("htmlCommentPart", s:comment, "", "")

	" Markdown Highlighting
	call <SID>X("markdownH1", s:lyme, "", "NONE")
	call <SID>X("markdownBlockquote", s:lyme, "", "")
	call <SID>X("markdownCodeBlock", s:purple, "", "NONE")
	call <SID>X("markdownLink", s:blue, "", "NONE")
	call <SID>X("mkdCode", s:olive, "", "none")
	call <SID>X("mkdLink", s:blue, "", "NONE")
	...
	call <SID>X("stapProbe", s:aqua, "", "NONE")
	call <SID>X("stapStat", s:peach, "", "NONE")
	...
	call <SID>X("stapType", s:lyme, "", "NONE")
	...
	call <SID>X("dtracePredicate", s:purple, "", "NONE")
	call <SID>X("dtraceComment", s:comment, "", "")
	call <SID>X("dtraceFunction", s:foreground, "", "")
	call <SID>X("dtraceAggregatingFunction", s:blue, "", "NONE")
	call <SID>X("dtraceStatement", s:peach, "", "NONE")
	call <SID>X("dtraceIdentifier", s:lyme, "", "")
	call <SID>X("dtraceOption", s:lyme, "", "")
	call <SID>X("dtraceConstant", s:orange, "", "")
	call <SID>X("dtraceType", s:lyme, "", "NONE")

	" PlantUML Highlighting
	call <SID>X("plantumlPreProc", s:orange, "", "NONE")
	...
	call <SID>X("plantumlClassPublic", s:olive, "", "NONE")
	...
	call <SID>X("plantumlTypeKeyword", s:blue, "", "NONE")
	call <SID>X("plantumlKeyword", s:lyme, "", "NONE")
	call <SID>X("plantumlType", s:blue, "", "NONE")
	call <SID>X("plantumlBlock", s:purple, "", "NONE")
	call <SID>X("plantumlPreposition", s:orange, "", "")
	call <SID>X("plantumlLayout", s:blue, "", "NONE")
	call <SID>X("plantumlNote", s:orange, "", "")
	call <SID>X("plantumlLifecycle", s:aqua, "", "")
	call <SID>X("plantumlParticipant", s:foreground, "", "NONE")

	" Haskell Highlighting
	call <SID>X("haskellType", s:aqua, "", "NONE")
	call <SID>X("haskellIdentifier", s:orange, "", "NONE")
	call <SID>X("haskellOperators", s:lyme, "", "")
	call <SID>X("haskellWhere", s:foreground, "", "NONE")
	call <SID>X("haskellDelimiter", s:aqua, "", "")
	call <SID>X("haskellImportKeywords", s:lyme, "", "")
	call <SID>X("haskellStatement", s:purple, "", "NONE")

	" SQL/MySQL Highlighting
	call <SID>X("sqlStatement", s:lyme, "", "NONE")
	call <SID>X("sqlType", s:blue, "", "NONE")
	call <SID>X("sqlKeyword", s:lyme, "", "")
	call <SID>X("sqlOperator", s:aqua, "", "")
	call <SID>X("sqlSpecial", s:green, "", "NONE")
	call <SID>X("mysqlVariable", s:olive, "", "NONE")
	call <SID>X("mysqlType", s:blue, "", "NONE")
	call <SID>X("mysqlKeyword", s:lyme, "", "")
	call <SID>X("mysqlOperator", s:aqua, "", "")
	call <SID>X("mysqlSpecial", s:green, "", "NONE")
	...
	call <SID>X("octaveBeginKeyword", s:purple, "", "NONE")
	call <SID>X("octaveElseKeyword", s:purple, "", "NONE")
	call <SID>X("octaveEndKeyword", s:purple, "", "NONE")
	call <SID>X("octaveStatement", s:lyme, "", "")

	" Fortran Highlighting
	call <SID>X("fortranUnitHeader", s:foreground, "", "NONE")
	call <SID>X("fortranType", s:lyme, "", "NONE")
	call <SID>X("fortranStructure", s:blue, "", "NONE")
	call <SID>X("fortranStorageClass", s:peach, "", "NONE")
	call <SID>X("fortranStorageClassR", s:peach, "", "NONE")
	...
	call <SID>X("perlFunction", s:lyme, "", "NONE")
	...
	call <SID>X("perlStatementInclude", s:aqua, "", "NONE")
	call <SID>X("perlStatementScalar", s:purple, "", "")
	call <SID>X("perlSubName", s:aqua, "", "NONE")
	call <SID>X("perlSpecialString", s:olive, "", "NONE")

	" Lua Highlighting
	call <SID>X("luaFunc", s:foreground, "", "")
	call <SID>X("luaIn", s:blue, "", "NONE")
	call <SID>X("luaFunction", s:lyme, "", "")
	call <SID>X("luaStatement", s:blue, "", "")
	call <SID>X("luaRepeat", s:blue, "", "NONE")
	call <SID>X("luaCondStart", s:purple, "", "NONE")
	call <SID>X("luaTable", s:aqua, "", "NONE")
	call <SID>X("luaConstant", s:green, "", "NONE")
	call <SID>X("luaElse", s:purple, "", "NONE")
	call <SID>X("luaCondElseif", s:purple, "", "NONE")
	...
	call <SID>X("clojureSpecial", s:blue, "", "NONE")
