...
if &background == "dark"
    ...
    hi MatchParen   ctermbg=0 cterm=NONE
    hi Pmenu        ctermbg=0
...
if &background == "dark"
    ...
    exe "hi Label        guifg=".s:white        ." gui=NONE"
    ...
    exe "hi ErrorMsg     guifg=".s:white        ." gui=NONE guibg=".s:darkred
    ...
    exe "hi StatusLine   guifg=".s:lightgrey    ." gui=NONE guibg=".s:black
    ...
    exe "hi DiffAdd      gui=NONE guibg=".s:darkgreen
