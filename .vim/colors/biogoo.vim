...
hi Include			guifg=#295498 gui=NONE
hi IncSearch		guifg=#ffffff guibg=#0000ff gui=NONE
...
hi PreCondit		guifg=#295498 gui=NONE
hi PreProc			guifg=#0c3b6b gui=NONE
...
hi TabLineSel		guifg=#00007f guibg=#eeeeee gui=NONE
hi Title			guifg=#404040 gui=NONE
hi Todo				guifg=#00007f guibg=#e5e5e5 gui=underline
hi Type				guifg=#540054 gui=NONE
