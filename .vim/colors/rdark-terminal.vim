...
hi SpecialKey term=NONE cterm=NONE ctermbg=bg ctermfg=196
hi NonText term=NONE cterm=NONE ctermbg=8 ctermfg=236
hi MatchParen term=reverse cterm=NONE ctermbg=215 ctermfg=23
hi Comment term=NONE cterm=NONE ctermbg=bg ctermfg=245
hi Constant term=underline cterm=NONE ctermbg=bg ctermfg=113
hi Special term=NONE cterm=NONE ctermbg=bg ctermfg=248
hi Keyword term=NONE cterm=NONE ctermbg=bg ctermfg=255
hi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=252
hi Statement term=NONE cterm=NONE ctermbg=bg ctermfg=74
...
hi StatusLine term=reverse,NONE cterm=NONE ctermbg=250 ctermfg=0
...
hi Directory term=NONE cterm=NONE ctermbg=bg ctermfg=231
...
hi MoreMsg term=NONE cterm=NONE ctermbg=bg ctermfg=74
hi ModeMsg term=NONE cterm=NONE ctermbg=bg ctermfg=fg
hi TabLine term=underline cterm=underline ctermbg=16 ctermfg=102
hi TabLineSel term=NONE cterm=NONE ctermbg=59 ctermfg=255
...
hi Title term=NONE cterm=NONE ctermbg=bg ctermfg=215
...
hi DiffAdd term=NONE cterm=NONE ctermbg=0 ctermfg=113
hi DiffChange term=NONE cterm=NONE ctermbg=0 ctermfg=fg
hi DiffDelete term=NONE cterm=NONE ctermbg=0 ctermfg=215
