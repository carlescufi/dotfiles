...
hi DiffAdd      ctermfg=40      ctermbg=236     cterm=NONE
hi DiffChange   ctermfg=184     ctermbg=236     cterm=NONE
hi DiffDelete   ctermfg=160     ctermbg=236     cterm=NONE
hi DiffText     ctermfg=236     ctermbg=184     cterm=NONE
hi ErrorMsg     ctermfg=196     ctermbg=235     cterm=NONE
hi Folded       ctermfg=175     ctermbg=236     cterm=none
hi IncSearch    ctermfg=140     ctermbg=240     cterm=NONE
hi LineNr       ctermfg=238     ctermbg=235     cterm=none
hi MatchParen   ctermfg=110     ctermbg=240     cterm=NONE
...
hi Directory    ctermfg=254     cterm=NONE
...
hi Todo         ctermfg=61      ctermbg=235      cterm=NONE
