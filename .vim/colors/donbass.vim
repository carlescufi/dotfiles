...
hi WarningMsg    ctermfg=196  guifg=#ff0000  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
hi ModeMsg       ctermfg=254  guifg=#e4e4e4  ctermbg=28   guibg=#008700  cterm=NONE  gui=NONE
hi MoreMsg       ctermfg=254  guifg=#e4e4e4  ctermbg=28   guibg=#008700  cterm=NONE  gui=NONE
hi Question      ctermfg=52   guifg=#5f0000  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
...
hi TabLineSel    ctermfg=16   guifg=#000000  ctermbg=248  guibg=#a8a8a8  cterm=NONE  gui=NONE
...
hi FoldColumn    ctermfg=124  guifg=#af0000  ctermbg=250  guibg=#bcbcbc  cterm=NONE  gui=NONE
...
hi NonText       ctermfg=238  guifg=#444444  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
hi SpecialKey    ctermfg=239  guifg=#4e4e4e  ctermbg=250  guibg=#bcbcbc  cterm=NONE  gui=NONE
hi Title         ctermfg=254  guifg=#e4e4e4  ctermbg=167  guibg=#df5f5f  cterm=none  gui=none
hi Directory     ctermfg=24   guifg=#005f87  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
...
hi Statement     ctermfg=28   guifg=#008700  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
hi Type          ctermfg=25   guifg=#005faf  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
...
hi Special       ctermfg=131  guifg=#af5f5f  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
hi PreProc       ctermfg=29   guifg=#00875f  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
...
hi Error         ctermfg=196  guifg=#ff0000  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
hi cPreCondit    ctermfg=131  guifg=#af5f5f  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
hi diffRemoved   ctermfg=131  guifg=#af5f5f  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
hi diffAdded     ctermfg=28   guifg=#008700  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
hi diffChanged   ctermfg=130  guifg=#af5f00  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
hi diffFile      ctermfg=25   guifg=#005faf  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
hi diffLine      ctermfg=25   guifg=#005faf  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
hi diffSubname   ctermfg=29   guifg=#00875f  ctermbg=bg   guibg=bg       cterm=NONE  gui=NONE
