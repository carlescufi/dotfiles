...
if exists("g:impact_transbg")
        ...
        hi Comment      ctermfg=DarkGray guifg=DarkGray  ctermbg=none guibg=Black cterm=NONE gui=NONE term=NONE
        ...
        hi PreProc      ctermfg=LightGray guifg=LightGray ctermbg=none guibg=Black cterm=NONE gui=NONE term=NONE
        ...
        hi ErrorMsg     ctermfg=Red guifg=Red       ctermbg=none guibg=Black cterm=NONE gui=NONE term=NONE
        ...
        hi StatusLine   term=NONE cterm=NONE gui=NONE,underline ctermfg=White guifg=White ctermbg=Black guibg=Black
        hi StatusLineNC term=NONE cterm=NONE gui=NONE,underline ctermfg=Gray guifg=Gray  ctermbg=Black guibg=Black
        hi LineNr       term=NONE cterm=NONE gui=NONE ctermfg=White guifg=White ctermbg=DarkGray guibg=DarkGray
else
        ...
        hi Comment      ctermfg=DarkGray guifg=DarkGray  ctermbg=Black guibg=Black cterm=NONE gui=NONE term=NONE
        ...
        hi PreProc      ctermfg=LightGray guifg=LightGray ctermbg=Black guibg=Black cterm=NONE gui=NONE term=NONE
        ...
        hi ErrorMsg     ctermfg=Red guifg=Red       ctermbg=Black guibg=Black cterm=NONE gui=NONE term=NONE
