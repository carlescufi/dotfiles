...
hi Operator   guifg=#0066cc                gui=NONE    
hi Function   guifg=#aa0000                            
hi PreProc    guifg=#aa0000                            
hi Special    guifg=#cc6600                            
hi Statement  guifg=#008040                gui=NONE     
hi Type       guifg=#0066cc                gui=NONE    
hi Directory  guifg=#0066cc                gui=NONE     
                                                       
hi DiffAdd                   guibg=#ccffcc             
hi DiffChange                guibg=#ffffcc             
hi DiffDelete guifg=#6699cc  guibg=#bbeeff gui=NONE    
hi DiffText                  guibg=#ffcccc gui=NONE    
