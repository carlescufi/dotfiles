...
hi Statement gui=NONE	guifg=#0086b5 "Deep blue
hi PreProc	gui=NONE   guifg=#4900cc "Deep purple
hi Type	gui=NONE		guifg=#0086b5 "Deep blue
hi Function	gui=NONE guifg=#0086b5 "Deep blue
hi Repeat	gui=NONE guifg=Black
...
hi pythonRepeat gui=NONE guifg=Black " Python Repeat : for, while, etc.
hi pythonConditional gui=NONE guifg=Black " Python conditonnal : if, elif, else, then
hi pythonPrecondit guifg=#894c24 " python Precondit : import from
hi pythonOperator gui=NONE guifg=Black " pythonOperator : and, in, is, not, or
