...
hi Visual	guifg=black  		guibg=#C0FFC0	gui=NONE
hi WarningMsg	guifg=#F60000				gui=underline

" syntax highlighting groups
hi Comment	guifg=#666666                           gui=italic
hi Constant	guifg=#A9EE5A				gui=NONE,italic
hi Identifier	guifg=#555555
hi Function	guifg=#555555
hi Statement	guifg=#ff9742                           gui=NONE,italic
hi PreProc	guifg=#F9449A
hi Type		guifg=#55AAFF                           gui=NONE,italic
