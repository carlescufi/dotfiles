...
hi StatusLine ctermfg=231 ctermbg=240 cterm=NONE guifg=#f8f8f8 guibg=#565656 gui=NONE
...
hi Todo ctermfg=59 ctermbg=NONE cterm=inverse,NONE guifg=#5f5a60 guibg=NONE gui=inverse,NONE,italic
