...
" Statement: SteelBlue
hi Conditional    ctermfg=DarkBlue      guifg=#4682b4 guibg=#000000 gui=NONE
hi Exception      ctermfg=DarkBlue      guifg=#4682b4 guibg=#000000 gui=NONE
hi Keyword        ctermfg=DarkBlue      guifg=#4682b4 guibg=#000000 gui=NONE
hi Label          ctermfg=DarkBlue      guifg=#4682b4 guibg=#000000 gui=NONE
hi Operator       ctermfg=DarkBlue      guifg=#4682b4 guibg=#000000 gui=NONE
hi Repeat         ctermfg=DarkBlue      guifg=#4682b4 guibg=#000000 gui=NONE
hi Statement      ctermfg=DarkBlue      guifg=#4682b4 guibg=#000000 gui=NONE
...
" Type: orchid2
hi Type           ctermfg=DarkGreen     guifg=#ee7ae9 guibg=#000000 gui=NONE
hi StorageClass   ctermfg=DarkGreen     guifg=#ee7ae9 guibg=#000000 gui=NONE
hi Structure      ctermfg=DarkGreen     guifg=#ee7ae9 guibg=#000000 gui=NONE
hi Typedef        ctermfg=DarkGreen     guifg=#ee7ae9 guibg=#000000 gui=NONE
...
" Error: red
hi Error          ctermfg=LightGray     guifg=#ff0000 guibg=#232323 gui=NONE
...
" Line number.
"hi LineNr         ctermfg=DarkMagenta     guifg=#4682b4 guibg=#000000 gui=NONE
...
hi DiffText       guifg=#000000 guibg=#e6fff3 gui=NONE
hi Directory      guifg=#e6fff3 guibg=#000000 gui=none
hi ErrorMsg       guifg=#e6fff3 guibg=#61a181 gui=NONE
hi FoldColumn     guifg=#9bcfb5 guibg=#43705a gui=NONE
hi Folded         guifg=#9bcfb5 guibg=#43705a gui=NONE
hi IncSearch      guifg=#1d3026 guibg=#61a181 gui=NONE
hi ModeMsg        guifg=#4EEE94 guibg=#000000 gui=NONE
hi MoreMsg        guifg=#4EEE94 guibg=#000000 gui=NONE
hi NonText        guifg=#c0c0c0 guibg=#000000 gui=NONE
hi Question       guifg=#9bcfb5 guibg=#000000 gui=NONE
hi Search         guifg=#1d3026 guibg=#61a181 gui=NONE
hi SpecialKey     guifg=#9bcfb5 guibg=#000000 gui=none
"hi StatusLine     guifg=#e6fff3 guibg=#61a181 gui=NONE
"hi StatusLineNC   guifg=#1d3026 guibg=#61a181 gui=NONE
hi StatusLine     guifg=#4EEE94 guibg=#333333 gui=none
hi StatusLineNC   guifg=#4EEE94 guibg=#222222 gui=none
hi Title          guifg=#e6fff3 guibg=#1d3026 gui=NONE
...
hi WarningMsg     guifg=#BF3EFF guibg=#000000 gui=NONE
...
hi def OL0 ctermfg=1 cterm=NONE gui=NONE guifg=#36648B term=reverse
hi def OL1 ctermfg=4 cterm=NONE gui=NONE guifg=#4682B4 term=reverse
hi def OL2 ctermfg=2 cterm=NONE gui=NONE guifg=#4F94CD term=reverse
hi def OL3 ctermfg=3 cterm=NONE gui=NONE guifg=#5CACEE term=reverse
hi def OL4 ctermfg=5 cterm=NONE gui=NONE guifg=#63B8FF term=reverse
hi def OL5 ctermfg=6 cterm=NONE gui=NONE guifg=#708090 term=reverse
hi def OL6 ctermfg=1 cterm=NONE gui=NONE guifg=#6C7B8B term=reverse
hi def OL7 ctermfg=4 cterm=NONE gui=NONE guifg=#9FB6CD term=reverse
hi def OL8 ctermfg=2 cterm=NONE gui=NONE guifg=#B9D3EE term=reverse
hi def OL9 ctermfg=3 cterm=NONE gui=NONE guifg=#C6E2FF term=reverse
