...
highlight MoreMsg cterm=NONE ctermfg=72 gui=NONE guifg=SeaGreen
highlight Question cterm=NONE ctermfg=46 gui=NONE guifg=Green

" Split area area
highlight StatusLine cterm=NONE,reverse gui=NONE,reverse
...
highlight Title cterm=NONE ctermfg=15 gui=NONE guifg=#FFFFFF
...
highlight VisualNOS cterm=NONE,underline gui=NONE,underline
