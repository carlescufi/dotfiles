...
function! ToggleSemicolonHighlighting()
	if exists("b:semicolon")
		...
		syn match semicolon #;$#
		hi semicolon guifg=red gui=NONE ctermfg=1
		let b:semicolon = 1
	endif
endfunction
"}}}
...
"hi VertSplit	
hi Folded guibg=darkred ctermbg=4 guifg=gold ctermfg=11 gui=NONE
hi FoldColumn guibg=darkred ctermbg=14 guifg=gold ctermfg=11 gui=NONE
"hi IncSearch	
...
hi Constant	guifg=lightmagenta gui=NONE ctermfg=13
hi String guifg=grey85 ctermfg=5
hi Character guifg=violet ctermfg=5
hi Number guifg=red ctermfg=5
"hi Identifier	
hi Statement guifg=khaki1 gui=NONE ctermfg=15 cterm=underline
hi PreProc guifg=white gui=italic ctermfg=9
hi Type	guifg=yellow gui=NONE ctermfg=3
hi Special guifg=red gui=NONE
"hi Underlined	
"hi Ignore		
"hi Error		
hi Todo guifg=yellow guibg=blue gui=NONE
