...
"              "Für Elise" (For Elise). This one uses NONE and italic font     |
...
if v:version >= 700
  ...
  if has("windows")
    ...
    hi TabLineSel ctermbg=DarkBlue ctermfg=fg cterm=NONE guibg=#ffcc66 guifg=Gray20 gui=NONE
  endif
...
if has("wildmenu")
  hi WildMenu ctermbg=bg ctermfg=Magenta guibg=bg guifg=#ffcc66 gui=NONE
endif
...
hi Function ctermbg=bg ctermfg=Green guibg=bg guifg=Green gui=NONE,italic
...
hi PreCondit ctermbg=bg ctermfg=Blue guibg=bg guifg=#cc66dd gui=NONE,italic
