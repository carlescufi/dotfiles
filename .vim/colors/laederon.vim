...
call s:HL('MatchParen', 'crystallake', 'darkgravel', 'NONE')
...
call s:HL('Search',    'coal', 'raspberry', 'NONE')
call s:HL('IncSearch', 'coal', 'darkbark',    'NONE')

call s:HL('Underlined', 'fg', '', 'underline')

call s:HL('StatusLine',   'snow', 'deepgravel',     'NONE')
call s:HL('StatusLineNC', 'wetcoldterrain', 'deepgravel', 'NONE')

call s:HL('Directory', 'tundrariver', '', 'NONE')

call s:HL('Title', 'crystallake')

call s:HL('ErrorMsg',   'wintrygray',       '', 'NONE')
call s:HL('MoreMsg',    'raspberry',   '',   'NONE')
call s:HL('ModeMsg',    'tundrariver', '',   'NONE')
call s:HL('Question',   'tundrariver', '',   'NONE')
call s:HL('WarningMsg', 'coldsky',       '',   'NONE')
...
call s:HL('Cursor',  'coal', 'darkbark', 'NONE')
call s:HL('vCursor', 'coal', 'darkbark', 'NONE')
...
call s:HL('Todo',           'wintrygray', 'snow', 'NONE')
call s:HL('SpecialComment', 'crystallake', 'bg', 'NONE')

call s:HL('String', 'tundrariver')

" Control flow stuff is wintrygray.
call s:HL('Statement',   'wintrygray', '', 'NONE')
call s:HL('Keyword',     'wintrygray', '', 'NONE')
call s:HL('Conditional', 'wintrygray', '', 'NONE')
...
call s:HL('PreCondit', 'crystallake', '', 'NONE')

" Constants of all kinds are colored together.
call s:HL('Constant',  'dilutedpaint', '', 'NONE')
call s:HL('Character', 'dilutedpaint', '', 'NONE')
call s:HL('Boolean',   'dilutedpaint', '', 'NONE')

call s:HL('Number', 'dilutedpaint', '', 'NONE')
call s:HL('Float',  'dilutedpaint', '', 'NONE')

" Not sure what 'special character in a constant' means, but let's make it pop.
call s:HL('SpecialChar', 'coldsky', '', 'NONE')

call s:HL('Type', 'darkestnight', '', 'none')
call s:HL('StorageClass', 'wintrygray', '', 'none')
call s:HL('Structure', 'wintrygray', '', 'none')
call s:HL('Typedef', 'wintrygray', '', 'NONE')

" Make try/catch blocks stand out.
call s:HL('Exception', 'crystallake', '', 'NONE')

" Misc
call s:HL('Error',  'snow',   'raspberry', 'NONE')
call s:HL('Debug',  'snow',   'blackgravel', 'NONE')
...
call s:HL('PmenuSel', 'coal', 'darkbark', 'NONE')
...
if has("spell")
    call s:HL('SpellCap', 'raspberry', 'bg', 'undercurl,NONE', 'raspberry')
...
" CtrlP {{{
    ...
    call s:HL('CtrlPNoEntries', 'snow', 'wintrygray', 'NONE')
    ...
    call s:HL('CtrlPPrtCursor', 'coal', 'darkbark', 'NONE')

    " 'prt' or 'win', also for 'regex'
    call s:HL('CtrlPMode1', 'coal', 'darkbark', 'NONE')

    " 'file' or 'path', also for the local working dir
    call s:HL('CtrlPMode2', 'coal', 'darkbark', 'NONE')

    " the scanning status
    call s:HL('CtrlPStats', 'coal', 'darkbark', 'NONE')

" }}}
" EasyMotion {{{

call s:HL('EasyMotionTarget', 'darkbark',     'bg', 'NONE')
...
call s:HL('cConditional', 'darkbark', 'bg', 'NONE')
call s:HL('cRepeat', 'lichen', 'bg', 'NONE')
...
call s:HL('clojureAnonArg', 'tundrariver', '', 'NONE')
...
call s:HL('cssValueLength', 'dilutedpaint', '', 'NONE')
call s:HL('cssColor', 'dilutedpaint', '', 'NONE')
call s:HL('cssBraces', 'wetcoldterrain', '', 'none')
call s:HL('cssIdentifier', 'trunk', '', 'NONE')
call s:HL('cssClassName', 'trunk', '', 'none')
call s:HL('cssImportant', 'raspberry', '', 'NONE')
...
call s:HL('diffFile', 'coal', 'wintrygray', 'NONE')
call s:HL('diffNewFile', 'coal', 'wintrygray', 'NONE')

call s:HL('diffLine', 'coal', 'trunk', 'NONE')
...
" Tag names
call s:HL('htmlTagName',        'stainonsnow', '', 'NONE')
call s:HL('htmlSpecialTagName', 'stainonsnow', '', 'NONE')
...
call s:HL('javaClassDecl', 'wintrygray', '', 'NONE')
call s:HL('javaScopeDecl', 'wintrygray', '', 'NONE')
...
call s:HL('javaScriptConditional', 'raspberry', '', 'NONE')
...
call s:HL('jsonNull', 'wintrygray', '', 'NONE')
...
call s:HL('luaConstant', 'darkbark', '', 'NONE')

" }}}
" Mail {{{

call s:HL('mailSubject', 'trunk', '', 'NONE')
...
call s:HL('markdownHeadingRule', 'wetcoldterrain', '', 'NONE')
call s:HL('markdownHeadingDelimiter', 'wetcoldterrain', '', 'NONE')
call s:HL('markdownOrderedListMarker', 'stainonsnow', '', 'NONE')
call s:HL('markdownListMarker', 'stainonsnow', '', 'NONE')
call s:HL('markdownItalic', 'crystallake', '', '')
call s:HL('markdownBold', 'raspberry', '', 'NONE')
call s:HL('markdownH1', 'oakleaf', '', 'NONE')
call s:HL('markdownH2', 'raspberry', '', 'NONE')
...
call s:HL('markdownAutomaticLink', 'dilutedpaint', '', 'NONE')
call s:HL('markdownUrl', 'dilutedpaint', '', 'NONE')
call s:HL('markdownUrlDelimiter', 'wetcoldterrain', '', 'NONE')
call s:HL('markdownLinkText', 'raspberry', '', 'underline')
call s:HL('markdownLinkDelimiter', 'wetcoldterrain', '', 'NONE')
call s:HL('markdownLinkTextDelimiter', 'wetcoldterrain', '', 'NONE')
call s:HL('markdownCodeDelimiter', 'darkbark', '', 'NONE')
...
call s:HL('mysqlSpecial', 'coldsky', '', 'NONE')
...
call s:HL('pythonException',   'coldsky', '', 'NONE')
...
call s:HL('pythonStatement',   'oakleaf', '', 'NONE')
...
call s:HL('VimCommentTitle', 'wetcoldterrain', '', 'NONE')
