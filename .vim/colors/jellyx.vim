...
function! s:HI(group, fg, bg, fx, ...)
    ...
    if a:fx != '-'
        if a:fx =~ 'italic'
            if !s:enable_italic
                let ctfx = substitute(a:fx,'italic','NONE','g')
                let gfx  = ctfx
...
HI Folded           240     232     NONE,italic
HI StatusLine       -       234     NONE
HI StatusLineNC     -       234     NONE
HI TabLine          249     236     NONE
HI TabLineSel       -       bg      NONE,italic
