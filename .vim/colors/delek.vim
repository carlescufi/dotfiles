...
hi NonText term=NONE ctermfg=Blue gui=NONE guifg=gray guibg=white
...
hi Special    term=NONE      cterm=NONE ctermfg=lightred     gui=NONE guifg=deeppink
hi Statement  term=NONE      cterm=NONE ctermfg=blue         gui=NONE guifg=blue
hi Type	      term=underline cterm=NONE ctermfg=blue         gui=NONE guifg=blue 
