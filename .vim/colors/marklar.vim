...
if !exists("s:main")
    ...
    function! s:main()
        ...
        execute "hi Identifier       guifg=#38FF56 guibg=NONE gui=".s:NONE."  ctermfg=8 cterm=NONE"
        execute "hi Statement        guifg=#FFFF00 guibg=NONE gui=".s:NONE."  ctermfg=3 cterm=NONE"
        execute "hi Special          guifg=#25B9F8 guibg=bg   gui=".s:NONE."  ctermfg=2 cterm=underline"
        execute "hi PreProc          guifg=#FF80FF guibg=bg   gui=NONE        ctermfg=2"
        execute "hi Type             guifg=#00FFFF guibg=NONE gui=".s:NONE."  ctermfg=6 cterm=NONE"
        ...
        hi Error            guifg=#FFFFFF guibg=#000000            ctermfg=7 ctermbg=0 cterm=NONE
        hi ErrorMsg         guifg=#8eff2e guibg=#204d40
        hi FoldColumn       guifg=#00BBBB guibg=#204d40
        hi Folded           guifg=#44DDDD guibg=#204d40            ctermfg=0 ctermbg=8 cterm=NONE

        hi IncSearch        guibg=#52891f gui=NONE
        hi LineNr           guifg=#38ff56 guibg=#204d40
        hi ModeMsg          guifg=#FFFFFF guibg=#0000FF            ctermfg=7 ctermbg=4 cterm=NONE
        hi MoreMsg          guifg=#FFFFFF guibg=#00A261            ctermfg=7 ctermbg=2 cterm=NONE
        hi NonText          guifg=#00bbbb guibg=#204d40
        hi Normal           guifg=#71C293 guibg=#06544a
        hi Question         guifg=#FFFFFF guibg=#00A261
        hi Search           guifg=NONE    guibg=#0f374c            ctermfg=3 ctermbg=0 cterm=NONE
        ...
        hi WarningMsg       guifg=#FFFFFF guibg=#FF0000            ctermfg=7 ctermbg=1 cterm=NONE
        ...
        if version >= 700
            ...
            hi PmenuSel     guifg=#ffff00 guibg=#000000 gui=NONE   cterm=NONE ctermfg=3
            ...
            hi Tabline      guifg=bg      guibg=fg gui=NONE        cterm=reverse,NONE ctermfg=NONE ctermbg=NONE
            hi TablineSel   guifg=#20012e guibg=#00a675 gui=NONE
            hi TablineFill  guifg=#689C7C
            hi MatchParen   guifg=#38ff56 guibg=#0000ff gui=NONE   ctermbg=4
        endif
        "
        hi Tag              guifg=#7CFC94 guibg=NONE gui=NONE      ctermfg=2 cterm=NONE
        hi link Bold Tag
        "
        hi pythonPreCondit                                         ctermfg=2 cterm=NONE
        execute "hi tkWidget         guifg=#ffa0a0 guibg=bg gui=".s:NONE." ctermfg=7 cterm=NONE"
    endfunction

    if version >= 700

        let s:opts = {'NONE': 0, 'ignore': 1}

        " preserves vim<7 compat, while letting me reuses some code
        function! s:apply_opts()
            let s:bold_opt = s:opts['NONE']
