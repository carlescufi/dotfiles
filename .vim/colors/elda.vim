...
call s:hi('NonText', '229', s:bg, 'NONE')
...
call s:hi('FoldColumn', 248, s:bg, 'NONE')
call s:hi('SignColumn', 248, s:bg, 'NONE')
...
call s:hi('WildMenu', s:white, 17, 'NONE')
call s:hi('VertSplit', 236, 245, '')
call s:hi('TabLine', 230, 236, 'NONE')
call s:hi('TabLineSel', 226, 238, 'NONE')
...
call s:hi('Title', s:red, s:bg, 'NONE')
call s:hi('ErrorMsg', 255, s:red, 'NONE')
call s:hi('ModeMsg', 229, '', '')
call s:hi('Question', 28, s:bg, '')
call s:hi('MoreMsg', 28, s:bg, '')
call s:hi('WarningMsg', 229, s:bg, 'NONE')

" syntax highlighting groups (:help group-name)

call s:hi('Comment', 248, s:bg, '')
call s:hi('Statement', s:white, s:bg, 'NONE')
...
call s:hi('Todo', s:diff, s:bg, 'NONE')
...
call s:hi('StorageClass', s:white, s:bg, 'NONE')
call s:hi('Structure', s:white, s:bg, 'NONE')
