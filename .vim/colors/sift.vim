...
hi Function     guifg=#c08a50 guibg=bg gui=NONE "or green 50b3b0 
hi Conditional	guifg=#f8f024 guibg=bg
hi Repeat		guifg=#ffa400 guibg=bg gui=NONE
...
hi LineNr       guibg=bg guifg=#207585 gui=NONE
"hi LineNr       guibg=#081c30 guifg=#80a0dA 
hi StatusLine	guibg=#20aaea guifg=#202050 gui=NONE
hi StatusLineNC	guibg=#2a90c0 guifg=#204050 gui=NONE
