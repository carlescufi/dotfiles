...
hi SpecialKey		gui=NONE    guifg=#996699               ctermfg=red
...
hi Visual		guifg=#9c6666 guibg=#433c49	        ctermfg=darkgray ctermbg=gray cterm=NONE term=underline

hi VisualNOS	        guifg=#8080ff guibg=fg gui=reverse,underline	ctermfg=lightblue ctermbg=fg cterm=reverse,underline
hi Search		guifg=#DDDBCF guibg=#7C7B9D	        ctermfg=darkgray ctermbg=gray cterm=NONE term=underline
...
hi Folded		guifg=#996699  guibg=#222430	        ctermfg=darkred ctermbg=black cterm=NONE term=NONE
hi FoldColumn		guifg=#3E6FFF  guibg=#222430	        ctermfg=darkgrey ctermbg=black cterm=NONE term=NONE
...
hi DiffText		guibg=#FF0000 guifg=white gui=none 	cterm=NONE ctermbg=red 

hi Title		guifg=#CC02B8 gui=none		        ctermfg=magenta cterm=NONE term=NONE
...
hi Statement		guifg=#009900	gui=none	        ctermfg=green  cterm=none term=NONE
...
hi PmenuSel             guifg=#000000 guibg=#9c6666             ctermfg=gray ctermbg=darkgray cterm=NONE term=reverse,underline
