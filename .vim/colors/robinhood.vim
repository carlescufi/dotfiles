...
"hi FoldColumn
"hi IncSearch
hi LineNr               gui=NONE guifg=yellowgreen guibg=#203010
"hi ModeMsg
"hi MoreMsg
"hi NonText
hi Normal               guibg=#304020 guifg=wheat
"hi Question
hi Search               gui=NONE guifg=black guibg=gray
"hi SpecialKey
...
hi User2                guifg=yellowgreen guibg=#091900 gui=NONE
...
hi Constant             gui=NONE guifg=lightcyan
    hi String           guifg=lightsalmon
    hi Character        guifg=lightsalmon
    hi Number           gui=NONE guifg=lightcyan
    hi Boolean          gui=NONE guifg=lightcyan
    hi Float            gui=NONE guifg=lightcyan

hi Identifier           gui=NONE guifg=palegreen
    hi Function         guifg=yellowgreen

hi Statement            gui=NONE guifg=salmon
    hi Conditional      gui=NONE guifg=salmon
    hi Repeat           gui=NONE guifg=salmon
...
hi PreProc              guifg=palegreen
    hi Include          gui=NONE guifg=palegreen
    hi Define           guifg=palegreen
    hi Macro            guifg=aquamarine
    hi PreCondit        guifg=palegreen

hi Type                 gui=NONE guifg=yellowgreen
    hi StorageClass     gui=NONE guifg=aquamarine
    hi Structure        gui=NONE guifg=aquamarine
    hi Typedef          gui=NONE guifg=aquamarine
