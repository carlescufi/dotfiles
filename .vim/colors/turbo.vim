...
hi DiffText     guibg=Red       gui=NONE    ctermbg=red     cterm=NONE
...
hi Statement    guifg=white     gui=NONE        ctermfg=grey        cterm=none
hi PreProc      guifg=darkgreen gui=none        ctermfg=darkgreen   cterm=none
hi type         guifg=grey      gui=NONE        ctermfg=grey    cterm=none
