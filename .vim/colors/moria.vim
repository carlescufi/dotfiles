...
if &background == "dark"
    ...
    if s:moria_monochrome == 1
        ...
        hi NonText ctermfg=8 guibg=bg guifg=#a0a0a0 gui=NONE
        ...
        hi StatusLine ctermbg=7 ctermfg=0 guibg=#4c4c4c guifg=fg gui=NONE
        ...
        hi NonText ctermfg=8 guibg=bg guifg=#8fa5d1 gui=NONE
        ...
        hi StatusLine ctermbg=7 ctermfg=0 guibg=#334b7d guifg=fg gui=NONE
    ...
    hi Title ctermbg=0 ctermfg=15 guifg=fg gui=NONE
    if version >= 700
        hi Visual ctermbg=7 ctermfg=0 guibg=#606060 gui=none
    else
        hi Visual ctermbg=7 ctermfg=0 guibg=#606060 guifg=fg gui=none
    endif
    hi VisualNOS ctermbg=8 ctermfg=0 guibg=bg guifg=#a0a0a0 gui=NONE,underline
...
elseif &background == "light"
    ...
    if s:moria_monochrome == 1
        ...
        hi NonText ctermfg=8 guibg=bg guifg=#7a7a7a gui=NONE
        ...
        hi StatusLine ctermbg=0 ctermfg=15 guibg=#a0a0a0 guifg=fg gui=NONE
        ...
        hi NonText ctermfg=8 guibg=bg guifg=#375288 gui=NONE
        ...
        hi StatusLine ctermbg=0 ctermfg=15 guibg=#8fa5d1 guifg=fg gui=NONE
    ...
    hi ModeMsg ctermbg=15 ctermfg=0 guibg=bg guifg=fg gui=NONE
    ...
    hi htmlBold ctermbg=15 ctermfg=0 guibg=bg guifg=fg gui=NONE
    hi htmlBoldItalic ctermbg=15 ctermfg=0 guibg=bg guifg=fg gui=NONE,italic
    hi htmlBoldUnderline ctermbg=15 ctermfg=0 guibg=bg guifg=fg gui=NONE,underline
    hi htmlBoldUnderlineItalic ctermbg=15 ctermfg=0 guibg=bg guifg=fg gui=NONE,underline,italic
