...
hi NonText		guifg=LightBlue		guibg=#eee9bf			gui=NONE
...
hi DiffText					guibg=DarkRed			gui=NONE
hi Directory		guifg=DarkGrey						gui=underline
hi LineNr		guifg=#ccaa22
hi MoreMsg		guifg=SeaGreen						gui=NONE
hi Question		guifg=DarkGreen						gui=NONE
...
hi Todo						guibg=#ccaa22			gui=NONE,underline
