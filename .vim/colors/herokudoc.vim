...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || (&term =~? "^konsole" && s:old_kde())
    ...
    CSAHi Statement term=NONE cterm=NONE ctermbg=bg ctermfg=231 gui=NONE guibg=bg guifg=#f8f8f8
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=191 gui=NONE guibg=bg guifg=#d8fa3c
    ...
    CSAHi Include term=NONE cterm=NONE ctermbg=bg ctermfg=231 gui=NONE guibg=bg guifg=#f8f8f8
    CSAHi SpecialKey term=NONE cterm=NONE ctermbg=66 ctermfg=247 gui=NONE guibg=#434e56 guifg=#a0a0a0
    CSAHi NonText term=NONE cterm=NONE ctermbg=bg ctermfg=153 gui=NONE guibg=bg guifg=#adc6ee
    CSAHi Directory term=NONE cterm=NONE ctermbg=bg ctermfg=191 gui=NONE guibg=bg guifg=#d8fa3c
    ...
    CSAHi MoreMsg term=NONE cterm=NONE ctermbg=bg ctermfg=191 gui=NONE guibg=bg guifg=#d8fa3c
    ...
    CSAHi CursorLineNr term=NONE cterm=NONE ctermbg=235 ctermfg=191 gui=NONE guibg=#292929 guifg=#d8fa3c
    CSAHi Question term=NONE cterm=NONE ctermbg=bg ctermfg=191 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi StatusLine term=NONE,reverse cterm=NONE ctermbg=16 ctermfg=191 gui=NONE guibg=#000000 guifg=#d8fa3c
    ...
    CSAHi Title term=NONE cterm=NONE ctermbg=bg ctermfg=191 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi Visual term=reverse cterm=NONE ctermbg=189 ctermfg=16 gui=NONE guibg=#c8c8ff guifg=#010101
    CSAHi VisualNOS term=NONE,underline cterm=NONE,underline ctermbg=bg ctermfg=fg gui=NONE,underline guibg=bg guifg=fg
    ...
    CSAHi Comment term=NONE cterm=NONE ctermbg=bg ctermfg=249 gui=NONE guibg=bg guifg=#aeaeae
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=191 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi Special term=NONE cterm=NONE ctermbg=bg ctermfg=214 gui=NONE guibg=bg guifg=#ffa500
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=191 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi Define term=NONE cterm=NONE ctermbg=bg ctermfg=231 gui=NONE guibg=bg guifg=#f8f8f8
    CSAHi Folded term=NONE cterm=NONE ctermbg=66 ctermfg=153 gui=NONE guibg=#434e56 guifg=#adc6ee
    ...
    CSAHi DiffChange term=NONE cterm=NONE ctermbg=127 ctermfg=fg gui=NONE guibg=#8b008b guifg=fg
    CSAHi DiffDelete term=NONE cterm=NONE ctermbg=37 ctermfg=21 gui=NONE guibg=#008b8b guifg=#0000ff
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi Statement term=NONE cterm=NONE ctermbg=bg ctermfg=255 gui=NONE guibg=bg guifg=#f8f8f8
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=227 gui=NONE guibg=bg guifg=#d8fa3c
    ...
    CSAHi Include term=NONE cterm=NONE ctermbg=bg ctermfg=255 gui=NONE guibg=bg guifg=#f8f8f8
    CSAHi SpecialKey term=NONE cterm=NONE ctermbg=102 ctermfg=247 gui=NONE guibg=#434e56 guifg=#a0a0a0
    CSAHi NonText term=NONE cterm=NONE ctermbg=bg ctermfg=195 gui=NONE guibg=bg guifg=#adc6ee
    CSAHi Directory term=NONE cterm=NONE ctermbg=bg ctermfg=227 gui=NONE guibg=bg guifg=#d8fa3c
    ...
    CSAHi MoreMsg term=NONE cterm=NONE ctermbg=bg ctermfg=227 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi ModeMsg term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi CursorLineNr term=NONE cterm=NONE ctermbg=59 ctermfg=227 gui=NONE guibg=#292929 guifg=#d8fa3c
    CSAHi Question term=NONE cterm=NONE ctermbg=bg ctermfg=227 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi StatusLine term=NONE,reverse cterm=NONE ctermbg=16 ctermfg=227 gui=NONE guibg=#000000 guifg=#d8fa3c
    ...
    CSAHi Title term=NONE cterm=NONE ctermbg=bg ctermfg=227 gui=NONE guibg=bg guifg=#d8fa3c
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=37 ctermfg=fg gui=NONE guibg=#008b8b guifg=fg
    CSAHi Comment term=NONE cterm=NONE ctermbg=bg ctermfg=188 gui=NONE guibg=bg guifg=#aeaeae
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=227 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi Special term=NONE cterm=NONE ctermbg=bg ctermfg=220 gui=NONE guibg=bg guifg=#ffa500
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=227 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi Define term=NONE cterm=NONE ctermbg=bg ctermfg=255 gui=NONE guibg=bg guifg=#f8f8f8
    CSAHi Folded term=NONE cterm=NONE ctermbg=102 ctermfg=195 gui=NONE guibg=#434e56 guifg=#adc6ee
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=250 ctermfg=51 gui=NONE guibg=#bebebe guifg=#00ffff
    CSAHi DiffAdd term=NONE cterm=NONE ctermbg=19 ctermfg=fg gui=NONE guibg=#00008b guifg=fg
    CSAHi DiffChange term=NONE cterm=NONE ctermbg=127 ctermfg=fg gui=NONE guibg=#8b008b guifg=fg
    CSAHi DiffDelete term=NONE cterm=NONE ctermbg=37 ctermfg=21 gui=NONE guibg=#008b8b guifg=#0000ff
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=153 gui=NONE guibg=bg guifg=#adc6ee
    CSAHi Include term=NONE cterm=NONE ctermbg=bg ctermfg=231 gui=NONE guibg=bg guifg=#f8f8f8
    CSAHi SpecialKey term=NONE cterm=NONE ctermbg=59 ctermfg=247 gui=NONE guibg=#434e56 guifg=#a0a0a0
    CSAHi NonText term=NONE cterm=NONE ctermbg=bg ctermfg=153 gui=NONE guibg=bg guifg=#adc6ee
    CSAHi Directory term=NONE cterm=NONE ctermbg=bg ctermfg=191 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=196 ctermfg=231 gui=NONE guibg=#ff0000 guifg=#ffffff
    CSAHi IncSearch term=reverse cterm=reverse ctermbg=191 ctermfg=16 gui=reverse guibg=#010101 guifg=#d8fa3c
    ...
    CSAHi Comment term=NONE cterm=NONE ctermbg=bg ctermfg=145 gui=NONE guibg=bg guifg=#aeaeae
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=191 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi Special term=NONE cterm=NONE ctermbg=bg ctermfg=214 gui=NONE guibg=bg guifg=#ffa500
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=191 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi Define term=NONE cterm=NONE ctermbg=bg ctermfg=231 gui=NONE guibg=bg guifg=#f8f8f8
    CSAHi Folded term=NONE cterm=NONE ctermbg=59 ctermfg=153 gui=NONE guibg=#434e56 guifg=#adc6ee
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=250 ctermfg=51 gui=NONE guibg=#bebebe guifg=#00ffff
    CSAHi DiffAdd term=NONE cterm=NONE ctermbg=18 ctermfg=fg gui=NONE guibg=#00008b guifg=fg
    CSAHi DiffChange term=NONE cterm=NONE ctermbg=90 ctermfg=fg gui=NONE guibg=#8b008b guifg=fg
    CSAHi DiffDelete term=NONE cterm=NONE ctermbg=30 ctermfg=21 gui=NONE guibg=#008b8b guifg=#0000ff
    CSAHi DiffText term=reverse cterm=NONE ctermbg=196 ctermfg=fg gui=NONE guibg=#ff0000 guifg=fg
    CSAHi SignColumn term=NONE cterm=NONE ctermbg=250 ctermfg=51 gui=NONE guibg=#bebebe guifg=#00ffff
    CSAHi Conceal term=NONE cterm=NONE ctermbg=248 ctermfg=252 gui=NONE guibg=#a9a9a9 guifg=#d3d3d3
    CSAHi SpellBad term=reverse cterm=undercurl ctermbg=bg ctermfg=196 gui=undercurl guibg=bg guifg=fg guisp=#ff0000
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi Statement term=NONE cterm=NONE ctermbg=bg ctermfg=79 gui=NONE guibg=bg guifg=#f8f8f8
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=60 gui=NONE guibg=bg guifg=#d8fa3c
    ...
    CSAHi Include term=NONE cterm=NONE ctermbg=bg ctermfg=79 gui=NONE guibg=bg guifg=#f8f8f8
    CSAHi SpecialKey term=NONE cterm=NONE ctermbg=21 ctermfg=84 gui=NONE guibg=#434e56 guifg=#a0a0a0
    CSAHi NonText term=NONE cterm=NONE ctermbg=bg ctermfg=59 gui=NONE guibg=bg guifg=#adc6ee
    CSAHi Directory term=NONE cterm=NONE ctermbg=bg ctermfg=60 gui=NONE guibg=bg guifg=#d8fa3c
    ...
    CSAHi MoreMsg term=NONE cterm=NONE ctermbg=bg ctermfg=60 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi ModeMsg term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi CursorLineNr term=NONE cterm=NONE ctermbg=80 ctermfg=60 gui=NONE guibg=#292929 guifg=#d8fa3c
    CSAHi Question term=NONE cterm=NONE ctermbg=bg ctermfg=60 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi StatusLine term=NONE,reverse cterm=NONE ctermbg=16 ctermfg=60 gui=NONE guibg=#000000 guifg=#d8fa3c
    ...
    CSAHi Title term=NONE cterm=NONE ctermbg=bg ctermfg=60 gui=NONE guibg=bg guifg=#d8fa3c
    ...
    CSAHi Comment term=NONE cterm=NONE ctermbg=bg ctermfg=85 gui=NONE guibg=bg guifg=#aeaeae
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=60 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi Special term=NONE cterm=NONE ctermbg=bg ctermfg=68 gui=NONE guibg=bg guifg=#ffa500
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=60 gui=NONE guibg=bg guifg=#d8fa3c
    CSAHi Define term=NONE cterm=NONE ctermbg=bg ctermfg=79 gui=NONE guibg=bg guifg=#f8f8f8
    CSAHi Folded term=NONE cterm=NONE ctermbg=21 ctermfg=59 gui=NONE guibg=#434e56 guifg=#adc6ee
    ...
    CSAHi DiffChange term=NONE cterm=NONE ctermbg=33 ctermfg=fg gui=NONE guibg=#8b008b guifg=fg
    CSAHi DiffDelete term=NONE cterm=NONE ctermbg=21 ctermfg=19 gui=NONE guibg=#008b8b guifg=#0000ff
