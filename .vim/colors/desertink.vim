...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  call <SID>X("NonText", "addbe7", "3D3D3D", "NONE")
  ...
  " use only NONE for the cursorline to avoid covering the background
  ...
  call <SID>X("Error", "ffffff", "913d3b", "NONE")
  call <SID>X("ErrorMsg", "ffffff", "913d3b", "NONE")
  call <SID>X("ModeMsg", "daa520", "", "")
  call <SID>X("MoreMsg", "00ff7f", "", "NONE")
  call <SID>X("Ignore", "666666", "", "")
  call <SID>X("Todo", "f9f747", "d75f00", "NONE")
  ...
  call <SID>X("Folded", "ffa500", "333333", "NONE")
  call <SID>X("FoldColumn", "d2b48c", "222222", "")
  call <SID>X("SignColumn", "", "2a2a2a", "", "", "236")

  call <SID>X("Search", "ffffff", "6b8e23", "NONE")
  call <SID>X("IncSearch", "ffffff", "3a663a", "NONE")

  call <SID>X("SpecialKey", "9acd32", "", "")

  call <SID>X("Title", "cd5c5c", "", "")
  call <SID>X("Visual", "", "2e5e73", "NONE")
  call <SID>X("VisualNOS", "", "254A59", "NONE")
  call <SID>X("WarningMsg", "fa8072", "", "")
  call <SID>X("MatchParen", "", "606060", "NONE")
  ...
  call <SID>X("PmenuSel", "ffffff", "555555", "NONE")
  ...
  call <SID>X("Statement", "f0e260", "", "NONE")
  call <SID>X("PreProc", "cd5c5c", "", "NONE")
  call <SID>X("Type", "91b365", "", "NONE")
  ...
  highlight Folded cterm=NONE,reverse ctermfg=DarkGray ctermbg=Brown
