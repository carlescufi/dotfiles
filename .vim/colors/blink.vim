...
hi NonText term=NONE ctermfg=DarkBlue guifg=#0000c0
...
hi Error term=NONE ctermfg=Red ctermbg=Black guifg=Red guibg=Black
hi Todo term=reverse cterm=reverse gui=reverse

" Constants (plain data)
hi Constant term=NONE cterm=NONE ctermfg=Brown ctermbg=Black gui=NONE guifg=#c0c000 guibg=Black
...
hi Statement term=NONE ctermfg=DarkGreen ctermbg=Black guifg=#00c000 ctermbg=Black
...
" Preprocessing (meta)
hi PreProc term=NONE cterm=NONE ctermfg=DarkGreen ctermbg=Black gui=NONE guifg=#00c000 guibg=Black
...
" Types (define things)
hi Type term=NONE cterm=NONE ctermfg=DarkCyan ctermbg=Black gui=Bold guifg=#00c0c0 guibg=Black
