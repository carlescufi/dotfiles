...
hi Visual        gui=NONE guifg=Grey guibg=fg
hi VisualNOS     gui=underline,NONE
hi Directory     guifg=Grey
hi MoreMsg       gui=NONE guifg=White
hi NonText       gui=NONE guifg=DarkGrey
hi Question      gui=NONE guifg=White
hi Search        guibg=#998844 guifg=Black
hi IncSearch     gui=NONE
hi SpecialKey    guifg=White
hi Title         gui=NONE guifg=Grey
hi WildMenu      guibg=Yellow guifg=Black
hi Folded        guifg=Grey guibg=#554455
hi FoldColumn    guifg=Grey guibg=#554455
hi DiffText      gui=NONE guibg=#442266
hi DiffAdd       guibg=#000055
hi DiffChange    guibg=#220044
hi DiffDelete    gui=NONE guifg=#604060 guibg=#302030
hi ErrorMsg      gui=NONE guifg=Black
hi WarningMsg    guifg=Black

" general highlighting
hi Constant      gui=NONE guifg=#9060c8
...
hi Label         gui=NONE guifg=#805070
hi Todo          gui=NONE guifg=black
hi String        guifg=#999999
hi Operator      guifg=#8080c0
hi Identifier    guifg=#686888
hi Pmenu         guibg=#101033 guifg=#999999 gui=NONE

hi MatchParen    gui=NONE guibg=#000022
