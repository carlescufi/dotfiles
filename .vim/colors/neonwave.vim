...
hi Constant          ctermfg=33    ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#0087ff  guibg=NONE
hi Character         ctermfg=207   ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#ff5fff  guibg=NONE
hi Conditional       ctermfg=201   ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#ff00ff  guibg=NONE
...
hi CursorLineNr      ctermfg=45    ctermbg=235   gui=NONE       cterm=NONE      guifg=#00d7ff  guibg=#262626
...
hi Directory         ctermfg=45    ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#00d7ff  guibg=NONE
hi Error             ctermfg=196   ctermbg=232   gui=NONE       cterm=NONE      guifg=#ff0000  guibg=#080808
hi ErrorMsg          ctermfg=196   ctermbg=232   gui=NONE       cterm=NONE      guifg=#ff0000  guibg=#080808
hi Exception         ctermfg=201   ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#ff00ff  guibg=NONE
...
hi Include           ctermfg=69    ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#5f87ff  guibg=NONE
hi IncSearch         ctermfg=232   ctermbg=33    gui=NONE       cterm=NONE      guifg=#080808  guibg=#0087ff
hi jsonKeyword       ctermfg=45    ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#00d7ff  guibg=NONE
hi Keyword           ctermfg=201   ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#ff00ff  guibg=NONE
hi Label             ctermfg=201   ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#ff00ff  guibg=NONE
hi LineNr            ctermfg=36    ctermbg=233   gui=NONE       cterm=NONE      guifg=#00af87  guibg=#121212
hi Macro             ctermfg=69    ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#5f87ff  guibg=NONE
hi MatchParen        ctermfg=50    ctermbg=39    gui=NONE       cterm=NONE      guifg=#00ffd7  guibg=#00afff
hi ModeMsg           ctermfg=39    ctermbg=232   gui=NONE       cterm=NONE      guifg=#00afff  guibg=#080808
hi MoreMsg           ctermfg=46    ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#00ff00  guibg=NONE
...
hi OverLength        ctermfg=46    ctermbg=234   gui=NONE       cterm=NONE      guifg=#00ff00  guibg=#1c1c1c
...
hi pythonStatement   ctermfg=45    ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#00d7ff  guibg=NONE
hi Question          ctermfg=46    ctermbg=232   gui=NONE       cterm=NONE      guifg=#00ff00  guibg=#080808
hi Repeat            ctermfg=201   ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#ff00ff  guibg=NONE
...
hi shVariable        ctermfg=45    ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#00d7ff  guibg=NONE
...
hi SpellBad          ctermfg=196   ctermbg=232   gui=NONE       cterm=NONE      guifg=#ff0000  guibg=#080808
hi StatusLine        ctermfg=32    ctermbg=232   gui=NONE       cterm=NONE      guifg=#0087d7  guibg=#080808
hi StatusLineNC      ctermfg=105   ctermbg=236   gui=NONE       cterm=NONE      guifg=#8787ff  guibg=#303030
hi Statement         ctermfg=201   ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#ff00ff  guibg=NONE
hi StorageClass      ctermfg=45    ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#00d7ff  guibg=NONE
hi String            ctermfg=171   ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#d75fff  guibg=NONE
hi Structure         ctermfg=45    ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#00d7ff  guibg=NONE
...
hi TabLineSel        ctermfg=32    ctermbg=233   gui=NONE       cterm=NONE      guifg=#0087d7  guibg=#121212
hi Title             ctermfg=201   ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#ff00ff  guibg=NONE
hi Todo              ctermfg=231   ctermbg=201   gui=NONE       cterm=NONE      guifg=#ffffff  guibg=#ff00ff
hi Type              ctermfg=45    ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#00d7ff  guibg=NONE
hi Typedef           ctermfg=45    ctermbg=NONE  gui=NONE       cterm=NONE      guifg=#00d7ff  guibg=NONE
