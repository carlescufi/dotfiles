...
" hi MatchParen ctermfg=lightgray ctermbg=none
    hi ErrorMsg ctermfg=red ctermbg=none cterm=NONE term=NONE
    hi Error ctermfg=red ctermbg=none cterm=NONE term=NONE
    hi LineNr ctermfg=white ctermbg=none term=NONE cterm=NONE 
...
" hi Todo ctermfg=lightgray ctermbg=none
    ...
    hi StatusLineNC ctermfg=darkgray  ctermbg=white term=NONE cterm=NONE 
...
" hi Special ctermfg=lightgray ctermbg=none
    ...
    hi NonText ctermfg=244 guifg=#444444 cterm=NONE gui=NONE
    hi SpecialKey ctermfg=214 guifg=#FFA500
    hi MatchParen ctermfg=233 guifg=#222222 ctermbg=246 guibg=#999999 cterm=NONE gui=NONE
    ...
    hi Todo ctermfg=142 guifg=#adac4f ctermbg=235 guibg=#252525 cterm=NONE
    ...
    " Dividers
    hi StatusLine ctermbg=235 guibg=#222222 ctermfg=255 guifg=#FFFFFF cterm=NONE gui=none
