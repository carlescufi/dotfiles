...
" Diff
hi DiffText guibg=red guifg=white gui=NONE
hi DiffAdd guibg=darkblue guifg=white
hi DiffChange guibg=darkmagenta guifg=white
hi DiffDelete guibg=darkcyan guifg=blue gui=NONE

" Misc
hi Title guifg=magenta gui=NONE
hi Question guibg=black guifg=green gui=NONE
...
" Messages
hi ModeMsg guibg=black guifg=white gui=NONE
hi MoreMsg guibg=black guifg=seagreen gui=NONE
hi WarningMsg guibg=black guifg=pink gui=NONE
hi ErrorMsg guibg=black guifg=red gui=NONE
