...
hi Number       guifg=#5080b0   guibg=bg        gui=NONE
hi String       guifg=#085d06   guibg=bg
hi Comment      guifg=#79a97b   guibg=bg
hi Constant     guifg=#508040
hi Special      guifg=#5080b0                   gui=NONE
hi SpecialChar  guifg=#a9a61f   guibg=bg        gui=NONE
hi Identifier   guifg=#a9a61f
hi Statement    guifg=#121bc0   guibg=bg        gui=NONE
hi PreProc      guifg=#121bc0   guibg=bg        gui=NONE
hi PreCondit    guifg=#cc00cc   guibg=bg        gui=NONE
hi Type         guifg=#121bc0   guibg=bg        gui=NONE
