...
if has("gui_running")
	...
	hi Title          guibg=#1F1F1F guifg=#6DF584 gui=NONE
	...
	hi Todo           guibg=#1F1F1F guifg=#FC4234 gui=NONE
	...
	" -> HTML-specific
	hi htmlBold                 guibg=#1F1F1F guifg=#D0D0D0 gui=NONE
	hi htmlBoldItalic           guibg=#1F1F1F guifg=#D0D0D0 gui=NONE,italic
	hi htmlBoldUnderline        guibg=#1F1F1F guifg=#D0D0D0 gui=NONE,underline
	hi htmlBoldUnderlineItalic  guibg=#1F1F1F guifg=#D0D0D0 gui=NONE,underline,italic
...
elseif &t_Co == 256
	...
	hi Title          ctermbg=234  ctermfg=84    cterm=NONE
	...
	hi Todo           ctermbg=234  ctermfg=203   cterm=NONE
	...
	" -> HTML-specific
	hi htmlBold                 ctermbg=234  ctermfg=252   cterm=NONE
	hi htmlBoldItalic           ctermbg=234  ctermfg=252   cterm=NONE,italic
	hi htmlBoldUnderline        ctermbg=234  ctermfg=252   cterm=NONE,underline
	hi htmlBoldUnderlineItalic  ctermbg=234  ctermfg=252   cterm=NONE,underline,italic
...
elseif &t_Co == 16
  ...
  hi Title          ctermbg=8  ctermfg=10 cterm=NONE
  ...
  hi Todo           ctermbg=8  ctermfg=12 cterm=NONE
  ...
  " -> HTML-specific
  hi htmlBold                  ctermbg=8 ctermfg=7 cterm=NONE
  hi htmlBoldItalic            ctermbg=8 ctermfg=7 cterm=NONE,italic
  hi htmlBoldUnderline         ctermbg=8 ctermfg=7 cterm=NONE,underline
  hi htmlBoldUnderlineItalic   ctermbg=8 ctermfg=7 cterm=NONE,underline,italic
...
elseif &t_Co == 8
  ...
  hi Title          ctermbg=8  ctermfg=2  cterm=NONE
  ...
  hi Todo           ctermbg=8  ctermfg=4 cterm=NONE
