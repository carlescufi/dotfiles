...
hi Todo           guifg=#8f3231 guibg=#0e1219  gui=NONE,undercurl guisp=#cbc32a " red on dark grey
...
hi Underlined                                  gui=NONE,underline               " underline
if version>= 700
...
hi IncSearch      guifg=#0e1219 guibg=#82ade0  gui=NONE                         " dark grey on cyan
hi DiffText       guifg=#0e1219 guibg=#82ade0  gui=NONE                         " dark grey on cyan
...
elseif &t_Co == 256
  ...
  if has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi Comment term=NONE ctermbg=59 ctermfg=30
    ...
    CSAHi DiffChange term=NONE ctermbg=61 ctermfg=white
    ...
    CSAHi DiffAdd term=NONE ctermbg=29 ctermfg=113
    CSAHi Exception ctermbg=59 ctermfg=red
    CSAHi Title term=NONE ctermbg=59 ctermfg=red
    CSAHi Error term=reverse ctermbg=red ctermfg=white
    CSAHi DiffDelete term=NONE ctermbg=red ctermfg=white
    CSAHi Todo cterm=NONE,undercurl ctermbg=black ctermfg=red
    CSAHi LineNr term=underline ctermbg=black ctermfg=61
    CSAHi Statement term=NONE ctermbg=59 ctermfg=140
    CSAHi Underlined term=underline cterm=NONE,underline ctermfg=147
    ...
    CSAHi StatusLine term=reverse,NONE ctermbg=16 ctermfg=220
    CSAHi WildMenu ctermbg=16 ctermfg=145
    CSAHi FoldColumn ctermbg=16 ctermfg=61
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=146 ctermfg=16
    CSAHi DiffText term=reverse cterm=NONE ctermbg=146 ctermfg=16
    ...
    CSAHi TabLineSel term=NONE cterm=NONE
    CSAHi Tag ctermbg=59 ctermfg=61
    CSAHi VisualNOS term=NONE,underline cterm=NONE,underline
    CSAHi WarningMsg ctermfg=160
    CSAHi htmlBold term=NONE cterm=NONE
    CSAHi htmlBoldItalic term=NONE,italic cterm=NONE
    CSAHi htmlBoldUnderline term=NONE,underline cterm=NONE,underline
    CSAHi htmlBoldUnderlineItalic term=NONE,italic,underline cterm=NONE,underline
  ...
  elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi DiffChange term=NONE ctermbg=68 ctermfg=white
    ...
    CSAHi DiffAdd term=NONE ctermbg=36 ctermfg=150
    CSAHi Exception ctermbg=59 ctermfg=red
    CSAHi Title term=NONE ctermbg=59 ctermfg=red
    CSAHi Error term=reverse ctermbg=red ctermfg=white
    CSAHi DiffDelete term=NONE ctermbg=red ctermfg=white
    ...
    CSAHi Statement term=NONE ctermbg=59 ctermfg=177
    CSAHi Underlined term=underline cterm=NONE,underline ctermfg=153
    CSAHi CursorLine term=underline cterm=underline ctermbg=black
    CSAHi CursorColumn term=reverse ctermfg=white ctermbg=30
    ...
    CSAHi StatusLine term=reverse,NONE ctermbg=16 ctermfg=226
    CSAHi WildMenu ctermbg=17 ctermfg=152
    CSAHi FoldColumn ctermbg=17 ctermfg=104
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=153 ctermfg=17
    CSAHi DiffText term=reverse cterm=NONE ctermbg=153 ctermfg=17
    ...
    CSAHi SpecialKey term=NONE ctermbg=59 ctermfg=134
    ...
    CSAHi Ignore ctermfg=59
    CSAHi NonText term=NONE ctermbg=59 ctermfg=60
    CSAHi Directory term=NONE ctermfg=45
    ...
    CSAHi htmlUnderlineItalic term=italic,underline cterm=underline
    CSAHi htmlUnderline term=underline cterm=underline
    CSAHi Special term=NONE ctermbg=59 ctermfg=68
  ...
  elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi Comment term=NONE ctermbg=16 ctermfg=23
    ...
    CSAHi DiffAdd term=NONE ctermbg=23 ctermfg=107
    CSAHi Exception ctermbg=16 ctermfg=red
    CSAHi Title term=NONE ctermbg=16 ctermfg=red
    CSAHi Error term=reverse ctermbg=red ctermfg=white
    CSAHi DiffDelete term=NONE ctermbg=red ctermfg=white
    CSAHi Todo cterm=NONE,undercurl ctermbg=black ctermfg=red
    CSAHi LineNr term=underline ctermbg=black ctermfg=61
    CSAHi Statement term=NONE ctermbg=16 ctermfg=98
    CSAHi Underlined term=underline cterm=NONE,underline ctermfg=111
    CSAHi CursorLine term=underline cterm=underline ctermbg=black
    ...
    CSAHi FoldColumn ctermbg=16 ctermfg=61
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=110 ctermfg=16
    CSAHi DiffText term=reverse cterm=NONE ctermbg=110 ctermfg=16
    ...
    CSAHi SpecialKey term=NONE ctermbg=16 ctermfg=91

    CSAHi Cursor ctermbg=103 ctermfg=16
    CSAHi lCursor ctermbg=103 ctermfg=16
    CSAHi Delimiter ctermbg=16 ctermfg=61
    CSAHi Directory term=NONE ctermfg=38
    CSAHi ErrorMsg ctermbg=160 ctermfg=231
    CSAHi Identifier term=underline ctermfg=87
    CSAHi Ignore ctermfg=16
    CSAHi ModeMsg term=NONE cterm=NONE
    CSAHi MoreMsg term=NONE cterm=NONE ctermfg=29
    CSAHi NonText term=NONE ctermbg=16 ctermfg=59
    CSAHi PmenuSbar ctermbg=250
    CSAHi PmenuThumb ctermbg=103 ctermfg=16
    CSAHi Question cterm=NONE ctermfg=22
    CSAHi SignColumn ctermbg=250 ctermfg=38
    CSAHi Special term=NONE ctermbg=16 ctermfg=61
  ...
  elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi Comment term=NONE ctermbg=80 ctermfg=21
    ...
    CSAHi DiffChange term=NONE ctermbg=18 ctermfg=white
    ...
    CSAHi DiffAdd term=NONE ctermbg=20 ctermfg=40
    CSAHi Exception ctermbg=80 ctermfg=red
    CSAHi Title term=NONE ctermbg=80 ctermfg=red
    CSAHi Error term=reverse ctermbg=red ctermfg=white
    CSAHi DiffDelete term=NONE ctermbg=red ctermfg=white
    CSAHi Todo cterm=NONE,undercurl ctermbg=black ctermfg=white
    CSAHi LineNr term=underline ctermbg=black ctermfg=38
    CSAHi Statement term=NONE ctermbg=80 ctermfg=38
    CSAHi Underlined term=underline cterm=NONE,underline ctermfg=39
    ...
    CSAHi StatusLine term=reverse,NONE ctermbg=16 ctermfg=72
    CSAHi WildMenu ctermbg=16 ctermfg=37
    CSAHi FoldColumn ctermbg=16 ctermfg=38
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=42 ctermfg=16
    CSAHi DiffText term=reverse cterm=NONE ctermbg=42 ctermfg=16
