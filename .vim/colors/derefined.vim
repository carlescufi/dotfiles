...
hi Folded       guibg=black guifg=green gui=NONE ctermbg=black ctermfg=green
...
hi StatusLine	guibg=grey guifg=blue gui=NONE ctermbg=white ctermfg=blue
hi StatusLineNC	guibg=grey guifg=black gui=NONE ctermbg=grey ctermfg=black 
...
hi Comment		guifg=black  guibg=bg ctermfg=black ctermbg=bg gui=NONE
...
highlight Keyword gui=NONE guifg=grey guibg=bg cterm=NONE ctermfg=grey ctermbg=bg
highlight Exception gui=NONE guifg=yellow guibg=bg cterm=NONE ctermfg=yellow ctermbg=bg
"""""""""""""""""""""""""""""""""""""""""""""""""""""""
