...
hi NonText      guifg=#77ff22  ctermfg=yellow     guibg=#000000 ctermbg=black  gui=NONE cterm=NONE
...
hi DiffDelete   guifg=#b0b0b0  ctermfg=gray       guibg=#202020 ctermbg=black  gui=NONE cterm=NONE
...
hi FoldColumn   guifg=#c8bcb9       guibg=#786d65       ctermfg=lightgray   ctermbg=darkgray  gui=NONE   cterm=NONE
hi SignColumn   guifg=#c8bcb9       guibg=#786d65       ctermfg=lightgray   ctermbg=darkgray  gui=NONE   cterm=NONE
...
hi WildMenu     guifg=#ffffff       guibg=#133293       ctermfg=white       ctermbg=darkblue  gui=NONE   cterm=NONE
...
hi TabLineSel   guifg=#ffffff       guibg=#133293       ctermfg=yellow      ctermbg=blue cterm=underline,NONE
...
hi Title        guifg=#dd4452 ctermfg=red       guibg=#000000 ctermbg=black  gui=NONE cterm=NONE
...
hi ErrorMsg     guifg=#ff0000 ctermfg=red       guibg=#000000 ctermbg=black  gui=NONE cterm=NONE
hi WarningMsg   guifg=#ccae22 ctermfg=yellow    guibg=#000000 ctermbg=black  gui=NONE cterm=NONE
...
hi Statement    guifg=#ffffff  ctermfg=white       guibg=#000000 ctermbg=black  gui=NONE cterm=NONE 
hi StorageClass guifg=#b0ffb0  ctermfg=white       guibg=#000000 ctermbg=black  gui=NONE cterm=NONE
hi Structure    guifg=#b0ffb0  ctermfg=white       guibg=#000000 ctermbg=black  gui=NONE cterm=NONE
...
hi Todo         guifg=#a00000  ctermfg=darkred     guibg=#000000 ctermbg=black  gui=NONE cterm=NONE
"hi Error        guifg=#ffffff  ctermfg=white       guibg=#ff0000 ctermbg=red
hi Error        guifg=#ff0000  ctermfg=red       guibg=#000000 ctermbg=black  gui=NONE cterm=NONE
