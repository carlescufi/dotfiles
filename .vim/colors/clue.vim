...
hi type         gui=NONE      guifg=#8080e0                                     ctermfg=darkcyan
hi statement    gui=NONE      guifg=#e09000                                     ctermfg=brown
hi operator     gui=NONE      guifg=orange                                      ctermfg=brown
hi constant                   guifg=cyan                                        ctermfg=darkblue
hi label        gui=NONE      guifg=darkyellow                                  ctermfg=grey
...
hi matchparen   gui=NONE      guifg=yellow    guibg=darkblue                    ctermfg=yellow      ctermbg=black
...
hi warningmsg   gui=NONE      guifg=cyan      guibg=darkblue                    ctermfg=cyan
hi modemsg                    guifg=yellow                                      ctermfg=brown
hi moremsg                    guifg=yellow                                      ctermfg=brown

hi statusline   gui=NONE      guifg=cyan      guibg=blue        cterm=none      ctermfg=black       ctermbg=white
...
hi title        gui=NONE      guifg=white                                       ctermfg=white
