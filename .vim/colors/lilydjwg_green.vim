...
hi Cursor gui=NONE guifg=#ff68d1 guibg=#00c4ff ctermfg=206 ctermbg=45 cterm=NONE
...
hi DiffDelete gui=NONE guifg=black guibg=coral ctermfg=16 ctermbg=209 cterm=NONE
hi DiffText gui=NONE guifg=black guibg=olivedrab ctermfg=16 ctermbg=64 cterm=NONE
...
hi IncSearch gui=NONE,reverse guifg=#33ff1c guibg=#3454ff ctermfg=82 ctermbg=63 cterm=NONE,reverse
...
hi ModeMsg gui=NONE guifg=#ffff3c guibg=#9bedd1 ctermfg=227 ctermbg=122 cterm=NONE
...
hi Question gui=NONE guifg=#006633 guibg=#66ffff ctermfg=23 ctermbg=87 cterm=NONE
...
hi Statement gui=NONE guifg=#d86868 guibg=#9bedd1 ctermfg=167 ctermbg=122 cterm=NONE
...
hi TabLineSel gui=NONE,underline guifg=#3488ff guibg=#9bedd1 ctermfg=69 ctermbg=122 cterm=NONE,underline
hi Title gui=NONE guifg=#006611 guibg=#9bedd1 ctermfg=22 ctermbg=122 cterm=NONE
hi Todo gui=NONE,underline guifg=#ff4c4c guibg=#d8ff33 ctermfg=203 ctermbg=191 cterm=NONE,underline
hi Type gui=NONE guifg=orange ctermfg=214 ctermbg=122 cterm=NONE
...
hi VisualNOS gui=NONE,underline ctermbg=122 cterm=NONE,underline
