...
hi SpecialKey     term=NONE ctermfg=112 guifg=#9acd32
hi NonText        term=NONE ctermfg=147 ctermbg=16 gui=NONE guifg=#a0a0ff guibg=#000000
hi Directory      term=NONE ctermfg=159 guifg=Cyan
...
hi MoreMsg        term=NONE ctermfg=29 gui=NONE guifg=#2e8b57
hi ModeMsg        term=NONE cterm=NONE ctermfg=178 gui=NONE guifg=#daa520
hi LineNr         term=underline ctermfg=11 guifg=Yellow
hi CursorLineNr   term=NONE ctermfg=11 gui=NONE guifg=Yellow
hi Question       term=standout ctermfg=48 gui=NONE guifg=#00ff7f
hi StatusLine     term=NONE,reverse ctermfg=16 ctermbg=145 guifg=#000000 guibg=#c2bfa5
...
hi Title          term=NONE ctermfg=167 gui=NONE guifg=#cd5c5c
...
hi DiffAdd        term=NONE ctermfg=16 ctermbg=40 guifg=#000000 guibg=#33cc33
hi DiffChange     term=NONE ctermfg=16 ctermbg=44 guifg=#000000 guibg=#33cccc
hi DiffDelete     term=NONE ctermfg=231 ctermbg=160 gui=NONE guifg=#ffffff guibg=#cc3333
hi DiffText       term=reverse cterm=NONE ctermfg=231 ctermbg=20 gui=NONE guifg=#ffffff guibg=#3333cc
