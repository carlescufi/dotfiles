...
highlight PreProc	    cterm=NONE ctermfg=black ctermbg=white gui=NONE guifg=black guibg=#C0C0C0
" Include defaults to PreProc
" Define defaults to PreProc
" Macro defaults to PreProc
" PreCondit defaults to PreProc

highlight Type		    cterm=NONE ctermfg=black ctermbg=white gui=NONE guifg=black guibg=#C0C0C0
...
highlight Todo		    cterm=italic,NONE ctermfg=black ctermbg=white gui=italic,NONE guifg=black guibg=#C0C0C0
