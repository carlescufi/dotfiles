...
hi MoreMsg              guifg=#5FAF87                   gui=NONE
hi ModeMsg                                              gui=NONE
hi LineNr               guifg=#D7D7AF   guibg=#262626
hi Question             guifg=#5FFF5F                   gui=NONE
hi StatusLine                                           gui=reverse,NONE
hi StatusLineNC                                         gui=reverse
hi Title                guifg=#FF87FF                   gui=NONE
hi Visual                               guibg=NONE      gui=reverse
hi VisualNOS                                            gui=NONE,underline
...
hi Boolean              guifg=#5F87FF                   gui=NONE
