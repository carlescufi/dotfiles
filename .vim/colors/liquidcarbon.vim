...
hi  ErrorMsg        guifg=#ff6a6a   guibg=NONE      gui=NONE
hi  FoldColumn      guifg=#68838b   guibg=#4B4B4B   gui=NONE
hi  Folded          guifg=#68838b   guibg=#4B4B4B   gui=NONE
hi  IncSearch       guifg=#ffffff   guibg=#ff4500   gui=NONE
hi  LineNr          guifg=#767676   guibg=#000000   gui=NONE
hi  MatchParen      guifg=#fff000   guibg=#000000   gui=NONE
hi  ModeMsg         guifg=#000000   guibg=#00ff00   gui=NONE
hi  MoreMsg         guifg=#2e8b57   guibg=bg        gui=NONE
hi  NonText         guifg=#9ac0cd   guibg=bg        gui=NONE
hi  Pmenu           guifg=#0000ff   guibg=#c0c8cf   gui=NONE
hi  PmenuSel        guifg=#c0c8cf   guibg=#0000ff   gui=NONE
hi  PmenuSbar       guifg=#ffffff   guibg=#c1cdc1   gui=NONE
hi  PmenuThumb      guifg=#ffffff   guibg=#838b83   gui=NONE
hi  Question        guifg=#00ee00   guibg=NONE      gui=NONE
hi  Search          guifg=#000000   guibg=#fff68f   gui=NONE
...
hi  Title           guifg=#009acd   guibg=bg        gui=NONE
...
hi  Todo            guifg=#ff88ee   guibg=NONE      gui=NONE
" 2}}}

" Vim {{{2
" -----------------------------------------------------------------------------
hi VimError         guifg=#ff0000   guibg=#000000   gui=NONE
hi VimCommentTitle  guifg=#528b8b   guibg=bg        gui=NONE,italic
" 2}}}

" QuickFix {{{2
" -----------------------------------------------------------------------------
hi qfFileName       guifg=#607b8b   guibg=NONE      gui=italic
hi qfLineNr         guifg=#0088aa   guibg=NONE      gui=NONE
hi qfError          guifg=#ff0000   guibg=NONE      gui=NONE
" 2}}}
