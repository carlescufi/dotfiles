...
highlight StatusLine     gui=NONE guibg=DarkGrey   guifg=Orange
highlight StatusLineNC            guibg=DarkGrey   guifg=Orange

highlight Comment    term=NONE      ctermfg=LightGrey                  guifg=#d1ddff
...
highlight Statement  term=NONE      ctermfg=Yellow           gui=NONE  guifg=#ffff60
highlight PreProc    term=underline ctermfg=Blue                       guifg=#ff4500
highlight Type       term=underline ctermfg=DarkGrey         gui=NONE  guifg=#7d96ff
highlight Special    term=NONE      ctermfg=Magenta                    guifg=Orange
...
highlight Typedef                   ctermfg=White      ctermbg=Blue    gui=NONE       guifg=White guibg=Blue
