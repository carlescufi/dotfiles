...
if version >= 700
  ...
  exe 'hi MatchParen    guifg='.s:text_hl           .' guibg='.s:bg_hl     .' gui=NONE'

  exe 'hi Pmenu         guifg='.s:text              .' guibg='.s:popup_bg      .' gui=none'
  exe 'hi PmenuSel      guifg='.s:text_hl           .' guibg='.s:popup_bg_hl   .' gui=NONE'
...
exe 'hi TODO           guifg='.s:greyed            .' guibg='.s:bg        .' gui=NONE'
...
"exe 'hi Conditional    guifg='.s:grey             .' guibg='.s:bg        .' gui=NONE'
"exe 'hi Repeat         guifg='.s:light_orange             .' guibg='.s:bg        .' gui=NONE'
