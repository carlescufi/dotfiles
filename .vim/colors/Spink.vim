...
hi EasyMotionTarget           guifg=#BD9700    guibg=NONE        guisp=NONE         gui=NONE
hi EasyMotionShade            guifg=#777777    guibg=NONE        guisp=NONE         gui=NONE
hi EasyMotionTarget2First     guifg=#BD9700    guibg=NONE        guisp=NONE         gui=NONE
hi EasyMotionTarget2Second    guifg=#BD9700    guibg=NONE        guisp=NONE         gui=NONE
hi CtrlPMatch                 guifg=#8a3824    guibg=NONE        guisp=#F9F9F9      gui=NONE
...
hi Conditional                guifg=#ceb67f    guibg=NONE        guisp=NONE         gui=NONE
...
hi Directory                  guifg=#536991    guibg=NONE        guisp=NONE         gui=NONE
hi Error                      guifg=NONE        guibg=NONE       guisp=NONE         gui=NONE
hi ErrorMsg                   guifg=#A1A6A8    guibg=#643c3c     guisp=NONE         gui=NONE
hi Exception                  guifg=#ceb67f    guibg=NONE        guisp=NONE         gui=NONE
hi Float                      guifg=#A1A6A8    guibg=NONE        guisp=NONE         gui=NONE
hi Folded                     guibg=#2D3239    guifg=#747474     guisp=NONE         gui=NONE
...
hi IncSearch                  guifg=#400000    guibg=#515e61     guisp=#BD9800      gui=NONE
hi Search                     guifg=NONE       guibg=#710000     guisp=#F9F9FF      gui=NONE
hi Include                    guifg=#ceb67f    guibg=NONE        guisp=NONE         gui=NONE
hi Keyword                    guifg=#727152    guibg=NONE        guisp=NONE         gui=NONE
hi Label                      guifg=#BD9800    guibg=NONE        guisp=NONE         gui=NONE
hi LineNr                     guifg=#3C3836    guibg=NONE        guisp=NONE         gui=NONE
hi Macro                      guifg=#BD9800    guibg=NONE        guisp=NONE         gui=NONE
hi MatchParen                 guifg=NONE       guibg=#3F3F3F     guisp=NONE         gui=NONE,italic
hi ModeMsg                    guifg=#fffedc    guibg=#192224     guisp=#192224      gui=NONE
hi MoreMsg                    guifg=#BD9800    guibg=NONE        guisp=NONE         gui=NONE
...
hi PMenuSel                   guifg=NONE       guibg=#750000     guisp=#BD9800      gui=NONE,underline
...
hi Repeat                     guifg=#ceb67f    guibg=NONE        guisp=NONE         gui=NONE
...
hi Statement                  guifg=#8a3824    guibg=NONE        guisp=NONE         gui=NONE
...
hi Title                      guifg=#F9F9FF    guibg=#192224     guisp=#192224      gui=NONE
hi Todo                       guifg=#BD9800    guibg=#492224     guisp=#BD9800      gui=NONE
hi Type                       guifg=#8A905D    guibg=NONE        guisp=NONE         gui=NONE
hi Typedef                    guifg=#536991    guibg=NONE        guisp=NONE         gui=italic
hi Underlined                 guifg=NONE       guibg=#492224     guisp=NONE         gui=NONE
hi VertSplit                  guifg=#21201F    guibg=#21201F     guisp=NONE         gui=NONE
hi Split                      guifg=#3D3D3D    guibg=NONE        guisp=NONE         gui=NONE
...
hi htmlTag                    guifg=#245361     guibg=NONE        guisp=#750000      gui=NONE
...
" PHP/ Mysql syntax {
hi PHPprivate                 guifg=#978A55    guibg=NONE        guisp=NONE         gui=underline,NONE
hi PHPfunction                guifg=#978A55    guibg=NONE        guisp=NONE         gui=underline,NONE
hi PHPtest                    guifg=#978A55    guibg=NONE        guisp=NONE         gui=underline,NONE
hi PHPClass                   guifg=#978A55    guibg=NONE        guisp=NONE         gui=underline,NONE
hi PHPConstant                guifg=#978A55    guibg=NONE        guisp=NONE         gui=underline,NONE
hi mysqlKeyword               guifg=#889CAC    guibg=NONE        guisp=NONE         gui=NONE
hi mysqlOperator              guifg=#889CAC    guibg=NONE        guisp=NONE         gui=NONE
hi phpFunctions               guifg=#6C1C00    guibg=NONE        guisp=NONE         gui=NONE
...
hi pythonStatement            guifg=#973824    guibg=NONE        guisp=NONE         gui=NONE
...
hi jsFunction                 guifg=#648A1C    guibg=NONE        guisp=NONE         gui=underline,NONE
hi javascriptFunction         guifg=#648A1C    guibg=NONE        guisp=NONE         gui=underline,NONE
