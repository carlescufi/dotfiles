...
highlight TabLineSel cterm=NONE ctermfg=253 guifg=#dadada
...
if version >= 700
  if get(g:, 'landscape_cursorline', 1)
    ...
    highlight CursorLineNr term=underline cterm=NONE ctermfg=148 ctermbg=235 gui=NONE guifg=#afdf00 guibg=#262626
  else
