...
highlight Debug         term=NONE         ctermfg=red ctermbg=black                       guifg=#dc0000 guibg=#000000
...
highlight DiffText      term=NONE         ctermfg=green ctermbg=black                     guifg=#00ac00 guibg=#000000
highlight Directory     term=underline    ctermfg=green ctermbg=black                     guifg=#336633 guibg=#000000
highlight Error         term=reverse,NONE ctermfg=black ctermbg=red                       guifg=#000000 guibg=#dc0000
highlight ErrorMsg      term=reverse,NONE ctermfg=white ctermbg=red                       guifg=#ffffff guibg=#dc0000
...
highlight LineNr        term=NONE         ctermfg=green                                   guifg=#00ff00
highlight MatchParen    term=NONE         ctermbg=green                                   guifg=#009900
highlight ModeMsg       term=NONE         cterm=NONE                                      gui=NONE
highlight MoreMsg       term=NONE         cterm=NONE                                      gui=NONE
...
highlight PmenuSel      term=NONE         ctermfg=black  ctermbg=gray                     guifg=#000000 guibg=#999999 
...
highlight Special       term=NONE         ctermfg=green                                   guifg=#00ff00
highlight SpecialKey    term=NONE         ctermfg=green                                   guifg=#00ff00
...
highlight VisualNOS     term=reverse,NONE cterm=reverse ctermbg=darkgreen                 guifg=#000000 guibg=#228822
highlight VertSplit     term=reverse      ctermfg=darkgreen                               guifg=#336633
highlight User1         term=standout     cterm=NONE ctermbg=darkgreen ctermfg=red        gui=NONE guibg=#228822 guifg=#FF0000
