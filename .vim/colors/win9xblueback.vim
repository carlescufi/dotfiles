...
hi Directory	guifg=#ffffff guibg=#0000b0 gui=NONE
...
hi DiffText	guifg=#ffffff guibg=#448844 gui=NONE
...
"\n, \0, %d, %s, etc...
hi Special	guifg=#d0d0d0 guibg=#0000b0 gui=NONE,underline
" status line
hi StatusLine	guifg=#0000b0 guibg=#d0d0d0 gui=NONE
hi StatusLineNC	guifg=#0000b0 guibg=#b0b0b0 gui=none
hi Title	guifg=#0000b0 guibg=#d0d0d0 gui=NONE
...
if version >= 700
  ...
  hi TabLineSel	  guifg=#ffffff guibg=#0000b0 gui=NONE
endif
