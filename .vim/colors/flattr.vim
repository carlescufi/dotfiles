...
hi Conditional    guifg=#FF8A3C ctermfg=209 gui=NONE
hi Conceal        guifg=#BA7FFA ctermfg=141 guibg=#1B1D1E ctermbg=234 gui=NONE
hi Constant       guifg=#A1DD63 ctermfg=149 gui=NONE
...
hi Debug          guifg=#FF154A ctermfg=197 gui=NONE
...
hi DiffText       guibg=#4C4745 ctermbg=238 gui=italic,NONE
hi Directory      guifg=#45E22E ctermfg=76  gui=NONE
hi Error          guifg=#E6DB74 ctermfg=186 guibg=#555555 ctermbg=240
hi ErrorMsg       guifg=#F94226 ctermfg=202 guibg=#232526 ctermbg=235 gui=NONE
hi Exception      guifg=#8ABD25 ctermfg=106 gui=NONE
...
hi Keyword        guifg=#78D3F4 ctermfg=117 gui=NONE
...
hi MatchParen     guifg=#000000 ctermfg=0   guibg=#FFAE4F ctermbg=215 gui=NONE
...
hi PreCondit      guifg=#C6F961 ctermfg=191 gui=NONE
hi PreProc        guifg=#1DFFB0 ctermfg=49
hi Question       guifg=#8D8FF8 ctermfg=105
hi Repeat         guifg=#FF7499 ctermfg=210 gui=NONE
...
hi SpecialChar    guifg=#85D99A ctermfg=114 gui=NONE
hi SpecialComment guifg=#6A6E6F ctermfg=242 gui=NONE
...
hi Statement      guifg=#61D1FD ctermfg=81  gui=NONE
...
hi Todo           guifg=#E962FB ctermfg=171 guibg=bg      ctermbg=0   gui=NONE
...
hi VertSplit      guifg=#808080 ctermfg=244 guibg=#080808 ctermbg=0   gui=NONE
hi VisualNOS      guibg=#403D3D ctermbg=237
hi Visual         guibg=#403D3D ctermbg=237
hi WarningMsg     guifg=#FF914C ctermfg=209 guibg=#333333 ctermbg=236 gui=NONE
