...
hi DiffText term=NONE,underline
...
hi Folded term=NONE
hi Folded cterm=NONE ctermfg=fg ctermbg=bg
hi Folded gui=NONE guifg=fg guibg=bg
...
hi StatusLine term=NONE,inverse
