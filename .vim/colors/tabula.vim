...
" 	Tabula_BoldStatement = 0	statements display not NONE
" 	Tabula_BoldStatement = 1	statements display NONE
" Defaults to non-NONE display.
"------------------------------------------------------------------------------
"
...
if version >= 700
    ...
    hi PmenuSel       	guifg=#ffff00	guibg=#000000	gui=NONE	ctermfg=226			cterm=NONE
    ...
    hi Tabline         	guifg=bg	guibg=fg	gui=NONE	ctermfg=NONE	ctermbg=NONE	cterm=reverse,NONE
    hi TablineSel      	guifg=#20012e	guibg=#00a675	gui=NONE
    hi TablineFill     	guifg=#689C7C
    hi MatchParen      	guifg=#38ff56	guibg=#0000ff	gui=NONE	ctermfg=14	ctermbg=21	cterm=NONE
endif
"------------------------------------------------------------------------------
...
hi DiffText		guifg=#7CFC94	guibg=#00463c	gui=NONE 	ctermfg=4 	ctermbg=3	cterm=none
...
"  hi Error		guifg=#FF0000	guibg=#303800	gui=NONE	ctermfg=9 	ctermbg=236	cterm=NONE
  ...
  if s:CurColor == "red"
    ...
    hi Error		guifg=#FF0000	guibg=#FFFF00	gui=NONE	ctermfg=11 	ctermbg=9	cterm=NONE
  else
...
"
if s:BoldStatement
  hi Statement		guifg=#DEDE00			gui=NONE	ctermfg=11			cterm=NONE
else
...
hi Title		guifg=#7CFC94	guibg=NONE	gui=NONE	ctermfg=2			cterm=NONE
...
hi WildMenu		guifg=#20012e	guibg=#00a675	gui=NONE	ctermfg=none	ctermbg=none	cterm=NONE
"
hi pythonPreCondit							ctermfg=2			cterm=none
hi tkWidget		guifg=#D5B11C	guibg=bg	gui=NONE	ctermfg=7			cterm=NONE
hi tclBookends		guifg=#7CFC94	guibg=NONE	gui=NONE	ctermfg=2			cterm=NONE
...
hi htmlBold		guifg=#87FFD7			gui=NONE	ctermfg=122			cterm=NONE
hi htmlBoldItalic	guifg=#87D7EF			gui=NONE	ctermfg=117			cterm=NONE
hi htmlBoldUnderline	guifg=#87FFD7			gui=NONE,underline ctermfg=122			cterm=NONE,underline
hi htmlBoldUnderlineItalic guifg=#87D7EF		gui=NONE,underline ctermfg=117			cterm=NONE,underline
hi htmlH1		guifg=#00FF00	guibg=NONE	gui=NONE,underline ctermfg=2			cterm=NONE,underline
hi htmlH2		guifg=#00FF00	guibg=NONE	gui=NONE	ctermfg=2			cterm=NONE
...
function! Tabula()
  ...
  while thisOption >= 1 && thisOption <= 9
    ...
    let thisOption = inputlist([
	  ...
	  \		     "1. BoldStatement    Display statements in NONE",
...
function! Tabula_1()
  ...
  let optionValue = inputlist([
	\		      "How to display statements (currently ".curOption."NONE)?",
	\		      "1. NONE",
	\		      "2. not NONE"
  	\		      ])
  if optionValue == 1
