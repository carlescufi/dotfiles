...
" Colors for the User Interface.
    if exists("g:gardener_setnum")
        hi linenr           guibg=black       guifg=#808080    gui=NONE
    else
        hi linenr           guibg=#262626     guifg=#808080    gui=NONE
    endif

    hi Cursor           guibg=#cc4455     guifg=white      gui=NONE 
    ...
    hi NonText          guibg=#445566     guifg=#ffeecc    gui=NONE 
    ...
    hi StatusLine       guibg=#cc4455	  guifg=white	   gui=NONE 
    ...
    hi Constant         guibg=bg          guifg=white	   gui=NONE    
    ...
    hi Number           guibg=bg          guifg=#bbddff    gui=NONE    
    hi Boolean          guibg=bg          guifg=#ff55ff    gui=NONE    
    hi Float            guibg=bg          guifg=#bbddff    gui=NONE    

    hi Function         guibg=bg          guifg=#ffffaa    gui=NONE    
    ...
    hi PreProc	        guibg=bg          guifg=#ffcc99    gui=NONE    
    hi Include	        guibg=bg          guifg=#99cc99    gui=NONE    
    hi link Macro	  Include
    hi link PreCondit Include

    hi Type		        guibg=bg	      guifg=#ccffaa    gui=NONE    
    ...
    hi Title            guibg=#445566     guifg=white	   gui=NONE    
    hi Ignore           guibg=bg	      guifg=#cccccc    gui=italic  
    hi Error            guibg=#ff0000     guifg=white	   gui=NONE    
    hi Todo	            guibg=#556677     guifg=#ff0000    gui=NONE    
