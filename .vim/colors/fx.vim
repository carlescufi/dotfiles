...
exe "hi! CursorLineNr" .s:term."fg="  .s:purple2 .s:NONE   .s:term."bg="   .s:base2L
...
exe "hi! MatchParen"   .s:term."fg="  .s:white   .s:NONE   .s:term."bg="   .s:purple2
"        Match parentheses
...
exe "hi! Visual"       .s:term."fg="  .s:n       .s:NONE   .s:term."bg="    .s:base2
...
" Tabs " {{{
exe "hi! TabLine"      .s:term."fg="  .s:white   .s:NONE   .s:term."bg="   .s:purple2
"       *TabLine        tab pages line, not active tab page label

exe "hi! TabLineFill"  .s:term."fg="  .s:white   .s:NONE   .s:term."bg="   .s:purple2
"       *TabLineFill    tab pages line, where there are no labels

exe "hi! TabLineSel"   .s:term."fg="  .s:white   .s:NONE   .s:term."bg="   .s:purple2
"       *TabLineSel     tab pages line, active tab page label
"}}}
...
exe "hi! DiffAdd"             .s:term."fg="      .s:green  .s:NONE         .s:term."bg="    .s:base2
