...
" UI colors
hi ErrorMsg guifg=#000 ctermfg=0 guibg=#fc8 ctermbg=222 gui=NONE
hi Folded guifg=#88f ctermfg=105 guibg=#333 ctermbg=236 gui=NONE
hi FoldColumn guifg=#88f ctermfg=105 guibg=#333 ctermbg=236 gui=NONE
...
hi CursorLineNr guifg=#ee8 ctermfg=228 gui=NONE
...
hi Boolean guifg=#f88 ctermfg=210 gui=NONE

hi Identifier guifg=#f8f ctermfg=213 gui=none
hi Function guifg=#8f8 ctermfg=120 gui=NONE
...
hi Todo guifg=#444 ctermfg=238 guibg=#999 ctermbg=246 gui=NONE
hi Error guifg=#000 ctermfg=0 guibg=#fc8 ctermbg=222 gui=NONE
