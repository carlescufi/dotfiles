...
let g:elrond#cursorline16 = get(g:, 'elrond#cursorline16' , 'NONE')
...
hi Special    term=NONE      ctermfg=DarkMagenta     guifg=Red
...
hi Function   term=NONE      ctermfg=White           guifg=White
...
if &t_Co == 256
    ...
    highlight LiningBufName ctermbg=237 ctermfg=252 cterm=NONE
    ...
    highlight StatusLineNC  ctermbg=LightGrey ctermfg=0         cterm=reverse,NONE
