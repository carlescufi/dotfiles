...
hi ModeMsg	guibg=Grey90	guifg=Grey30		gui=NONE
...
hi StatusLine	guibg=DimGrey	guifg=White		gui=NONE
...
hi Statement			guifg=#8B4513		gui=NONE
hi PreProc			guifg=DarkBlue		gui=NONE
hi Type				guifg=Blue		gui=NONE
hi Special 			guifg=Red
hi Ignore			guifg=Grey60
hi Todo		guibg=Yellow	guifg=Black 
hi Label 			guifg=firebrick3	gui=NONE

" Vim defaults
hi ErrorMsg	guibg=Red	guifg=White
hi DiffAdd	guibg=#90B0D9
hi DiffChange	guibg=#B1E599
hi DiffDelete	guibg=#D9A465	guifg=Black		gui=NONE
hi DiffText	guibg=Firebrick4 guifg=White		gui=NONE
