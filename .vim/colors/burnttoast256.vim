...
"  au InsertLeave * hi StatusLine term=reverse ctermfg=0 ctermbg=2 gui=NONE,reverse
"endif
...
hi CursorLineNr ctermfg=7   guifg=#e5e5e5 ctermbg=233 guibg=#121212 cterm=NONE gui=NONE
...
hi StatusLine                             ctermbg=239 guibg=#4e4e4e cterm=NONE gui=NONE
...
hi WildMenu     ctermfg=0   guifg=#000000 ctermbg=184 guibg=#d7d700 cterm=NONE gui=NONE
hi LineNr       ctermfg=8   guifg=#7f7f7f ctermbg=233 guibg=#121212
...
hi MatchParen   ctermfg=188 guifg=#d7d7d7 ctermbg=68  guibg=#5f87d7 cterm=NONE gui=NONE
