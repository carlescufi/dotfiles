...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  call <SID>X("Todo",                       accent22, accent00, "NONE")
  ...
  call <SID>X("HTMLEndTag",                 fg1,      "",       "NONE")
  call <SID>X("HTMLTag",                    fg1,      "",       "NONE")
  call <SID>X("HTMLTagN",                   accent21, "",       "")
  call <SID>X("HTMLArg",                    accent21, "",       "")

  " Markdown highlights
  call <SID>X("markdownJekyllFrontMatter",                  accent32,      "",       "NONE")

  " NERDTREE highlights
  call <SID>X("Directory",                  fg1,      "",       "NONE")
  call <SID>X("NERDTreeCWD",                fg2,      "",       "NONE")
  call <SID>X("NERDTreeFlags",              fg2,      "",       "NONE")
  ...
  call <SID>X("NERDTreeGitStatusDirDirty",  accent22, "",       "NONE")
  call <SID>X("NERDTreeGitStatusModified",  accent21, "",       "NONE")
  call <SID>X("NERDTreeGitStatusUntracked", fg1,      "",       "NONE")
