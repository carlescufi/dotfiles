...
hi conditional	guifg=#0000B0 gui=NONE 		"dark blue "former statement
hi preProc		guifg=#FF0D00 gui=italic 	"red
hi Function		guifg=#008040 gui=NONE 		"dark green,functions not not in standard lib
hi Keyword		guifg=#0000B0 gui=NONE 		"dark blue "former statement
hi special		guifg=#DC5B00 				"orange, ahkKeyword (ahkclass). also scales
hi Macro		guifg=#FF6400 gui=NONE 		"orange, built-in variable
hi operator		guifg=#FF0D00 					"not used in ahk
hi Label 		guifg=#FF0D00 gui=NONE,underline "this is important. Return is also marked
hi Typedef		guifg=#804040 gui=NONE 		"dark red, other keywords
