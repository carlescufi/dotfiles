...
hi SpecialKey term=NONE ctermfg=51
hi NonText term=NONE cterm=NONE ctermfg=21
hi Directory term=NONE ctermfg=51
hi ErrorMsg term=standout ctermfg=231 ctermbg=196
hi IncSearch term=reverse cterm=reverse
hi Search term=reverse ctermfg=16 ctermbg=226
hi MoreMsg term=NONE cterm=NONE ctermfg=29
hi ModeMsg term=NONE cterm=NONE
hi LineNr term=underline ctermfg=226
hi CursorLineNr term=NONE cterm=NONE ctermfg=226
hi Question term=standout cterm=NONE ctermfg=46
hi StatusLine term=NONE,reverse cterm=NONE,reverse
hi StatusLineNC term=reverse cterm=reverse
hi VertSplit term=reverse cterm=reverse
hi Title term=NONE cterm=NONE ctermfg=201
hi Visual term=reverse ctermbg=248
hi VisualNOS term=NONE,underline cterm=NONE,underline
...
hi DiffAdd term=NONE ctermbg=18
hi DiffChange term=NONE ctermbg=90
hi DiffDelete term=NONE cterm=NONE ctermfg=21 ctermbg=30
hi DiffText term=reverse cterm=NONE ctermbg=196
...
hi Comment term=NONE ctermfg=111
hi Constant term=underline ctermfg=217
hi Special term=NONE ctermfg=214
hi Identifier term=underline ctermfg=87
hi Statement term=NONE cterm=NONE ctermfg=227
hi PreProc term=underline ctermfg=213
hi Type term=underline cterm=NONE ctermfg=83
...
hi quickfix_error cterm=NONE ctermfg=16 ctermbg=196
hi syntax_pimpl_access term=NONE ctermfg=242
...
hi SpecialKey gui=NONE guifg=yellow guibg=darkred
hi Conceal guifg=yellow guibg=black gui=NONE

hi DiffAdd guibg=#152515
hi DiffChange guibg=#153552
hi DiffDelete guibg=#552525 guifg=#552525
hi DiffText gui=NONE guifg=yellow guibg=darkred
...
hi StatusLineNC guibg=black guifg=#c2bfa5 gui=NONE

hi Question guifg=seagreen
hi ModeMsg guifg=seagreen
hi MoreMsg guifg=seagreen
hi ErrorMsg gui=NONE guifg=yellow guibg=darkred
hi WarningMsg gui=NONE guifg=black guibg=darkorange
...
hi WildMenu guibg=#6f6760 guifg=black gui=NONE

" Syntax highlighting groups "
hi Comment guifg=#668888

hi Todo gui=NONE guifg=yellow guibg=darkred
...
hi Boolean guibg=#0b0b0b gui=NONE
...
hi Type guifg=#68bb88 gui=NONE
hi Special guifg=#3daee9
hi Ignore guifg=#668888
hi Keyword guifg=#eeee77 gui=NONE gui=NONE
...
hi cStorageClass guifg=#68bb88 gui=NONE
hi cType guifg=#68bb88 gui=NONE
hi cUserLabel guifg=#eeee77 gui=NONE

hi cppAccess guifg=#eeee77 gui=NONE
hi cppAnnotation guifg=#777777
hi cppConstKeyword guifg=#68bb88
hi cppOperator guifg=#3daee9 gui=NONE gui=none
hi cppSTLNamespace guifg=#777777
hi cppSTLfunction guifg=#eeeeee
hi cppStructure guifg=#eeee77 gui=NONE gui=NONE
hi cppSyntaxNamespaceAccess guifg=#777777
hi cppTemplateKeyword guifg=#f67400 gui=NONE
hi cppType guifg=#68bb88 gui=NONE
...
hi scalaInstanceDeclaration guifg=#68bb88 gui=NONE
