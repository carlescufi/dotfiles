...
if &background == "dark"
  ...
  hi Constant 	      guifg=#ffaf00                   gui=NONE
  ...
  hi Statement 	      guifg=#94be54                   gui=NONE
  hi Conditional      guifg=#7aa6c2                   gui=NONE
  hi Repeat           guifg=#7aa6c2 guibg=NONE      gui=NONE
  hi Label            guifg=#409a50                   gui=NONE
  " operator cpp: sizeof()
  hi Operator         guifg=#658aa5 guibg=NONE      gui=none
  "html: special keywords in jscript: window log
  hi Keyword	        guifg=#adffdd                   gui=none
  hi Exception        guifg=#2080c0 guibg=NONE      gui=NONE

  hi PreProc 	        guifg=#2288ee                   gui=NONE
  hi Include 	        guifg=#2288ee                   gui=NONE
  hi Define           guifg=#2288ee                   gui=NONE
  ...
  hi Tag              guifg=#00c0ff               gui=NONE
  hi Delimiter        guifg=#7a9acd guibg=NONE    gui=none

  hi SpecialComment   guifg=#6090c0               gui=NONE
  hi Debug            guifg=#ddb800 guibg=NONE    gui=NONE

  hi Underlined       guifg=#b5b5b5 guibg=NONE    gui=underline

  " Misc syntax ###############################################################
  
  hi Todo             guifg=#fff63f guibg=#736a3f gui=NONE

  hi Directory        guifg=#b5b5b5 guibg=NONE    gui=NONE
  ...
  hi Search           guifg=#000000 guibg=#b8ea00 gui=NONE
  hi IncSearch        guifg=#f8cf00 guibg=#000000

  hi Error            guifg=#e5a5a5 guibg=#602020 gui=NONE,underline
  hi ErrorMsg         guifg=#f5c5c5 guibg=#901010 gui=NONE
  ...
  hi CursorLineNr     guifg=#d0d0d0 guibg=#482020 gui=NONE
  ...
  hi FoldColumn       guifg=#b0b8c0 guibg=#373d43 gui=NONE
  ...
  hi NERDTreeClosable guifg=#66b600 guibg=#385038 gui=NONE ctermfg=70 ctermbg=22 cterm=NONE
  hi NERDTreePart     guifg=#707070 ctermfg=243
  hi NERDTreePartFile guifg=#FFFFFF gui=NONE ctermfg=231 cterm=NONE
  ...
  hi TagbarScope      guifg=#0087d7 gui=NONE ctermfg=32 cterm=NONE
  hi TagbarType       guifg=#66b600 gui=NONE ctermfg=70 cterm=NONE
  ...
  hi CleverFDefaultLabel guibg=#5fd700 guifg=#404040 gui=NONE ctermbg=76 ctermfg=238 cterm=NONE

  " https://github.com/mhinz/vim-startify
  hi StartifyBracket  guifg=#0087d7 guibg=#303030 gui=NONE ctermfg=32 ctermbg=236 cterm=NONE
  hi StartifyFile     guifg=#00afff ctermfg=39
  hi StartifyHeader   guifg=#00afff ctermfg=39
  hi link StartifyFooter StartifyHeader
  hi StartifyNumber   ctermfg=215 guifg=#00d700 guibg=#303030 gui=NONE ctermfg=40 ctermbg=236 cterm=NONE
  ...
  hi  jediFat         guibg=#303030  guifg=#afd700 gui=NONE ctermbg=236 ctermfg=148 cterm=NONE

  " https://github.com/tomtom/quickfixsigns_vim
  if g:kalisi_recolor_quickfixsigns == 1
     hi QFSignsMark       guifg=#ffc63f guibg=#202020 gui=NONE ctermfg=220 ctermbg=234 cterm=NONE
  ...
  if &t_Co > 255
    ...
    hi Constant cterm=NONE ctermfg=214
    ...
    hi Statement cterm=NONE ctermfg=149
    hi Conditional cterm=NONE ctermfg=110
    hi Repeat cterm=NONE ctermfg=110
    hi Label cterm=NONE ctermfg=35
    hi Operator ctermfg=67
    hi Keyword ctermfg=158
    hi Exception cterm=NONE ctermfg=32
    hi PreProc cterm=NONE ctermfg=33
    hi Include cterm=NONE ctermfg=33
    hi Define cterm=NONE ctermfg=33
    ...
    hi Tag cterm=NONE ctermfg=39
    hi Delimiter ctermfg=104
    hi SpecialComment cterm=NONE ctermfg=67
    hi Debug cterm=NONE ctermfg=184
    hi Underlined cterm=underline ctermfg=249
    hi Todo cterm=NONE ctermbg=94 ctermfg=227
    hi Directory cterm=NONE ctermfg=252
    hi DiffAdd ctermbg=22
    hi DiffChange ctermbg=239
    hi DiffText cterm=NONE ctermbg=18 ctermfg=254
    ...
    hi ModeMsg cterm=NONE ctermbg=148 ctermfg=16
    hi Cursor ctermbg=160 ctermfg=231
    hi CursorLineNr cterm=NONE ctermbg=52 ctermfg=252
    ...
    hi FoldColumn cterm=NONE ctermbg=236 ctermfg=145
    ...
    hi Title cterm=NONE ctermfg=252
  ...
  hi Constant         guifg=#0000af guibg=NONE    gui=NONE
  ...
  hi Statement        guifg=#66b600 guibg=NONE    gui=NONE
  hi Conditional      guifg=#1177dd guibg=NONE    gui=NONE
  hi Repeat           guifg=#1177dd guibg=NONE    gui=NONE
  hi Label            guifg=#007700               gui=NONE
  hi Operator         guifg=#274aac guibg=NONE    gui=none
  hi Exception        guifg=#005090 guibg=NONE    gui=NONE

  hi PreProc          guifg=#d80050 guibg=NONE    gui=NONE
  hi Include          guifg=#d80050 guibg=NONE    gui=NONE
  hi Define           guifg=#d80050 guibg=NONE    gui=NONE
  ...
  hi CursorLineNr     guifg=#e0e0e0 guibg=#c9c4c4 gui=NONE
  ...
  hi FoldColumn       guifg=#707070 guibg=#b0b0b0 gui=NONE
  ...
  hi ModeMsg          guifg=#000000 guibg=#A6DB29
  hi WarningMsg       guifg=#d82020 guibg=NONE    gui=NONE
  ...
  hi PmenuSel         guifg=#000000 guibg=#A6DB29 gui=NONE
  hi PmenuSbar                      guibg=#a0a0a0
  hi PmenuThumb                     guibg=#555555
  ...
  " htmldjango
  hi DjangoBlock      guifg=#005f00               gui=NONE
  hi link djangoTagBlock DjangoBlock
  hi link djangoVarBlock DjangoBlock
  ...
  " https://github.com/scrooloose/nerdtree
  hi NERDTreeDir      guifg=#0087d7 gui=NONE ctermfg=32 cterm=NONE
  hi link NERDTreeDirSlash NERDTreeDir
  hi link NERDTreeOpenable NERDTreeDir
  hi NERDTreeClosable guifg=#008700  guibg=#5fd75f gui=NONE ctermfg=28 ctermbg=77 cterm=NONE
  hi NERDTreePart     guifg=#c0c0c0 ctermfg=250
  hi NERDTreePartFile guifg=#000000 gui=NONE ctermfg=16 cterm=NONE
  hi NERDTreeLinkFile guifg=#ffaf00 ctermfg=214
  hi NERDTreeLinkDir  guifg=#ffaf00 ctermfg=214
  ...
  " https://github.com/justinmk/vim-sneak
  hi SneakPluginTarget guibg=#ffaf00 guifg=#ffff00 gui=NONE ctermbg=214 ctermfg=226 cterm=NONE
  hi link SneakPluginScope Visual

  " https://github.com/rhysd/clever-f.vim
  hi CleverFDefaultLabel guibg=#ffd700 guifg=#000000 gui=NONE ctermbg=220 ctermfg=16 cterm=NONE

  " https://github.com/mhinz/vim-startify
  hi StartifyBracket  guifg=#00d7ff  guibg=#005f87 gui=NONE ctermfg=45 ctermbg=24 cterm=NONE
  hi StartifyFile     guifg=#005fd7 ctermfg=26
  hi StartifyHeader   guifg=#005fd7 ctermfg=26
  hi link StartifyFooter StartifyHeader
  hi StartifyNumber   ctermfg=215 guifg=#00ff00  guibg=#005f87 gui=NONE ctermfg=46 ctermbg=24 cterm=NONE
  ...
  hi jediFat          guibg=#878787 guifg=#afd700 gui=NONE ctermbg=244 ctermfg=148 cterm=NONE
  
  " https://github.com/tomtom/quickfixsigns_vim
  if g:kalisi_recolor_quickfixsigns == 1
       hi QFSignsMark       guifg=#005faf guibg=#a0a0a0 gui=NONE ctermfg=25 ctermbg=247 cterm=NONE
  ...
  if &t_Co > 255
    ...
    hi Character ctermfg=98 cterm=NONE
    hi Number ctermfg=25
    hi Boolean ctermfg=70
    hi Float ctermfg=36
    hi Identifier ctermfg=18
    hi Function ctermfg=32
    hi Statement cterm=NONE ctermfg=70
    hi Conditional cterm=NONE ctermfg=32
    hi Repeat cterm=NONE ctermfg=32
    hi Label cterm=NONE ctermfg=28
    hi Operator ctermfg=25
    hi Exception cterm=NONE ctermfg=24
    hi PreProc cterm=NONE ctermfg=161
    hi Include cterm=NONE ctermfg=161
    ...
    hi SpecialChar cterm=NONE ctermfg=197
    hi Tag cterm=NONE ctermfg=21
    hi Delimiter ctermfg=161
    hi Debug cterm=NONE ctermfg=178
    hi Underlined cterm=underline ctermfg=234
    hi Error cterm=underline ctermbg=252 ctermfg=160
    hi ErrorMsg cterm=NONE ctermbg=188 ctermfg=160
    hi Todo cterm=NONE ctermbg=226 ctermfg=16
    hi Directory cterm=NONE ctermfg=25
    hi Keyword ctermfg=70
    hi Title cterm=NONE ctermfg=25
    hi NonText ctermbg=253 ctermfg=16
    hi Conceal ctermbg=253 ctermfg=236
    hi DiffAdd ctermbg=194
    hi DiffChange ctermbg=254
    hi DiffText cterm=NONE ctermbg=189 ctermfg=17
    hi DiffDelete cterm=NONE ctermbg=224 ctermfg=252
    ...
    hi CursorLineNr cterm=NONE ctermbg=251 ctermfg=254
    ...
    hi FoldColumn cterm=NONE ctermbg=145 ctermfg=242
    hi WildMenu ctermbg=148 ctermfg=16
    hi Question ctermbg=148 ctermfg=16
    hi MoreMsg ctermbg=148 ctermfg=16
    hi ModeMsg cterm=NONE ctermbg=148 ctermfg=16
    hi WarningMsg cterm=NONE ctermfg=160
    hi TabLine ctermbg=22 ctermfg=148 cterm=none
    hi TabLineSel ctermbg=148 ctermfg=22 cterm=none
    hi TabLineFill ctermbg=247 ctermfg=236 cterm=none
    hi SignColumn ctermbg=251 ctermfg=148
    hi Pmenu ctermbg=254 ctermfg=16
    hi PmenuSel cterm=NONE ctermbg=148 ctermfg=16
    hi PmenuSbar ctermbg=247
    hi PmenuThumb ctermbg=240
    ...
    hi DjangoBlock cterm=NONE ctermfg=22
  endif
endif 
