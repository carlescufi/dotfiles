...
hi LineNr gui=NONE guifg=#828c95 guibg=#bbbbbb
hi NonText gui=NONE guifg=DarkGray guibg=#bbbbbb
...
hi StatusLine gui=NONE guifg=#829db9 guibg=Black
hi StatusLineNC gui=NONE guifg=#829db9 guibg=#666666
hi VertSplit gui=NONE guifg=#9ca6af guibg=DimGray
