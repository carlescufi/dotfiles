...
if ($TERM =~ '256' || &t_Co >= 256) || has('gui_running')
  ...
  hi Error            ctermbg=160  ctermfg=255  guibg=#d70000 guifg=#ffffff cterm=NONE           gui=NONE
  ...
  hi Todo             ctermbg=228  ctermfg=234  guibg=#ffff87 guifg=#1c1c1c cterm=NONE           gui=NONE
  ...
  hi TabNumSel        ctermbg=1    ctermfg=231  guibg=#af0000 guifg=#ffffff cterm=NONE           gui=NONE
  hi TabNum           ctermbg=254  ctermfg=1    guibg=#e4e4e4 guifg=#d70000 cterm=NONE           gui=NONE

  hi WinNumSel        ctermbg=153  ctermfg=160  guibg=#afd7ff guifg=#d70000 cterm=NONE           gui=NONE
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
  ...
  hi TabNumSel        ctermbg=1           ctermfg=7           cterm=NONE
  hi TabNum           ctermbg=15          ctermfg=1           cterm=NONE

  hi WinNumSel        ctermbg=8           ctermfg=1           cterm=NONE
