...
hi ErrorMsg         guifg=#cd0000   guibg=bg        gui=NONE    " red3 on background (NONE)
hi FoldColumn       guifg=#00ced1   guibg=bg        gui=NONE    " darkturquoise on background (NONE)
hi Folded           guifg=#48d1cc   guibg=bg        gui=italic  " mediumturquoise on background (italic)
hi IncSearch        guifg=#00bfff   guibg=bg        gui=NONE    " deepskyblue on background
...
hi ModeMsg          guifg=#ff6347   guibg=bg        gui=NONE    " tomato on background (NONE)
hi MoreMsg          guifg=#ff4500   guibg=bg        gui=NONE    " orangered on background (NONE)
...
hi Question         guifg=#ffffff   guibg=#0000ff   gui=NONE    " white on blue (NONE)
hi SignColumn       guifg=#4169e1   guibg=bg        gui=NONE    " royalblue on background (NONE)
...
hi TabLineSel       guifg=fg        guibg=bg        gui=NONE    " mediumblue on background (NONE)
...
hi Error            guifg=#cd0000   guibg=bg        gui=NONE    " red3 on background (NONE)
hi Todo             guifg=#bc8f8f   guibg=bg        gui=NONE    " rosybrown on background (NONE)
hi Exception        guifg=#ee0000   guibg=bg        gui=NONE    " red2 on background (NONE)
hi Underlined                                       gui=underline    " underline

" --- VimError

hi VimError         guifg=#ffffff   guibg=#ff0000   gui=NONE    " white on red (NONE)
hi VimCommentTitle  guifg=#778899   guibg=bg        gui=italic  " lightslategray on background (italic)

" --- QuickFix

hi dfLineNr         guifg=#008080   guibg=#dcdcdc   gui=NONE    " teal on gainsboro (NONE)
...
elseif &t_Co == 256
    ...
    if has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsol) || &term =~? "^konsole"
        ...
        CSAHi ErrorMsg      ctermfg=160 ctermbg=231 term=NONE
        CSAHi FoldColumn    ctermfg=37  ctermbg=231 term=NONE
        CSAHi Folded        ctermfg=38  ctermbg=231 term=NONE
        CSAHi IncSearch     ctermfg=19  ctermbg=231
        CSAHi LineNr        ctermfg=20  ctermbg=251
        CSAHi MatchParen    ctermfg=231 ctermbg=20
        CSAHi ModeMsg       ctermfg=166 ctermbg=231 term=NONE
        CSAHi MoreMsg       ctermfg=202 ctermbg=231 term=NONE
        ...
        CSAHi Question      ctermfg=231 ctermbg=21  term=NONE
        CSAHi SignColumn    ctermfg=19  ctermbg=231 term=NONE
        ...
        CSAHi Error         ctermfg=160 ctermbg=231 term=NONE
        CSAHi Todo          ctermfg=95  ctermbg=231 term=NONE
        CSAHi Exception     ctermfg=124 ctermbg=231 term=NONE
