...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Folded", "ffd700", "000000", "NONE")
    ...
    call <SID>X("Search", "333333", "cccccc", "NONE")
    ...
    call <SID>X("PmenuSel", "663333", "cccccc", "NONE")
    ...
    call <SID>X("Conditional", "ff6633", "", "NONE")
    call <SID>X("Repeat", "66ff66", "", "NONE")
    call <SID>X("Function", "9999ff", "", "underline")
    call <SID>X("Delimiter", "99cccc", "", "NONE")
    "Underlined
    ...
    " for Ruby {{{
    call <SID>X("rubyDefine", "ffff00", "", "NONE")
    call <SID>X("rubyClass", "3399ff", "", "NONE")
    call <SID>X("rubyModule", "ff9966", "", "NONE")
    ...
    call <SID>X("rubyKeyword", "ff6666", "", "NONE")
    " }}}
