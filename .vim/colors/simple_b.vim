...
highlight PreProc	    cterm=NONE ctermfg=black ctermbg=lightblue gui=NONE guifg=black guibg=lightblue
" Include defaults to PreProc
" Define defaults to PreProc
" Macro defaults to PreProc
" PreCondit defaults to PreProc

highlight Type		    cterm=NONE ctermfg=black ctermbg=lightblue gui=NONE guifg=black guibg=lightblue
...
highlight Todo		    cterm=italic,NONE ctermfg=black ctermbg=lightblue gui=italic,NONE guifg=black guibg=lightblue
" Ideally, the bg color would be white but VIM cannot print white on black!
highlight Error		    cterm=NONE,reverse ctermfg=black ctermbg=grey gui=NONE,reverse guifg=black guibg=grey
