...
hi NonText		gui=NONE			guifg=LightBlue			guibg=grey80
...
hi Statement	cterm=NONE			ctermfg=DarkGreen		ctermbg=White
hi Statement	guifg=DarkGreen		gui=NONE
...
hi operator		guifg=DarkGreen		gui=NONE

hi StorageClass	ctermfg=DarkRed			ctermbg=White
hi StorageClass	guifg=#a02060			gui=NONE
...
hi DiffText		cterm=NONE			ctermbg=DarkRed
...
hi SpecialChar	guifg=DarkGrey		gui=NONE
...
hi StatusLine	term=reverse,NONE
hi StatusLine	cterm=reverse,NONE
