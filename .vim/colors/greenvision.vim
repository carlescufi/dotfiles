...
hi Cursor		guifg=#00ff00 gui=NONE,reverse ctermfg=010 ctermbg=000 cterm=NONE,reverse
hi CursorColumn 	guifg=#000000 guibg=#00cc00 gui=none ctermfg=000 ctermbg=002 cterm=none
hi CursorIM		guifg=#00ff00 guibg=#000000 gui=NONE ctermfg=046 ctermbg=000 cterm=NONE
...
hi ErrorMsg		guifg=#000000 guibg=#00ff00 gui=NONE ctermfg=000 ctermbg=010 cterm=none
...
hi MatchParen		guifg=#304300 guibg=#00fe00 gui=none ctermfg=010 ctermbg=022 cterm=NONE
hi ModeMsg		guifg=#00ea00 guibg=#000900 gui=none ctermfg=002 ctermbg=000 cterm=none
hi MoreMsg		guifg=#00e700 guibg=#001000 gui=NONE ctermfg=002 ctermbg=000 cterm=NONE
...
hi SpecialKey		guifg=#008000 guibg=#002300 gui=NONE ctermfg=034 ctermbg=000 cterm=NONE
hi Statement		guifg=#2fc626 guibg=#000000 gui=none ctermfg=010 ctermbg=000 cterm=none
hi StatusLine		guifg=#00ff00 guibg=#001000 gui=none ctermfg=047 ctermbg=022 cterm=NONE
...
hi TabLineSel		guifg=#00f000 guibg=#002a00 gui=none ctermfg=046 ctermbg=022 cterm=NONE
hi Title		guifg=#09ab00 guibg=#000000 gui=NONE ctermfg=010 ctermbg=000 cterm=NONE
