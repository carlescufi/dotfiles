...
if exists("g:zephyr_no_diff")
	...
	hi DiffChange term=reverse cterm=NONE ctermbg=235 ctermfg=252
	hi DiffDelete term=reverse cterm=NONE ctermbg=232 ctermfg=241
	hi DiffText   term=reverse cterm=NONE ctermbg=166 ctermfg=252
	hi DiffAdd    term=reverse cterm=NONE ctermbg=22  ctermfg=252
endif
...
" PHP Specific
hi phpRegionDelimiter cterm=NONE ctermfg=228
hi phpSpecialFunction cterm=NONE ctermfg=79
