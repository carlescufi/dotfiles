...
highlight Search        gui=NONE   guibg=#440088 guifg=fg
highlight SpecialKey    gui=NONE   guibg=#004400 guifg=#ffff00
highlight StatusLine    gui=NONE   guibg=#ffcc00 guifg=#000088
highlight StatusLineNC  gui=none   guibg=#ffcc00 guifg=#333300
highlight Title         gui=NONE,italic  guifg=black guibg=#ffff00
highlight Visual        gui=reverse guibg=#ffff00 guifg=#008800
highlight VisualNOS     gui=italic,underline guifg=fg guibg=bg
highlight WarningMsg    gui=NONE   guifg=#ff0000 guibg=bg
highlight WildMenu      gui=NONE   guibg=#008888 guifg=#ffff00
highlight ColorColumn   gui=NONE,italic guibg=#444400 guifg=#ff0000

"-- Syntax Colors
"highlight Comment       gui=reverse guifg=#507080
highlight Comment       gui=None guifg=#ffaa00 guibg=#221100

highlight Constant      gui=NONE guifg=white guibg=bg
...
highlight Statement   gui=NONE   guifg=#ff8800
...
highlight Type          gui=NONE guifg=#ff8800
...
highlight Todo       gui=NONE guifg=yellow guibg=#aa7700

"-- OLD COLORS
"highlight prologAtom guifg=#dddd00 gui=italic
highlight prologVariable     gui=NONE,italic guifg=#00ff00
highlight prologFreeVariable gui=italic      guifg=#00ff00
highlight xpceVariable       gui=NONE        guifg=#ffff00 guibg=#666666
highlight xpceKeyword        gui=NONE        guifg=#ff8800 guibg=#666666

highlight MatchParen         gui=NONE        guibg=#448800 guifg=#ccff00

highlight Pmenu         gui=NONE        guifg=#ffcc00 guibg=#004400
highlight PmenuSel      gui=NONE        guibg=#ffcc00 guifg=#004400
highlight PmenuSbar     gui=NONE        guibg=#884400 guifg=#004400
highlight PmenuThumb    gui=NONE        guibg=#ffff00 guifg=#004400
