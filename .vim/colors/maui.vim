...
hi SpecialKey term=NONE guifg=#5f5f5f ctermfg=59
hi NonText term=NONE guifg=#5f5f5f ctermfg=59
hi Directory term=NONE gui=NONE cterm=NONE guifg=#5f87af ctermfg=67
hi ErrorMsg term=standout gui=NONE cterm=NONE guifg=#ff00af ctermfg=199 guibg=#000000 ctermbg=16
...
hi MoreMsg term=NONE guifg=#ffffaf ctermfg=229
hi ModeMsg term=NONE gui=NONE cterm=NONE guifg=#ffffaf ctermfg=229
hi LineNr term=underline guifg=#303030 ctermfg=236 guibg=#101010 ctermbg=233
hi CursorLineNr term=NONE guifg=#ff8700 ctermfg=208
hi Question term=standout guifg=#5fdfff ctermfg=81
hi StatusLine term=NONE gui=NONE cterm=NONE guifg=#5f87af ctermfg=67 guibg=#303030 ctermbg=236
...
hi Title term=NONE guifg=#df5f00 ctermfg=166
hi Visual term=reverse gui=none cterm=none guibg=#003366 ctermbg=236
hi VisualNOS guibg=#444444 ctermbg=238
hi WarningMsg term=standout gui=NONE cterm=NONE guifg=#ffffff ctermfg=231 guibg=#444444 ctermbg=238
...
hi DiffAdd term=NONE guibg=#1d3600 ctermbg=22
hi DiffChange term=NONE guibg=#1d3600 ctermbg=0
hi DiffDelete term=NONE guifg=#5f0000 ctermfg=52 guibg=#5f0000 ctermbg=52
hi DiffText term=NONE gui=NONE cterm=NONE guibg=#2a4f00 ctermbg=238
...
hi TabLineSel term=NONE gui=NONE cterm=NONE
...
hi MatchParen term=reverse gui=NONE cterm=NONE guifg=#121212 ctermfg=233 guibg=#ff8700 ctermbg=208
...
hi Constant term=underline gui=NONE cterm=NONE guifg=#df005f ctermfg=161
hi Identifier term=underline guifg=#5f87af ctermfg=67
hi Statement term=NONE gui=NONE cterm=NONE guifg=#df5f00 ctermfg=166
hi PreProc term=underline guifg=#87af5f ctermfg=107
hi Type term=underline guifg=#5f87df ctermfg=68
hi Special term=NONE guifg=#5f87af ctermfg=67
hi Ignore guifg=#808080 ctermfg=244 guibg=#080808 ctermbg=232
hi Todo term=standout gui=NONE cterm=NONE guifg=#ffffff ctermfg=231 guibg=#080808 ctermbg=232
...
hi Conditional gui=NONE cterm=NONE guifg=#ff8700 ctermfg=208
hi Repeat gui=NONE cterm=NONE guifg=#df005f ctermfg=161
hi Label guifg=#ffffaf ctermfg=229
hi Operator guifg=#df005f ctermfg=161
hi Keyword gui=NONE cterm=NONE guifg=#df005f ctermfg=161
hi Exception gui=NONE cterm=NONE guifg=#87af5f ctermfg=107
hi Define guifg=#5f87af ctermfg=67
hi Macro guifg=#dfffaf ctermfg=193
hi PreCondit gui=NONE cterm=NONE guifg=#87af5f ctermfg=107
hi StorageClass guifg=#ff8700 ctermfg=208
hi Structure guifg=#5fdfff ctermfg=81
hi Typedef guifg=#5fdfff ctermfg=81
hi Tag gui=NONE cterm=NONE guifg=#df005f ctermfg=161
hi SpecialChar gui=NONE cterm=NONE guifg=#df005f ctermfg=161
hi Delimiter guifg=#5f87af ctermfg=67
hi SpecialComment gui=NONE cterm=NONE guifg=#8a8a8a ctermfg=245
hi Debug gui=NONE cterm=NONE guifg=#ffdfff ctermfg=225

hi diffRemoved term=NONE guibg=#5f0000 ctermbg=52
...
hi SyntasticError term=reverse gui=NONE,underline cterm=NONE,underline guifg=#ffafff ctermfg=219 guibg=#303030 ctermbg=236
hi SyntasticWarning term=standout gui=NONE,underline cterm=NONE,underline guifg=#ff00af ctermfg=199 guibg=#262626 ctermbg=235
