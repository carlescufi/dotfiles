...
hi LineNr gui=NONE guifg=#828c95 guibg=#bbbbbb ctermfg=244 ctermbg=7
hi NonText gui=NONE guifg=DarkGray guibg=#bbbbbb ctermfg=7 ctermbg=7
hi SpecialKey term=NONE ctermfg=4
hi Title term=NONE ctermfg=5 guifg=RoyalBlue4
...
hi VertSplit gui=NONE guifg=#9ca6af guibg=Black cterm=NONE ctermfg=231 ctermbg=8
...
hi Todo gui=NONE guifg=Black guibg=Yellow ctermbg=214 ctermbg=232
...
hi Statement gui=NONE guifg=#bb88bb ctermfg=132
