...
hi ErrorMsg		    guibg=#A50000   guifg=White     ctermfg=Red         ctermbg=none        term=NONE       cterm=NONE
hi WarningMsg 		guibg=#FFCC00   guifg=White     ctermfg=Yellow      ctermbg=none        term=NONE       cterm=NONE

hi IncSearch		guibg=#804000   guifg=#FF9911 	ctermfg=DarkRed     ctermbg=Brown       term=NONE            
hi Search		    guibg=#804000   guifg=#FF9911   ctermfg=DarkRed     ctermbg=Brown       term=NONE       gui=reverse    
...
hi Directory 		guibg=#405871   guifg=#CCCCFF   ctermfg=White       ctermbg=none        term=NONE		   
...
hi Visual 		    guibg=#25345F   guifg=#647C95   ctermfg=White       ctermbg=none        term=NONE       cterm=NONE      gui=none 
hi VisualNOS 		guibg=#25345F   guifg=#526A83   ctermfg=White       ctermbg=none        term=NONE       cterm=NONE      gui=underline

hi DiffText		    guibg=#FF9911   guifg=White     gui=none 	
hi DiffAdd 		    guibg=#FFB720   guifg=White	    gui=NONE         
hi DiffChange 		guibg=#D26C00		            gui=underline     
hi DiffDelete 		guibg=#AA4400   guifg=#DDDDDD   gui=NONE	
...
hi Comment		                    guifg=#5EA7DD   ctermfg=DarkCyan    ctermbg=none        term=NONE       cterm=NONE
hi PreProc		                    guifg=#999999   ctermfg=LightGray   ctermbg=none        term=NONE       cterm=NONE
hi Constant 		                guifg=#FF9911	ctermfg=Brown       ctermbg=none		term=underline
hi Special 		    guibg=Black	    guifg=#FF9911   ctermfg=Brown       ctermbg=Black       term=NONE
hi Identifier		                guifg=#BBBBBB   ctermfg=LightGray   ctermbg=none
hi Tag              guibg=Black     guifg=#B0E0E6
hi Statement 	                    guifg=#FFFFFF   ctermfg=White       ctermbg=none        term=NONE       cterm=NONE  gui=NONE      
hi Type			                    guifg=#80C9FF   ctermfg=LightCyan   ctermbg=none      	term=underline  gui=NONE
hi Title 		                    guifg=#C8E2FF   ctermfg=Cyan        ctermbg=DarkBlue	term=NONE	    gui=NONE
hi Question 		                guifg=#80C9FF   ctermfg=Blue        ctermbg=none        cterm=NONE      term=NONE   gui=NONE
hi SpecialKey 		                guifg=#677F98 	                                        term=NONE
...
hi ModeMsg 		                    guifg=#80C9FF   ctermfg=Blue        ctermbg=none        cterm=NONE      term=NONE   gui=NONE
hi MoreMsg 		                    guifg=#80C9FF   ctermfg=Blue        ctermbg=none        cterm=NONE      term=NONE   gui=NONE
hi NonText 		    guibg=#2D3D4F   guifg=#405871   ctermfg=DarkGray    ctermbg=none        cterm=NONE      term=NONE   gui=NONE		        
hi MatchParen       guibg=Black     guifg=#FF9911   ctermfg=Brown       ctermbg=none        cterm=NONE      term=NONE   gui=NONE
" EOF
