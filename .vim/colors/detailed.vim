...
fun! s:NONE(group)
  exe 'hi '.a:group.' cterm=NONE gui=NONE'
endfun
...
fun! s:underline_fgbg(group, fg, bg)
  exe 'hi '.a:group.' ctermfg='.s:c[a:fg].' '
    \s:color_for(a:bg,'bg').' cterm=underline,NONE gui=underline,NONE'
endfun
...
hi SpecialKey     term=NONE ctermfg=81 guifg=Cyan
hi NonText        term=NONE ctermfg=12 gui=NONE guifg=Blue
...
hi MoreMsg        term=NONE ctermfg=121 gui=NONE guifg=SeaGreen
...
hi Question       term=standout ctermfg=121 gui=NONE guifg=Green
hi StatusLine     term=NONE,reverse cterm=NONE,reverse gui=NONE,reverse
hi StatusLineNC   term=reverse cterm=reverse gui=reverse
hi VertSplit      term=reverse cterm=reverse gui=reverse
hi Title          term=NONE ctermfg=225 gui=NONE guifg=Magenta
...
hi Special        term=NONE ctermfg=224 guifg=Orange
hi Identifier     term=underline cterm=NONE ctermfg=14 guifg=#40ffff
hi Statement      term=NONE ctermfg=11 gui=NONE guifg=#ffff60
hi PreProc        term=underline ctermfg=81 guifg=#ff80ff
hi Type           term=underline ctermfg=121 gui=NONE guifg=#60ff60
