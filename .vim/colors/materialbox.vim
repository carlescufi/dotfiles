...
call s:HL('materialboxRedBold', s:red, s:none, s:NONE)
call s:HL('materialboxGreen', s:green)
call s:HL('materialboxGreenBold', s:green, s:none, s:NONE)
call s:HL('materialboxYellow', s:yellow)
call s:HL('materialboxYellowBold', s:yellow, s:none, s:NONE)
call s:HL('materialboxBlue', s:blue)
" call s:HL('materialboxBlueBold', s:blue, s:none, s:NONE)
call s:HL('materialboxPurple', s:purple)
" call s:HL('materialboxPurpleBold', s:purple, s:none, s:NONE)
call s:HL('materialboxAqua', s:aqua)
call s:HL('materialboxAquaBold', s:aqua, s:none, s:NONE)
call s:HL('materialboxOrange', s:orange)
call s:HL('materialboxOrangeBold', s:orange, s:none, s:NONE)
...
if version >= 700
  ...
  call s:HL('TabLineSel', s:vim_bg, s:bg4, s:NONE . s:invert_tabline)
  " Not active tab page label
  hi! link TabLine TabLineFill

  " Match paired bracket under the cursor
  call s:HL('MatchParen', s:none, s:bg3, s:NONE)
endif
...
call s:HL('StatusLine',   s:bg4, s:bg0, s:NONE . s:inverse)
call s:HL('StatusLineNC', s:bg2, s:fg4, s:NONE . s:inverse)

" The column separating vertically split windows
call s:HL('VertSplit', s:fg4, s:vert_split)

" Current match in wildmenu completion
call s:HL('WildMenu', s:blue, s:bg2, s:NONE)
...
call s:HL('ErrorMsg',   s:vim_bg, s:red, s:NONE)
" More prompt: -- More --
...
call s:HL('Todo', s:vim_fg, s:vim_bg, s:NONE . s:italic)
call s:HL('Error', s:red, s:vim_bg, s:NONE . s:inverse)
...
if version >= 700
  ...
  call s:HL('PmenuSel', s:bg2, s:blue, s:NONE)
...
if has("spell")
  ...
  if g:materialbox_improved_warnings == 0
    ...
    call s:HL('SpellCap',   s:green, s:none, s:NONE . s:italic)
  endif
  " Not recognized word
...
call s:HL('CtrlPMode1', s:blue, s:bg2, s:NONE)
call s:HL('CtrlPMode2', s:bg0, s:blue, s:NONE)
call s:HL('CtrlPStats', s:fg4, s:bg2, s:NONE)
...
call s:HL('htmlBold', s:vim_fg, s:vim_bg, s:NONE)
call s:HL('htmlBoldUnderline', s:vim_fg, s:vim_bg, s:NONE . s:underline)
call s:HL('htmlBoldItalic', s:vim_fg, s:vim_bg, s:NONE . s:italic)
call s:HL('htmlBoldUnderlineItalic', s:vim_fg, s:vim_bg, s:NONE . s:underline . s:italic)
...
call s:HL('vimCommentTitle', s:fg4_256, s:none, s:NONE . s:italicize_comments)
...
call s:HL('clojureRegexpCharClass', s:fg3, s:none, s:NONE)
