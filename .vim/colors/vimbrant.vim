...
if has('gui_running')
    ...
    " Outline tags
    hi outlTags        guifg=#A6E22E               gui=NONE
...
elseif &t_Co > 255
    ...
    " Outline tags
    hi outlTags        ctermfg=118               cterm=NONE
...
elseif &t_Co < 256
    ...
    hi Boolean         ctermfg=5  cterm=NONE 
    ...
    hi Debug           ctermfg=5  cterm=NONE 
    hi Define          ctermfg=4
    hi Delimiter       ctermfg=0  cterm=NONE

    hi DiffAdd                    ctermbg=4
    hi DiffChange      ctermfg=5  ctermbg=8  cterm=NONE 
    ...
    hi Float           ctermfg=5  cterm=NONE 
    hi FoldColumn      ctermfg=5  cterm=NONE 
    hi Folded          ctermfg=5  cterm=NONE 
    hi Function        ctermfg=2  
    hi Identifier      ctermfg=3
    hi Ignore          ctermfg=7
    hi IncSearch       ctermfg=2  cterm=NONE 

    hi Keyword         ctermfg=1
    hi Label           ctermfg=3  cterm=NONE 
    hi Macro           ctermfg=2  cterm=NONE 
    hi SpecialKey      ctermfg=4

    hi mailSubject     ctermfg=3  cterm=NONE 
    hi mailHeaderKey   ctermfg=3  cterm=NONE 
    hi mailHeader      ctermfg=3  cterm=NONE 
    hi mailQuoted1     ctermfg=6
    hi mailQuoted2     ctermfg=6  cterm=NONE 
    hi mailQuoted3     ctermfg=2
    hi mailQuoted4     ctermfg=3
    hi mailQuoted5     ctermfg=1
    hi mailQuoted6     ctermfg=5
    ...
    hi MoreMsg         ctermfg=3  cterm=NONE  
    ...
    hi Repeat          ctermfg=1
    hi Search          ctermfg=7  ctermbg=1     cterm=NONE 
    ...
    if has("spell")
        ...
        hi clear SpellLocal
        hi SpellLocal   ctermfg=3 term=underline  cterm=underline,NONE
        hi clear SpellRare
        hi SpellRare    ctermfg=7 term=underline  cterm=underline,NONE
    endif

    hi Statement       ctermfg=1
    hi StatusLine      ctermfg=7  ctermbg=6     cterm=NONE
    hi StatusLineNC    ctermfg=7                cterm=NONE
    hi StorageClass    ctermfg=3
    hi Structure       ctermfg=4 
    hi Tag             ctermfg=1  
    hi Title           ctermfg=3
    hi Todo            ctermfg=3  cterm=NONE 
    ...
    hi Visual                      ctermbg=8
    hi WarningMsg      ctermfg=3   ctermbg=8     cterm=NONE
    ...
    " Outlines
    hi OL1             ctermfg=1                cterm=NONE
    hi OL2             ctermfg=4                cterm=NONE
    hi OL3             ctermfg=6                cterm=NONE
    hi OL4             ctermfg=7                cterm=NONE
    hi OL5             ctermfg=1
    hi OL6             ctermfg=4
    hi OL7             ctermfg=6
    hi OL8             ctermfg=7
    ...
    " Outline tags
    hi outlTags        ctermfg=1                cterm=NONE
