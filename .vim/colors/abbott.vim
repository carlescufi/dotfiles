...
call s:H("Statement", { "fg": s:red, "opt": "NONE" })
...
call s:H("ModeMsg", { "opt": "NONE" })
call s:H("MoreMsg", { "fg": s:blue, "opt": "NONE" })
call s:H("Pmenu", { "bg": s:dark_brown })
call s:H("PmenuSel",
      \ { "fg": s:dark_brown, "bg": s:light_brown, "opt": "NONE" })
call s:H("PmenuSbar", { "bg": s:light_brown })
call s:H("PmenuThumb", { "bg": s:blue })
call s:H("Question", { "fg": s:pink, "opt": "NONE" })
call s:H("SignColumn", { "fg": s:brown, "bg": s:mint_green })
call s:H("StatusLine", { "fg": s:brown, "bg": s:pastel_blue, "opt": "NONE" })
...
call s:H("TabLineSel", { "fg": s:brown, "bg": s:pastel_blue, "opt": "NONE" })
call s:H("Title", { "fg": s:red, "opt": "NONE" })
...
call s:H("DiffAdd", { "fg": s:brown, "bg": s:green, "opt": "NONE" })
call s:H("DiffChange", { "fg": s:brown, "bg": s:pink })
call s:H("DiffDelete", { "fg": s:brown, "bg": s:red })
call s:H("DiffText", { "fg": s:brown, "bg": s:pastel_blue, "opt": "NONE" })
