...
hi Statement        cterm=NONE              ctermfg=149         ctermbg=NONE
hi Conditional      cterm=NONE              ctermfg=149         ctermbg=NONE
hi Repeat           cterm=NONE              ctermfg=149         ctermbg=NONE
hi Label            cterm=NONE              ctermfg=149         ctermbg=NONE
hi Operator         cterm=NONE              ctermfg=149         ctermbg=NONE
hi Keyword          cterm=NONE              ctermfg=149         ctermbg=NONE
...
hi ErrorMsg         cterm=NONE              ctermfg=15          ctermbg=9
hi LineNr           cterm=NONE              ctermfg=245         ctermbg=238
hi MatchParen       cterm=NONE              ctermfg=0           ctermbg=149
hi ModeMsg          cterm=NONE              ctermfg=15          ctermbg=NONE
hi MoreMsg          cterm=NONE              ctermfg=149         ctermbg=NONE
hi NonText          cterm=NONE              ctermfg=239         ctermbg=NONE
...
" TABS
""""""""""""""""""""""""
hi TabLine          cterm=NONE,reverse      ctermfg=0	        ctermbg=240
hi TabLineFill      cterm=NONE,reverse      ctermfg=0	        ctermbg=240
hi TabLineSel       cterm=NONE,reverse      ctermfg=0	        ctermbg=240
...
hi DiffDelete       cterm=NONE              ctermfg=239         ctermbg=66
hi DiffText         cterm=NONE              ctermfg=15         	ctermbg=NONE
