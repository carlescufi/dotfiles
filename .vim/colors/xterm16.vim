...
try
	...
	call s:hi( 'MatchParen'  , 'NONE'   , 'none'       , 'none'      )
	...
	call s:hi( 'SpellBad'  , 'NONE,underline', 'none', 'none'    ,
		    \		 'undercurl'     , 'none', 'none'    ,
		    \            'darkred'       )
	...
	if !exists("g:xterm16_NoHtmlColors")
	    call s:hi( 'htmlBold',                'none', 'white',       'none', 'NONE',                  'none')
	    call s:hi( 'htmlItalic',              'none', 'yellow',      'none', 'italic',                'none')
	    call s:hi( 'htmlUnderline',           'none', 'darkmagenta', 'none', 'underline',             'none')
	    call s:hi( 'htmlBoldItalic',          'NONE', 'yellow',      'none', 'NONE,italic',           'none')
	    call s:hi( 'htmlBoldUnderline',       'NONE', 'magenta',     'none', 'NONE,underline',        'none')
	    call s:hi( 'htmlUnderlineItalic',     'none', 'magenta',     'none', 'underline,italic',      'none')
	    call s:hi( 'htmlBoldUnderlineItalic', 'NONE', 'white',       'none', 'NONE,underline,italic', 'none')
	...
	" {{{2 Spelling highlighting groups.
	call s:hi( 'SpellBad'  , 'NONE,underline', 'none', 'darkgrey',
		    \		 'undercurl'     , 'none', 'none'    ,
		    \            'red'           )
	call s:hi( 'SpellCap'  , 'NONE'          , 'none', 'darkgrey',
		    \		 'undercurl'     , 'none', 'none'    ,
		    \            'skyblue'       )
	...
	if !exists("g:xterm16_NoHtmlColors")
	    ...
	    call s:hi( 'htmlUnderline',           'none', 'magenta', 'none',
			\ 'underline',             'none')
	    call s:hi( 'htmlBoldItalic',          'NONE', 'yellow',  'none',
			\ 'NONE,italic',           'none')
	    call s:hi( 'htmlBoldUnderline',       'NONE', 'magenta', 'none',
			\ 'NONE,underline',        'none')
	    call s:hi( 'htmlUnderlineItalic',     'NONE', 'magenta', 'none',
			\ 'underline,italic',      'none')
	    call s:hi( 'htmlBoldUnderlineItalic', 'NONE', 'white',   'none',
			\ 'NONE,underline,italic', 'none')
	endif
	" }}}2
	...
	" some crappy grey background + NONE / etc. Not something that stands
	" out too much because there are invariably numerous spelling mistakes
	" highlighted in most code.
	"
	call s:hi( 'SpellBad'	, 'NONE,underline'      , 'none', 'grey2',
		    \		  'undercurl' , 'none', 'none' , 'red' 	     )
	call s:hi( 'SpellCap'	, 'NONE'      , 'none', 'grey2',
	...
	if !exists("g:xterm16_NoHtmlColors")
	    call s:hi( 'htmlBold',                'none', 'yellow',  'none', 'NONE',                  'none')
	    call s:hi( 'htmlItalic',              'none', 'yellow',  'none', 'italic',                'none')
	    call s:hi( 'htmlUnderline',           'none', 'darkpurple', 'none', 'underline',             'none')
	    call s:hi( 'htmlBoldItalic',          'NONE', 'yellow',  'none', 'NONE,italic',           'none')
	    call s:hi( 'htmlBoldUnderline',       'NONE', 'darkpurple', 'none', 'NONE,underline',        'none')
	    call s:hi( 'htmlUnderlineItalic',     'NONE', 'darkpurple', 'none', 'underline,italic',      'none')
	    call s:hi( 'htmlBoldUnderlineItalic', 'NONE', 'white',   'none', 'NONE,underline,italic', 'none')
	endif
	" }}}2
    else
