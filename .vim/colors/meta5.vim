...
hi Visual         guifg=#afffff guibg=#4e4e4e gui=NONE ctermfg=159 ctermbg=239 cterm=NONE
...
hi Todo           guifg=#00ffff guibg=#606060 gui=NONE ctermfg=6 ctermbg=239 cterm=NONE
hi Boolean        guifg=#87ff5f gui=NONE ctermfg=119 cterm=NONE
...
hi Typedef        guifg=#87dfff gui=NONE ctermfg=117 cterm=NONE
...
hi Repeat         guifg=#afdfff gui=NONE ctermfg=153 cterm=NONE
hi Exception      guifg=#afdfff gui=NONE ctermfg=153 cterm=NONE
hi Operator       guifg=#8787ff ctermfg=105
hi Keyword        guifg=#dfffff guibg=NONE gui=NONE ctermfg=195 ctermbg=NONE  cterm=NONE
hi Constant       guifg=#af5fff ctermfg=195
hi Number         guifg=#5fdf5f ctermfg=77
hi Special        guifg=#5fdf5f gui=NONE ctermfg=77 cterm=NONE
