...
" StatusLine
" Bold
hi User1                     guifg=#eeeeee guibg=#606060 gui=NONE ctermfg=255 ctermbg=241 cterm=NONE
" Yellow
hi User2                     guifg=#FFAF00 guibg=#606060 gui=NONE ctermfg=214 ctermbg=241 cterm=NONE
" Green
hi User3                     guifg=#5fff00 guibg=#606060 gui=NONE ctermfg=82 ctermbg=241 cterm=NONE
" Red
hi User4                     guifg=#870000 guibg=#606060 gui=NONE ctermfg=88 ctermbg=241 cterm=NONE
hi User5                     guifg=#e4e4e4 guibg=#606060 gui=NONE ctermfg=254 ctermbg=241 cterm=NONE
hi User6                     guifg=#e4e4e4 guibg=#606060 gui=NONE ctermfg=254 ctermbg=241 cterm=NONE
hi User7                     guifg=#e4e4e4 guibg=#606060 gui=NONE ctermfg=254 ctermbg=241 cterm=NONE
hi User8                     guifg=#e4e4e4 guibg=#606060 gui=NONE ctermfg=254 ctermbg=241 cterm=NONE
hi User9                     guifg=#e4e4e4 guibg=#606060 gui=NONE ctermfg=254 ctermbg=241 cterm=NONE
...
" hi Todo                      guifg=#000000 guibg=ffff00 gui=NONE ctermfg=16 ctermbg=11 cterm=NONE
...
hi DiffDelete                guifg=#000000 guibg=#660000 gui=NONE ctermfg=16 ctermbg=52 cterm=NONE
hi DiffChange                guifg=#FFFFFF guibg=#870087 ctermfg=15 ctermbg=90
hi DiffText                  guifg=#FFFFFF guibg=#FF0000 gui=NONE ctermfg=15 ctermbg=9 cterm=NONE

hi diffAdded                 guifg=#008700 ctermfg=28
hi diffRemoved               guifg=#800000 ctermfg=1
hi diffNewFile               guifg=#FFFFFF guibg=NONE gui=NONE ctermfg=15 ctermbg=NONE cterm=NONE
hi diffFile                  guifg=#FFFFFF guibg=NONE gui=NONE ctermfg=15 ctermbg=NONE cterm=NONE


" Ruby
" ----
hi rubyTodo                  guifg=#df5f5f guibg=NONE gui=NONE ctermfg=167 ctermbg=NONE cterm=NONE
