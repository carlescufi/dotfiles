...
" Split area
highlight StatusLine   gui=none guifg=#ffffff guibg=#4570aa cterm=NONE       ctermbg=blue     ctermfg=white
...
" Diff
highlight DiffText   gui=none guifg=red   guibg=#ffd0d0 cterm=NONE    ctermbg=5  ctermfg=3
...
highlight DiffAdd    gui=none guifg=blue  guibg=#e7e7ff ctermbg=green cterm=NONE
