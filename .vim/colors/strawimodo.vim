...
hi PmenuSel                  guifg=#ffffff  guibg=#ff855c  gui=NONE
...
hi ModeMsg                   guifg=#f9d07f                 gui=NONE
...
hi Comment                   guifg=#bc9458                 gui=NONE,italic
hi Error                     guifg=#ffffff  guibg=#aa5555  gui=none
hi ErrorMsg                  guifg=#ffffff  guibg=#aa5555  gui=none
hi Todo                      guifg=#000000  guibg=#ff855c  gui=NONE
hi WarningMsg                guifg=#000000  guibg=#ff855c  gui=none

" IncSearch  = incremental search
" Search     = found matches

hi IncSearch                 guifg=#ffffff  guibg=#8d97af  gui=NONE
hi Search                    guifg=#000000  guibg=#f9d07f  gui=NONE
...
hi DiffText                  guifg=#000000  guibg=#ff855c  gui=NONE
...
hi TabLineSel                guifg=#222222 guibg=#b2c867 gui=NONE
...
hi Number                    guifg=#ff7a53                 gui=NONE
hi PreCondit                 guifg=#CC7833                 gui=none
hi PreProc                   guifg=#CC7833                 gui=none
hi Statement                 guifg=#f9d07f                 gui=NONE
hi String                    guifg=#b2c867                 gui=NONE
hi Title                     guifg=#ffffff                 gui=none
hi Type                      guifg=#d78a42                 gui=NONE

" plugin-specific {{{1

" file name from taglist.vim
hi TagListFileName           guifg=#b2c867                 gui=NONE
