...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || (&term =~? "^konsole" && s:old_kde())
    ...
    CSAHi Statement term=NONE cterm=NONE ctermbg=bg ctermfg=222 gui=NONE guibg=bg guifg=#ffd75f
    ...
    CSAHi SpecialKey term=NONE cterm=NONE ctermbg=bg ctermfg=38 gui=NONE guibg=bg guifg=#0087d7
    ...
    CSAHi ModeMsg term=NONE cterm=NONE ctermbg=bg ctermfg=138 gui=NONE guibg=bg guifg=#875f5f
    ...
    CSAHi Function term=NONE cterm=NONE ctermbg=bg ctermfg=217 gui=NONE guibg=bg guifg=#ff8787
    CSAHi CursorLineNr term=NONE cterm=NONE ctermbg=bg ctermfg=226 gui=NONE guibg=bg guifg=#ffff00
    CSAHi Question term=NONE cterm=NONE ctermbg=bg ctermfg=214 gui=NONE guibg=bg guifg=#ffaf00
    CSAHi StatusLine term=NONE,reverse cterm=NONE ctermbg=138 ctermfg=229 gui=NONE guibg=#875f5f guifg=#ffffaf
    ...
    CSAHi Title term=NONE cterm=NONE ctermbg=232 ctermfg=136 gui=NONE guibg=#080808 guifg=#af5f00
    ...
    CSAHi Comment term=NONE cterm=NONE ctermbg=237 ctermfg=195 gui=NONE guibg=#393939 guifg=#d7ffff
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=159 gui=NONE guibg=bg guifg=#9fffff
    CSAHi Special term=NONE cterm=NONE ctermbg=bg ctermfg=224 gui=NONE guibg=bg guifg=#ffd7d7
    CSAHi Identifier term=NONE cterm=NONE ctermbg=bg ctermfg=217 gui=NONE guibg=bg guifg=#ff8787
    ...
    CSAHi DiffAdd term=NONE cterm=NONE ctermbg=34 ctermfg=229 gui=NONE guibg=#00af00 guifg=#ffffaf
    CSAHi DiffChange term=NONE cterm=NONE ctermbg=38 ctermfg=229 gui=NONE guibg=#0087d7 guifg=#ffffaf
    CSAHi DiffDelete term=NONE cterm=NONE ctermbg=124 ctermfg=229 gui=NONE guibg=#af0000 guifg=#ffffaf
    CSAHi DiffText term=reverse cterm=NONE ctermbg=34 ctermfg=229 gui=NONE guibg=#00af00 guifg=#ffffaf
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi Statement term=NONE cterm=NONE ctermbg=bg ctermfg=228 gui=NONE guibg=bg guifg=#ffd75f
    ...
    CSAHi SpecialKey term=NONE cterm=NONE ctermbg=bg ctermfg=39 gui=NONE guibg=bg guifg=#0087d7
    ...
    CSAHi Function term=NONE cterm=NONE ctermbg=bg ctermfg=217 gui=NONE guibg=bg guifg=#ff8787
    CSAHi CursorLineNr term=NONE cterm=NONE ctermbg=bg ctermfg=226 gui=NONE guibg=bg guifg=#ffff00
    CSAHi Question term=NONE cterm=NONE ctermbg=bg ctermfg=220 gui=NONE guibg=bg guifg=#ffaf00
    CSAHi StatusLine term=NONE,reverse cterm=NONE ctermbg=138 ctermfg=230 gui=NONE guibg=#875f5f guifg=#ffffaf
    ...
    CSAHi Title term=NONE cterm=NONE ctermbg=232 ctermfg=172 gui=NONE guibg=#080808 guifg=#af5f00
    ...
    CSAHi Comment term=NONE cterm=NONE ctermbg=237 ctermfg=231 gui=NONE guibg=#393939 guifg=#d7ffff
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=195 gui=NONE guibg=bg guifg=#9fffff
    CSAHi Special term=NONE cterm=NONE ctermbg=bg ctermfg=231 gui=NONE guibg=bg guifg=#ffd7d7
    CSAHi Identifier term=NONE cterm=NONE ctermbg=bg ctermfg=217 gui=NONE guibg=bg guifg=#ff8787
    CSAHi StartifyPath term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SyntasticErrorLine term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Folded term=NONE cterm=NONE ctermbg=103 ctermfg=231 gui=NONE guibg=#5f5f87 guifg=#ffffd7
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=103 ctermfg=250 gui=NONE guibg=#5f5f87 guifg=#bbbbbb
    CSAHi DiffAdd term=NONE cterm=NONE ctermbg=40 ctermfg=230 gui=NONE guibg=#00af00 guifg=#ffffaf
    CSAHi DiffChange term=NONE cterm=NONE ctermbg=39 ctermfg=230 gui=NONE guibg=#0087d7 guifg=#ffffaf
    CSAHi DiffDelete term=NONE cterm=NONE ctermbg=160 ctermfg=230 gui=NONE guibg=#af0000 guifg=#ffffaf
    CSAHi DiffText term=reverse cterm=NONE ctermbg=40 ctermfg=230 gui=NONE guibg=#00af00 guifg=#ffffaf
    CSAHi SignColumn term=NONE cterm=NONE ctermbg=232 ctermfg=103 gui=NONE guibg=#0b0b0b guifg=#5f5f87
...
elseif has("gui_running") || &t_Co == 256
    CSAHi Normal term=NONE cterm=NONE ctermbg=16 ctermfg=229 gui=NONE guibg=#000000 guifg=#ffffaf
    CSAHi Statement term=NONE cterm=NONE ctermbg=bg ctermfg=221 gui=NONE guibg=bg guifg=#ffd75f
    ...
    CSAHi Number term=NONE cterm=NONE ctermbg=bg ctermfg=146 gui=NONE guibg=bg guifg=#afafd7
    CSAHi SpecialKey term=NONE cterm=NONE ctermbg=bg ctermfg=32 gui=NONE guibg=bg guifg=#0087d7
    CSAHi NonText term=NONE cterm=NONE ctermbg=233 ctermfg=230 gui=NONE guibg=#111111 guifg=#ffffd7
    ...
    CSAHi ModeMsg term=NONE cterm=NONE ctermbg=bg ctermfg=95 gui=NONE guibg=bg guifg=#875f5f
    CSAHi LineNr term=NONE cterm=NONE ctermbg=146 ctermfg=16 gui=NONE guibg=#afafd7 guifg=#000000
    CSAHi StartifyFile term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi StartifySlash term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi TabLineFill term=reverse cterm=reverse ctermbg=bg ctermfg=fg gui=reverse guibg=bg guifg=fg
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=242 ctermfg=fg gui=NONE guibg=#6c6c6c guifg=fg
    CSAHi Function term=NONE cterm=NONE ctermbg=bg ctermfg=210 gui=NONE guibg=bg guifg=#ff8787
    CSAHi CursorLineNr term=NONE cterm=NONE ctermbg=bg ctermfg=226 gui=NONE guibg=bg guifg=#ffff00
    CSAHi Question term=NONE cterm=NONE ctermbg=bg ctermfg=214 gui=NONE guibg=bg guifg=#ffaf00
    CSAHi StatusLine term=NONE,reverse cterm=NONE ctermbg=95 ctermfg=229 gui=NONE guibg=#875f5f guifg=#ffffaf
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=121 ctermfg=95 gui=NONE guibg=#8fffaf guifg=#875f5f
    CSAHi VertSplit term=reverse cterm=reverse ctermbg=229 ctermfg=16 gui=reverse guibg=#000000 guifg=#ffffaf
    CSAHi Title term=NONE cterm=NONE ctermbg=232 ctermfg=130 gui=NONE guibg=#080808 guifg=#af5f00
    ...
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=159 gui=NONE guibg=bg guifg=#9fffff
    CSAHi Special term=NONE cterm=NONE ctermbg=bg ctermfg=224 gui=NONE guibg=bg guifg=#ffd7d7
    CSAHi Identifier term=NONE cterm=NONE ctermbg=bg ctermfg=210 gui=NONE guibg=bg guifg=#ff8787
    CSAHi StartifyPath term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SyntasticErrorLine term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi DiffAdd term=NONE cterm=NONE ctermbg=34 ctermfg=229 gui=NONE guibg=#00af00 guifg=#ffffaf
    CSAHi DiffChange term=NONE cterm=NONE ctermbg=32 ctermfg=229 gui=NONE guibg=#0087d7 guifg=#ffffaf
    CSAHi DiffDelete term=NONE cterm=NONE ctermbg=124 ctermfg=229 gui=NONE guibg=#af0000 guifg=#ffffaf
    CSAHi DiffText term=reverse cterm=NONE ctermbg=34 ctermfg=229 gui=NONE guibg=#00af00 guifg=#ffffaf
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi Statement term=NONE cterm=NONE ctermbg=bg ctermfg=73 gui=NONE guibg=bg guifg=#ffd75f
    ...
    CSAHi SpecialKey term=NONE cterm=NONE ctermbg=bg ctermfg=22 gui=NONE guibg=bg guifg=#0087d7
    ...
    CSAHi ModeMsg term=NONE cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=#875f5f
    ...
    CSAHi Function term=NONE cterm=NONE ctermbg=bg ctermfg=69 gui=NONE guibg=bg guifg=#ff8787
    CSAHi CursorLineNr term=NONE cterm=NONE ctermbg=bg ctermfg=76 gui=NONE guibg=bg guifg=#ffff00
    CSAHi Question term=NONE cterm=NONE ctermbg=bg ctermfg=72 gui=NONE guibg=bg guifg=#ffaf00
    CSAHi StatusLine term=NONE,reverse cterm=NONE ctermbg=37 ctermfg=78 gui=NONE guibg=#875f5f guifg=#ffffaf
    ...
    CSAHi Title term=NONE cterm=NONE ctermbg=16 ctermfg=52 gui=NONE guibg=#080808 guifg=#af5f00
    ...
    CSAHi Comment term=NONE cterm=NONE ctermbg=80 ctermfg=63 gui=NONE guibg=#393939 guifg=#d7ffff
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=47 gui=NONE guibg=bg guifg=#9fffff
    CSAHi Special term=NONE cterm=NONE ctermbg=bg ctermfg=74 gui=NONE guibg=bg guifg=#ffd7d7
    CSAHi Identifier term=NONE cterm=NONE ctermbg=bg ctermfg=69 gui=NONE guibg=bg guifg=#ff8787
    CSAHi StartifyPath term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SyntasticErrorLine term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi DiffAdd term=NONE cterm=NONE ctermbg=24 ctermfg=78 gui=NONE guibg=#00af00 guifg=#ffffaf
    CSAHi DiffChange term=NONE cterm=NONE ctermbg=22 ctermfg=78 gui=NONE guibg=#0087d7 guifg=#ffffaf
    CSAHi DiffDelete term=NONE cterm=NONE ctermbg=48 ctermfg=78 gui=NONE guibg=#af0000 guifg=#ffffaf
    CSAHi DiffText term=reverse cterm=NONE ctermbg=24 ctermfg=78 gui=NONE guibg=#00af00 guifg=#ffffaf
