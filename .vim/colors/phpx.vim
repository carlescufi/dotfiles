...
hi Special         guifg=#d75f00 guibg=bg term=NONE ctermfg=166 
hi Identifier      guifg=#0000af guibg=bg term=underline cterm=NONE ctermfg=19 
hi Statement       guifg=#008700 guibg=bg gui=NONE term=NONE ctermfg=28 cterm=NONE 
hi PreProc         guifg=#00af00 guibg=bg term=underline cterm=NONE ctermfg=34 gui=NONE 
...
hi Ignore          guifg=bg guibg=fg cterm=NONE ctermfg=0 
hi Error           guifg=#ffffff guibg=#ff0000 term=reverse cterm=NONE ctermfg=15 ctermbg=12 
...
hi TabLineSel      guifg=fg guibg=bg gui=NONE term=NONE cterm=NONE 
...
hi SpecialKey      guifg=#00ffff guibg=bg term=NONE ctermfg=9 
hi NonText         guifg=#0000ff guibg=bg gui=NONE term=NONE ctermfg=9 
hi Directory       guifg=#00ffff guibg=bg term=NONE ctermfg=11 
hi ErrorMsg        guifg=#ffffff guibg=#ff0000 term=standout cterm=NONE ctermfg=15 ctermbg=4 
...
hi MoreMsg         term=NONE ctermfg=29 gui=NONE guifg=#00875f guibg=bg
hi ModeMsg         term=NONE cterm=NONE ctermfg=178 gui=NONE guifg=#d7af00 guibg=bg
hi LineNr          guifg=#d7d787 guibg=bg term=underline ctermfg=186 
hi Question        guifg=#00ffff guibg=bg gui=NONE term=standout ctermfg=14 
hi StatusLine      guifg=#000087 guibg=#ffffff gui=NONE,reverse term=NONE,reverse cterm=NONE,reverse ctermfg=18 ctermbg=15 
hi StatusLineNC    guifg=#949494 guibg=#ffffff gui=NONE,reverse term=NONE,reverse cterm=NONE,reverse ctermfg=246 ctermbg=15 
hi VertSplit       guifg=#000087 guibg=#c6c6c6 gui=reverse ctermfg=18 ctermbg=251 term=reverse cterm=reverse 
hi Title           guifg=#d700af guibg=bg gui=NONE term=NONE ctermfg=163 
hi Visual          guifg=#ffffaf guibg=#005f00 gui=reverse term=reverse cterm=reverse ctermfg=229 ctermbg=22 
hi VisualNOS       guifg=fg guibg=bg gui=NONE,underline term=NONE,underline cterm=NONE,underline 
...
hi DiffAdd         guibg=#000087 guifg=#e4e4e4 term=NONE ctermbg=1 ctermbg=18 ctermfg=254 
hi DiffChange      guibg=#870087 guifg=#87afff term=NONE ctermbg=90 
hi DiffDelete      guifg=#0000ff guibg=#008787 gui=NONE term=NONE cterm=NONE ctermfg=21 ctermbg=30 ctermbg=3 
hi DiffText        guibg=#ff0000 guifg=fg gui=NONE term=reverse cterm=NONE ctermbg=9 
