...
hi StatusLine   term=NONE cterm=NONE ctermfg=White ctermbg=Blue		gui=NONE guifg=#FFFFFF guibg=#0050EE
hi StatusLineNC term=NONE cterm=NONE ctermfg=Gray  ctermbg=Blue      gui=NONE guifg=#AAAAAA guibg=#000090
hi LineNr		 term=NONE cterm=NONE ctermfg=White ctermbg=DarkBlue  gui=NONE guifg=#00A0FF guibg=#000050
