...
execute "hi Conditional		gui=NONE guifg=" . s:LightBlue[1]
execute "hi Constant		gui=NONE guifg=" . s:Red[2]
execute "hi Error			guifg=" . s:Red[5] . " guibg=" . s:Red[0]
execute "hi Identifier		gui=NONE guifg=" . s:Red[3]
execute "hi Ignore			guifg=" . s:Red[1]
execute "hi Operator		gui=NONE guifg=" . s:Red[5]
execute "hi PreProc			gui=NONE guifg=" . s:Red[3]
execute "hi Repeat			gui=NONE guifg=" . s:LightBlue[3]
execute "hi Special			guifg=" . s:LightBlue[1]
execute "hi Statement		gui=NONE guifg=" . s:LightBlue[2]
execute "hi String			guifg=" . s:DarkBlue[2]
execute "hi Title			guifg=" . s:White[0]
execute "hi Todo			gui=NONE guisp=NONE guibg=NONE guifg=" . s:Red[4] 
