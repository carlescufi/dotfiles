...
hi DiffText	cterm=NONE	ctermfg=White	ctermbg=Gray		gui=NONE	guifg=White	guibg=DarkGray
hi ErrorMsg			ctermfg=White	ctermbg=DarkRed				guifg=White	guibg=DarkRed
hi VertSplit	cterm=reverse						gui=reverse
hi Folded	cterm=NONE	ctermfg=Cyan	ctermbg=NONE		gui=NONE	guifg=Cyan	guibg=DarkCyan
...
if version >= 700
  hi MatchParen	cterm=NONE,underline		ctermbg=NONE		gui=NONE,underline		guibg=NONE
endif
hi ModeMsg	cterm=NONE	ctermfg=White				gui=NONE	guifg=White
hi MoreMsg	cterm=NONE	ctermfg=White				gui=NONE	guifg=White
...
hi StatusLine	cterm=NONE,reverse ctermfg=White ctermbg=Black		gui=NONE,reverse guifg=White	guibg=Black
