...
hi NonText      guifg=ForestGreen	gui=NONE
...
hi StatusLine	guibg=#156050 guifg=yellow	gui=NONE
...
hi Type		guifg=PaleGreen1	gui=NONE
...
hi Conditional gui=NONE	guifg=DarkOliveGreen1
hi Operator gui=NONE	guifg=cyan1
hi link Keyword Operator
hi Directory	guifg=coral
hi Cursor       guibg=Salmon1	guifg=black
hi Search       guibg=yellow guifg=Black
hi IncSearch	guibg=#5a7570 guifg=Black gui=NONE
