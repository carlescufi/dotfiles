...
hi Directory      term=NONE cterm=NONE ctermfg=DarkCyan guifg=LightBlue
hi Search         term=reverse ctermfg=10 guifg=Green guibg=Black
hi MoreMsg        term=NONE cterm=NONE ctermfg=darkgreen gui=NONE guifg=Yellow
hi ModeMsg        term=NONE cterm=NONE ctermfg=lightred gui=NONE guifg=DeepPink guibg=Black
hi LineNr         term=underline cterm=NONE ctermfg=darkgrey guifg=Cadetblue4
hi Question       term=standout cterm=NONE ctermfg=lightgreen gui=NONE guifg=Yellow
hi Comment        term=NONE cterm=NONE ctermfg=darkcyan gui=none guifg=Cadetblue3
hi Constant       term=NONE cterm=none ctermfg=7 gui=none guifg=LightGray
hi Special        term=NONE cterm=none ctermfg=2 gui=none guifg=DarkOliveGreen1
hi Identifier     term=none cterm=none ctermfg=7 gui=none guifg=LightGray
hi PreProc        term=underline cterm=NONE ctermfg=7 gui=none guifg=Yellow
hi Error          term=reverse cterm=NONE ctermfg=7 ctermbg=1 gui=NONE guifg=Red guibg=Black
...
hi Function       term=NONE cterm=NONE ctermfg=14 gui=NONE guifg=White
hi Statement      term=NONE cterm=NONE ctermfg=14 gui=NONE guifg=White
hi Include        term=NONE cterm=NONE ctermfg=12 gui=none guifg=LightBlue
hi StorageClass   term=NONE cterm=NONE ctermfg=13 gui=none guifg=LightMagenta
hi Type           term=none cterm=none ctermfg=7 gui=none guifg=LightGray
hi Defined        term=NONE cterm=NONE ctermfg=14 gui=none guifg=LightCyan
hi MatchParen	  term=NONE cterm=NONE ctermbg=8 ctermfg=13 gui=none guifg=DeepPink guibg=Black
hi Cursorline	  guibg=Black
hi Cursor		  term=NONE cterm=NONE ctermfg=0 ctermbg=10 guibg=GreenYellow guifg=Black 
