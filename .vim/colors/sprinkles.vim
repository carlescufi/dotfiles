...
function! s:Style(hlgroup, fg, bg, attr)
  ...
  " use bright colors with the NONE attr
  if a:attr =~# "NONE" && (0 <= l:fg_idx && l:fg_idx < 8)
...
call s:Style("Error",          s:white,   s:red,     "NONE")
...
""           HIGHLIGHT GROUP   TEXT       BACKGROUND ATTRIBUTES
call s:Style("javaStorageClass","",       "",        "NONE")
call s:Style("javascriptFunction",   "",  "",        "NONE")
call s:Style("javascriptIdentifier", "",  "",        "NONE")
call s:Style("luaFunction",    "",        "",        "NONE")
call s:Style("phpDefine",      "",        "",        "NONE")
call s:Style("rubyDefine",     "",        "",        "NONE")
...
call s:Style("ErrorMsg",       s:white,   s:red,     "NONE")
call s:Style("MoreMsg",        s:cyan,    "",        "")
call s:Style("ModeMsg",        "",        "",        "NONE")
...
call s:Style("VisualNOS",      "",        "",        "NONE,underline")
...
call s:Style("StatusLine",     "",        "",        "reverse,NONE")
call s:Style("StatusLineNC",   "",        "",        "reverse")
call s:Style("WildMenu",       s:white,   s:magenta, "NONE")
call s:Style("Search",         s:black,   s:yellow,  "")
call s:Style("IncSearch",      s:black,   s:cyan,    "")
call s:Style("Directory",      s:blue,    "",        "NONE")
call s:Style("DiffAdd",        s:green,   "",        "")
call s:Style("DiffDelete",     s:red,     "",        "NONE")
call s:Style("DiffChange",     s:magenta, "",        "")
call s:Style("DiffText",       s:magenta, "",        "NONE")
