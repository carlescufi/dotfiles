...
hi FoldColumn guibg=#263238 guifg=#607d8b gui=NONE
...
hi Todo gui=NONE guifg=#80cbc4 guibg=#37474f
"hi Constant guifg=#8ae234
hi Constant guifg=#ffd54f
"hi Type guifg=#8AE234
hi Type guifg=#ffb74d
hi Function gui=NONE guifg=#9BCF8D
"hi Function gui=NONE guifg=#607D8B
...
hi Number guifg=#ffd54f gui=NONE

hi Search guifg=#81c784 guibg=#263238 gui=NONE
...
hi MatchParen guibg=#37473f guifg=#ffb74d gui=NONE
hi markdownHeadingDelimiter guifg=#ffb74d
hi Title gui=NONE guifg=#ffb74d
hi htmlH1 gui=NONE guifg=#ffb74d
hi htmlH2 gui=NONE guifg=#ffb74d
hi htmlH3 guifg=#ffb74d

" Syntastic
hi SyntasticError guifg=#e57373
hi SyntasticWarning guifg=#ffd54f gui=NONE
hi SyntasticErrorSign guifg=#e57373 gui=NONE
hi SyntasticWarningSign guifg=#ffd54f gui=NONE
