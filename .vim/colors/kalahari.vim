...
if has("gui_running") || &t_Co == 256
  ...
  hi NonText      ctermfg=152  ctermbg=235  cterm=NONE
 ...
 "hi MatchParen                ctermbg=6
  hi ModeMsg      ctermfg=178               cterm=NONE
  hi MoreMsg      ctermfg=29
  hi Pmenu        ctermfg=4    ctermbg=232
  hi PmenuSel     ctermfg=252  ctermbg=235  cterm=NONE
 ...
 "hi SpellRare                 ctermbg=13
  hi StatusLine   ctermfg=145  ctermbg=16   cterm=reverse,NONE
 ...
 "hi Error        ctermfg=15   ctermbg=9
  ...
  hi Statement    ctermfg=39                cterm=NONE
...
elseif &t_Co == 88
  ...
  hi NonText      ctermfg=59   ctermbg=80   cterm=NONE
 ...
 "hi Statement    ctermfg=77                cterm=NONE
  hi Statement    ctermfg=52                cterm=NONE
 "hi StorageClass ctermfg=117
