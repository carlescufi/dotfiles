...
elseif &t_Co == 88 || &t_Co == 256
    ...
    hi Directory    cterm=NONE    ctermfg=149
    hi ErrorMsg     ctermfg=228   ctermbg=124
    hi IncSearch    cterm=NONE    ctermfg=203
    ...
    hi StatusLine   cterm=NONE  ctermfg=187 ctermbg=60
    hi StatusLineNC cterm=NONE  ctermfg=108 ctermbg=238
    hi VertSplit    cterm=NONE  cterm=NONE  ctermfg=236 ctermbg=238
    hi Title        ctermfg=68
    hi Visual       ctermfg=152 ctermbg=60
    hi VisualNOS    cterm=NONE,underline    ctermfg=60
    hi WarningMsg   ctermfg=220
    hi WildMenu     cterm=NONE  ctermfg=16  ctermbg=76
    hi Folded       ctermfg=114 ctermbg=66
    hi FoldColumn   cterm=NONE  ctermfg=114 ctermbg=66
    ...
    if v:version >= 700
       ...
       hi MatchParen   cterm=NONE  ctermfg=172 ctermbg=30
    endif
    ...
    hi Todo        cterm=NONE ctermfg=172 ctermbg=NONE
    ...
    hi Directory    cterm=NONE     ctermfg=LightYellow
    hi ErrorMsg     ctermfg=Yellow ctermbg=Red
    hi IncSearch    cterm=NONE    ctermfg=Red
    ...
    hi VertSplit    cterm=NONE cterm=NONE ctermfg=DarkGray ctermbg=Gray
    hi Title        ctermfg=Blue
    hi Visual       ctermfg=Blue ctermbg=LightGreen
    hi VisualNOS    cterm=NONE,underline ctermfg=DarkBlue
    ...
    hi FoldColumn   cterm=NONE ctermfg=LightGray ctermbg=DarkCyan
    ...
    hi Todo       cterm=NONE ctermfg=LightYellow
