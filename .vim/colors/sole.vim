...
hi Comment		cterm=NONE			gui=italic			ctermfg=Magenta		ctermbg=White		guifg=Magenta	guibg=White
hi Constant		cterm=NONE			gui=NONE			ctermfg=DarkGreen	guifg=DarkGreen
hi Cursor							gui=reverse			ctermfg=Blue		guifg=Blue
hi Identifier	cterm=NONE			gui=NONE			ctermfg=DarkMagenta	ctermbg=White		guifg=DarkMagenta
hi LineNr		cterm=reverse		gui=reverse			ctermfg=DarkGray	guifg=#333333		guibg=#efefef
hi NonText		ctermfg=DarkGray	gui=NONE			guifg=DarkGray
hi Normal		ctermbg=LightGray	ctermfg=Black		guibg=LightGray		guifg=Black
hi Search												ctermbg=Yellow		guibg=Yellow
hi Statement	cterm=NONE			gui=NONE			ctermfg=DarkBlue	guifg=DarkBlue
hi StatusLine	cterm=reverse		gui=NONE			ctermfg=Black		guifg=#000000		guibg=#ffffbb
