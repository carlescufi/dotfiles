...
if version >= 700
  ...
  hi MatchParen guifg=white guibg=#747270 gui=NONE
...
"
" Html-Titles
hi Title      guifg=#f0f0f0 gui=NONE
...
hi StatusLine guifg=white guibg=#181a1c gui=NONE
...
hi Todo      guifg=#404a5c guibg=NONE gui=italic,NONE
...
hi Function    guifg=#d0a040 gui=italic,NONE
...
hi Repeat        guifg=#907040 gui=NONE
hi Conditional   guifg=#50a040 gui=NONE
...
hi Error      guifg=#a02000 guibg=white gui=NONE,underline

hi Search     guifg=#e0d000 guibg=NONE gui=NONE,underline

" color of <TAB>s etc...  
"hi SpecialKey guifg=#d8a080 guibg=#e8e8e8 gui=italic  
hi SpecialKey guifg=#c4c2c0 guibg=#14181c gui=italic,NONE  

" Diff
"hi Normal    guifg=#b0b0b0   guibg=#181c20
hi DiffChange guifg=NONE guibg=#383c50 gui=italic
hi DiffText guibg=#888c60 guifg=#e0d060 gui=none
hi DiffAdd guifg=NONE guibg=#203030 gui=NONE
hi DiffDelete guifg=NONE guibg=#302020 gui=italic,NONE
