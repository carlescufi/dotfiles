...
" remove some default NONE in gui
"
" 0.81
" invisible char
" line number
...
hi DiffText			cterm=NONE		ctermfg=255		ctermbg=196		guifg=#ffffff
...
hi StatusLine		cterm=NONE		ctermfg=255		ctermbg=19		guifg=#0000af	guibg=#ffffff
...
hi Define				cterm=NONE		ctermfg=27		gui=NONE			guifg=#005fff
hi Delimiter		cterm=none		ctermfg=196		guifg=#ff0000
hi Error				cterm=none		ctermfg=255		ctermbg=9			guifg=#ffffff
hi Exception		cterm=NONE		ctermfg=226		gui=NONE			guifg=#ffff00
