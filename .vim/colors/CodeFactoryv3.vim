...
hi Statement        gui=NONE              guifg=#EBAF12         guibg=NONE
hi Conditional      gui=NONE              guifg=#EBAF12         guibg=NONE
hi Repeat           gui=NONE              guifg=#EBAF12         guibg=NONE
hi Label            gui=NONE              guifg=#EBAF12         guibg=NONE
hi Operator         gui=NONE              guifg=#808080         guibg=NONE
hi Keyword          gui=NONE              guifg=#EBAF12         guibg=NONE
...
hi Error            gui=NONE              guifg=#FFFFFF         guibg=#BF3131
...
hi ErrorMsg         gui=NONE              guifg=#FFFFFF         guibg=#BF3131
hi LineNr           gui=NONE              guifg=#222222         guibg=#979797
hi MatchParen       gui=NONE              guifg=#000000         guibg=#93BF3D
hi ModeMsg          gui=NONE              guifg=#EBAF12         guibg=NONE
hi MoreMsg          gui=NONE              guifg=#93BF3D         guibg=NONE
hi NonText          gui=NONE              guifg=#0F629E         guibg=NONE
...
" TABS
""""""""""""""""""""""""
hi TabLine          gui=NONE,reverse      guifg=#222222         guibg=#000000
hi TabLineFill      gui=NONE,reverse      guifg=#222222         guibg=#505050
hi TabLineSel       gui=NONE,reverse      guifg=#EBAF12         guibg=#000000
...
" STATUS
""""""""""""""""""""""""
hi StatusLine       gui=NONE,reverse      guifg=#EBAF12         guibg=#000000
hi StatusLineNC     gui=NONE,reverse      guifg=#222222         guibg=#979797
...
hi DiffDelete       gui=NONE              guifg=#0F629E         guibg=#009AB5
hi DiffText         gui=NONE              guibg=#BF3131         guibg=NONE
...
hi VisualNOS        gui=NONE,underline    guifg=NONE            guibg=NONE
...
hi VertSplit        cterm=NONE,reverse      ctermfg=darkgrey        ctermbg=black
...
" TABS
""""""""""""""""""""""""
hi TabLine          cterm=NONE,reverse      ctermfg=darkgrey        ctermbg=black
hi TabLineFill      cterm=NONE,reverse      ctermfg=darkgrey        ctermbg=grey
hi TabLineSel       cterm=NONE,reverse      ctermfg=brown           ctermbg=black
...
" STATUS
""""""""""""""""""""""""
hi StatusLine       cterm=NONE,reverse      ctermfg=brown           ctermbg=black
hi StatusLineNC     cterm=NONE,reverse      ctermfg=darkgrey        ctermbg=black
...
hi VisualNOS        cterm=NONE,underline    ctermfg=NONE            ctermbg=NONE
