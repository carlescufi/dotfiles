...
hi Statement    ctermfg=Green      ctermbg=Black      guifg=#8AE234    guibg=#000000 cterm=NONE term=NONE gui=NONE
hi Repeat       ctermfg=Yellow     ctermbg=Black      guifg=#FCE94F    guibg=#000000 cterm=NONE term=NONE gui=NONE
hi PreProc      ctermfg=White      ctermbg=Black      guifg=#EEEEEC    guibg=#000000 cterm=NONE term=NONE gui=NONE
hi Type         ctermfg=DarkGreen  ctermbg=Black      guifg=#4E9A06    guibg=#000000 cterm=none term=NONE
hi Special      ctermfg=Blue       ctermbg=Black      guifg=#729FCF    guibg=#000000
hi Underlined   ctermfg=Magenta    ctermbg=Black      guifg=#AD7FA8    guibg=#000000 cterm=NONE,underline gui=NONE,underline
hi Error        ctermfg=White      ctermbg=Red        guifg=#FFFFFF    guibg=#FF00A0 cterm=NONE,underline term=NONE gui=NONE,underline
...
hi ErrorMsg     ctermfg=Red        ctermbg=Black      guifg=#FF0000    guibg=#000000 cterm=NONE term=NONE gui=NONE
...
hi StatusLine   ctermfg=White      ctermbg=Black      guifg=#EEEEEC    guibg=#000000 cterm=NONE,underline term=NONE gui=NONE,underline
hi StatusLineNC ctermfg=Gray       ctermbg=Black      guifg=#D3D7CF    guibg=#000000 cterm=NONE,underline term=NONE gui=NONE,underline
hi LineNr       ctermfg=DarkYellow ctermbg=Black      guifg=#EDDE5C    guibg=#000000 cterm=none term=NONE
