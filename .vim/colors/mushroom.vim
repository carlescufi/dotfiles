...
" Colorscheme
hi TabLine                ctermfg=96  ctermbg=236 cterm=NONE gui=BOLD guifg=#875f87 guibg=#303030
hi TabLineFill            ctermfg=16  ctermbg=236 cterm=none gui=NONE guifg=#000000 guibg=#303030
hi TabLineSel             ctermfg=216 ctermbg=239 cterm=NONE gui=BOLD guifg=#ffaf87 guibg=#4e4e4e
hi Folded                 ctermfg=130 ctermbg=233 cterm=NONE gui=BOLD guifg=#af5f00 guibg=#121212
hi StatusLineNC           ctermfg=16  ctermbg=236 cterm=NONE gui=BOLD guifg=#000000 guibg=#303030
hi StatusLine             ctermfg=173 ctermbg=236 cterm=NONE gui=BOLD guifg=#d7875f guibg=#303030
...
hi PmenuSel               ctermfg=208 ctermbg=239 cterm=NONE gui=BOLD guifg=#ff8700 guibg=#4e4e4e
hi WarningMsg             ctermfg=225 ctermbg=236 cterm=NONE gui=BOLD guifg=#ffd7ff guibg=#303030
hi ErrorMsg               ctermfg=167 ctermbg=236 cterm=NONE gui=BOLD guifg=#d75f5f guibg=#303030
hi CursorLineNr           ctermfg=216 ctermbg=236 cterm=NONE gui=BOLD guifg=#ffaf87 guibg=#303030
hi Wildmenu               ctermbg=239 ctermfg=178 cterm=NONE gui=BOLD guifg=#4e4e4e guibg=#d7af00
hi FoldColumn             ctermbg=233 ctermfg=102 cterm=NONE gui=BOLD guibg=#121212 guifg=#878787
hi CtrlPMode1             ctermfg=130 ctermbg=236 cterm=NONE gui=BOLD guifg=#af5f00 guibg=#303030
hi CtrlPMode2             ctermfg=178 ctermbg=236 cterm=NONE gui=BOLD guifg=#d7af00 guibg=#303030
hi CtrlPPrtBase           ctermfg=79  ctermbg=16  cterm=NONE gui=BOLD guifg=#5fd7af guibg=#000000
...
hi Title                  ctermfg=209 cterm=NONE  guifg=#ff875f gui=BOLD
hi MoreMsg                ctermfg=216 cterm=NONE  guifg=#ffaf87 gui=BOLD
hi Question               ctermfg=215 cterm=NONE  guifg=#ffaf5f gui=BOLD
hi NonText                ctermfg=236 cterm=NONE  guifg=#303030 gui=BOLD
