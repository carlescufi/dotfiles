...
hi Error cterm=NONE ctermfg=darkred ctermbg=darkgray guifg=darkred guibg=darkgray

" The error message on the command line
hi ErrorMsg	cterm=NONE ctermfg=darkred ctermbg=darkgray guifg=darkred guibg=darkgray
...
hi Ignore cterm=NONE ctermfg=grey ctermbg=darkgrey guifg=grey guibg=darkgrey
...
hi NonText cterm=NONE ctermfg=black guifg=black
