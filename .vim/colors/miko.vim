...
hi Statement           cterm=NONE ctermfg=231   " if, else, etc...
hi Identifier          cterm=NONE ctermfg=75               " opening or closing brackets, ex: <  /> 
hi Special             ctermfg=117              "
hi Title               ctermfg=39              "
hi Normal              ctermfg=153              " DEFAULT font color that will be used on all non-special characters

hi Cursor              cterm=NONE ctermfg=231 ctermbg=82
hi CursorLine          cterm=reverse

hi PreProc             ctermfg=226            " term after an identifier, ex: =NONE
