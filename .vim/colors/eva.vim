...
if version >= 700
  ...
  call s:h("MatchParen",  { "fg": s:accent5, "bg": s:accent2, "gui": "NONE" })
...
call s:h("DiffText",     { "bg": s:accent6, "gui": "NONE", "cterm": "NONE" })
...
call s:h("Todo",       { "fg": s:accent7, "gui": "NONE", "cterm": "NONE" })
call s:h("Function",   { "fg": s:accent14, "cterm": "NONE" })
