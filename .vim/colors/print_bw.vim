...
highlight PreProc	    cterm=NONE ctermfg=black ctermbg=white gui=NONE guifg=black guibg=white
" Include defaults to PreProc
" Define defaults to PreProc
" Macro defaults to PreProc
" PreCondit defaults to PreProc

highlight Type		    cterm=NONE ctermfg=black ctermbg=white gui=NONE guifg=black guibg=white
...
highlight Todo		    cterm=italic,NONE ctermfg=black ctermbg=white gui=italic,NONE guifg=black guibg=white
