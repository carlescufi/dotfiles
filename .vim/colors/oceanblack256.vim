...
highlight VisualNOS      cterm=NONE,underline ctermfg=151 ctermbg=0

highlight Cursor         cterm=none           ctermfg=15  ctermbg=152
highlight CursorIM       cterm=NONE           ctermfg=15  ctermbg=152
...
highlight DiffText       cterm=NONE           ctermfg=226 ctermbg=90

highlight Question       cterm=NONE           ctermfg=85  ctermbg=0
highlight ErrorMsg       ctermfg=230          ctermbg=167
highlight ModeMsg        ctermfg=77           ctermbg=22
highlight MoreMsg        cterm=NONE           ctermfg=72  ctermbg=0
highlight WarningMsg     cterm=NONE           ctermfg=203 ctermbg=0
...
highlight WildMenu       cterm=NONE           ctermfg=0   ctermbg=118

"highlight TabLine
"highlight TabLineFill
"highlight TabLineSel

highlight Title          cterm=NONE           ctermfg=171 ctermbg=0
