...
hi CursorIM             gui=NONE guifg=#ffffff ctermfg=15 guibg=#8DA1A1 ctermbg=247
...
hi Folded               gui=NONE guibg=#305060 ctermbg=239 guifg=#b0d0e0 ctermfg=152
...
hi MoreMsg              gui=NONE guifg=#C8F482 ctermfg=192 guibg=bg
...
hi Question             gui=NONE guifg=#C8F482 ctermfg=192 guibg=bg
...
hi StatusLine           gui=NONE guibg=#484848 ctermbg=238 guifg=#000000 ctermfg=0
hi StatusLineNC         gui=NONE guibg=#686868 ctermbg=242  guifg=#E0E0E0 ctermfg=7
hi Title                gui=NONE guifg=#9d7ff2 ctermfg=141 guibg=bg
hi Visual               gui=reverse guibg=#ffffff ctermbg=15 guifg=#55747c ctermfg=66
hi VisualNOS            gui=NONE,underline guifg=fg guibg=bg
hi WarningMsg           gui=NONE guifg=#FF0000 ctermfg=9 guibg=bg
hi WildMenu             gui=NONE guibg=#F6DA7B ctermbg=222 guifg=#000000 ctermfg=0
...
" Pink
hi Todo                 gui=NONE guifg=#e29aeb ctermfg=176 guibg=bg
...
hi Boolean              gui=NONE guifg=#776CC4 ctermfg=98 guibg=bg
...
" Ruby-specific
hi rubySharpBang        gui=NONE guifg=#e29aeb ctermfg=176
