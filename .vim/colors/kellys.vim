...
if has("gui_running")
	...
	hi MatchParen	guifg=#d1d435	guibg=#2a2b2f	gui=NONE,underline
	hi ModeMsg		guifg=#e1e0e5	guibg=#2a2b2f	gui=NONE
	hi Normal 		guifg=#e1e0e5	guibg=#2a2b2f	gui=none
	hi Pmenu		guifg=#2a2b2f	guibg=#9ab2c8	gui=none
	hi PmenuSel		guifg=#2a2b2f	guibg=#62acce	gui=NONE
	...
	hi StatusLine 	guifg=#2a2b2f	guibg=#62acce	gui=NONE
	hi StatusLineNC guifg=#2a2b2f	guibg=#e1e0e5	gui=none
	hi Todo 		guifg=#e1e0e5	guibg=#9d0e15	gui=NONE
	...
	if &t_Co == 256
		...
		hi MatchParen	ctermfg=184	ctermbg=235	cterm=NONE,underline
		hi ModeMsg		ctermfg=254	ctermbg=235	cterm=NONE
		hi Normal 		ctermfg=254	ctermbg=235	cterm=none
		hi Pmenu		ctermfg=235	ctermbg=74	cterm=none
		hi PmenuSel		ctermfg=235	ctermbg=81	cterm=NONE
		...
		hi StatusLine 	ctermfg=235	ctermbg=81	cterm=NONE
		hi StatusLineNC ctermfg=235	ctermbg=254	cterm=none
		hi Todo 		ctermfg=254	ctermbg=124	cterm=NONE
