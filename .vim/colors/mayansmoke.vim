...
hi FoldColumn   guifg=SteelBlue4        guibg=LightYellow2      gui=NONE
...
hi MatchParen   guifg=black             guibg=LemonChiffon3     gui=NONE
hi ModeMsg      guifg=White             guibg=tomato1           gui=NONE
hi MoreMsg      guifg=SeaGreen4         guibg=bg                gui=NONE
hi NonText      guifg=LightCyan3        guibg=bg                gui=NONE

hi Pmenu        guifg=Orange4           guibg=LightYellow3      gui=NONE
hi PmenuSel     guifg=ivory2            guibg=NavajoWhite4      gui=NONE
hi PmenuSbar    guifg=White             guibg=#999666        gui=NONE
hi PmenuThumb   guifg=White             guibg=#7B7939        gui=NONE

hi Question     guifg=Chartreuse4       guibg=bg                gui=NONE
...
"  Vim {{{2
" -----------------------------------------------------------------------------
hi VimError         guifg=red            guibg=Black   gui=NONE
hi VimCommentTitle  guifg=DarkSlateGray4 guibg=bg      gui=NONE,italic
" 2}}}
...
hi qfLineNr    guifg=coral             guibg=NONE      gui=NONE
hi qfError     guifg=red               guibg=NONE      gui=NONE
" 2}}}

" Python {{{2
" -----------------------------------------------------------------------------
hi pythonDecorator  guifg=orange3 guibg=NONE gui=NONE
...
hi diffNewFile          guifg=#0088FF           guibg=NONE      gui=NONE
...
hi phpNumber ctermfg=214 cterm=NONE guifg=brown
hi phpTodo ctermfg=red cterm=NONE guifg=red gui=NONE
...
hi phpIntVar ctermfg=0 cterm=NONE guifg=black gui=NONE
