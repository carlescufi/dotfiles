...
hi DiffAdd      term=NONE       cterm=none      ctermfg=white   ctermbg=DarkBlue        gui=none guifg=#aaeeaa          guibg=#447744
hi DiffChange   term=NONE       cterm=none      ctermfg=white   ctermbg=DarkMagenta     gui=none guifg=lightyellow      guibg=#ddbb55
hi DiffDelete   term=NONE       cterm=none      ctermfg=blue    ctermbg=darkcyan        gui=none guifg=#336633          guibg=#aaccaa
hi difftext     term=reverse    cterm=NONE      ctermfg=white   ctermbg=red             gui=none guifg=lightyellow      guibg=#cc7733
...
hi ModeMsg      term=NONE      cterm=none ctermfg=green         ctermbg=darkgreen       gui=none guifg=#007700          guibg=#aaccaa
hi MoreMsg      term=NONE      cterm=none ctermfg=darkGreen     ctermbg=white           gui=none guifg=darkgreen        guibg=bg
hi Question     term=NONE      cterm=none ctermfg=darkGreen     ctermbg=white           gui=none guifg=darkgreen        guibg=bg
...
hi NonText      term=NONE      cterm=none ctermfg=lightgrey     ctermbg=white           gui=none guifg=#c6c6c6          guibg=bg
hi StatusLine   term=reverse   cterm=none ctermfg=white         ctermbg=black           gui=none guifg=#80624d          guibg=#ddd9b8
hi Title        term=NONE      cterm=none ctermfg=DarkMagenta   ctermbg=white           gui=none guifg=DarkMagenta      guibg=bg
...
hi VisualNOS    term=NONE      cterm=none ctermfg=grey         ctermbg=black        gui=none guifg=grey         guibg=black
hi WarningMsg   term=standout  cterm=none ctermfg=Red          ctermbg=white        gui=none guifg=Red          guibg=bg
hi WildMenu     term=NONE      cterm=none ctermfg=darkblue     ctermbg=yellow       gui=none guifg=black        guibg=lightyellow

hi Constant     term=underline  cterm=none      ctermfg=darkred         ctermbg=bg      gui=none guifg=#bb6666  guibg=bg
hi Special      term=NONE       cterm=none      ctermfg=darkcyan        ctermbg=white   gui=none guifg=darkcyan guibg=bg
hi identifier   term=underline  cterm=none      ctermfg=darkmagenta     ctermbg=white   gui=none guifg=darkcyan guibg=bg
hi statement    term=NONE       cterm=none      ctermfg=darkgreen       ctermbg=white   gui=none guifg=#44aa44  guibg=bg
...
"hi todo         term=underline  cterm=NONE      ctermfg=yellow          ctermbg=brown   gui=none guifg=#333333     guibg=#ddee33
hi todo   term=NONE       cterm=none      ctermfg=yellow   ctermbg=brown     gui=NONE guifg=#229900      guibg=#ddd9b8
hi function     term=NONE       cterm=none      ctermfg=blue            ctermbg=white   gui=none guifg=#0055cc  guibg=bg
