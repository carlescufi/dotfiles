...
call s:X("Todo",g:dark_blue,"","NONE","Grey", "")
...
call s:X("MatchParen",g:white,g:dark_purple,"NONE","","")
...
call s:X("TabLineSel",g:black,g:yellow,"italic,NONE","Black","White")
...
call s:X("Title",g:dirty_green,"","NONE","Green","")
