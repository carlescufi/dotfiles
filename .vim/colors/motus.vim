...
highlight VertSplit    gui=NONE guifg=Grey25    guibg=Black
highlight StatusLine   gui=NONE guifg=White     guibg=Grey25
highlight StatusLineNC gui=NONE guifg=LightGrey guibg=Grey25

highlight FoldColumn	 gui=NONE guifg=White guibg=Black
...
highlight StatusLine   ctermfg=White  ctermbg=Grey cterm=NONE
highlight StatusLineNC ctermfg=Black  ctermbg=Grey cterm=NONE

highlight FoldColumn	ctermbg=Black		ctermfg=White cterm=NONE
