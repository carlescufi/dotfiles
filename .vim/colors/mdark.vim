...
call s:Color('Function', {'guifg': s:dusty_blue, 'gui': 'NONE'})
...
call s:Color('Structure', {'guifg': s:dg_dusty_blue, 'gui':'NONE' })
call s:Color('Typedef', {'guifg': s:lg_dusty_blue, 'gui':'NONE'})
